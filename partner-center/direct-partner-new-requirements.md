...
직접 청구 비즈니스에서 간접 재판매인 비즈니스로 전환하기로 결정한 경우 몇 가지 단계를 수행해야 합니다. 전환에 대한 자세한 내용은 [CSP(클라우드 솔루션 공급자) 직접 파트너에서 CSP 간접 재판매인으로 전환](transition-direct-to-indirect.md)을 참조하세요. 
