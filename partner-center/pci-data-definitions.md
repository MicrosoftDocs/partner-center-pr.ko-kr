...
### <a name="enterprise-mobility-license-usage-report"></a>**Enterprise Mobility 라이선스 사용 현황 보고서**
...
### <a name="power-bi-license-usage-report"></a>**라이선스 사용량 보고서 Power BI**
...
### <a name="teams-meetings-and-calls-report"></a>**Teams 모임 및 통화 보고서**
...
| CompetencyStartDate | 역량 시작 날짜 | 
| CompetencyEndDate | 역량 종료 날짜 | 
...
| 파트너 이름 | 파트너의 이름 | 
| 고객 ID | 고객 식별자 번호 | 
| 2018년 3월 1 | Propensity에 대한 점수가 매겨진 고객의 Bradstreet 번호 & | 
| 계정 이름 | 계정 이름 | 
| 도메인 | 계정의 도메인 | 
| 조직 크기 | 조직의 크기 | 
| 업종 | 조직이 속한 산업 | 
...
| 금융 위험 & 사기 관리 - Dynamics 온-프레미스 설치 기준 - Navision(Business Central propensity model) | 온-프레미스 Navision을 보유한 기존 고객. 파트너는 Dynamics 365 Business Central을 대상으로 해야 합니다. | 
...
| Agile 비즈니스 프로세스 빌드 - Dynamics 온-프레미스 설치 기준 - AX/GP/SL/NAV/기타(Dynamics 365 전파 모델) | Agile 비즈니스 프로세스 빌드 - Dynamics 온-프레미스 설치 기준 - AX/GP/SL/NAV/기타(Dynamics 365 전파 모델) | 
...
| Agile Business Processes 빌드 - Dynamics 365 Business Central 설치 기준 | 기존 Dynamics 365 Business Central 고객. Power Apps 대상으로 지정할 파트너입니다. | 
...
### <a name="cloud-ascent---azure-propensity-report"></a>**클라우드 상승 - Azure Propensity 보고서**
...
| 마이그레이션 - EOL Windows Server - 클라우드 Ascent propensity를 사용하는 EOL Windows Server IB - <5개 라이선스 | EOL 온-프레미스 Windows Server(즉, EOL 버전 이하)가 있는 고객입니다. 고객에게 5개 미만의 라이선스가 있습니다. 전파 점수가 있는 고객입니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL Windows Server - 클라우드 Ascent propensity가 없는 EOL Windows Server IB - 5개 이상의 라이선스 | EOL 온-프레미스 Windows Server(즉, EOL 버전 이하)가 있는 고객입니다. 고객에게 5개 이상의 라이선스가 있습니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL Windows Server - 클라우드 Ascent propensity가 없는 EOL Windows Server IB - <5개 라이선스 | EOL 온-프레미스 Windows Server(즉, EOL 버전 이하)가 있는 고객입니다. 라이선스가 5개 미만입니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL SQL - 클라우드 ascent propensity를 사용하여 EOL SQL Server IB - 5개 이상의 라이선스 | EOL 온-프레미스 SQL Server(즉, EOL 버전 이하)가 있는 고객입니다. 고객에게 5개 이상의 라이선스가 있습니다. 고객에게는 전파 점수가 있습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL SQL - 클라우드 ascent propensity를 사용하여 EOL SQL Server IB - <5개 라이선스 | EOL 온-프레미스 SQL Server(즉, EOL 버전 이하)가 있는 고객입니다. 라이선스가 5개 미만입니다. 전파 점수가 있는 고객입니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL SQL - 클라우드 ascent propensity가 없는 EOL SQL Server IB - 5개 이상의 라이선스 | EOL 온-프레미스 SQL Server(즉, EOL 버전 이하)가 있는 고객입니다. 고객에게 5개 이상의 라이선스가 있습니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - EOL SQL - 클라우드 ascent propensity가 없는 EOL SQL Server IB - <5개 라이선스 | EOL 온-프레미스 SQL Server(즉, EOL 버전 이하)가 있는 고객입니다. 고객에게 5개 미만의 라이선스가 있습니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
...
| 마이그레이션 - 온-프레미스 Windows Server 마이그레이션 - 클라우드 Ascent propensity를 사용하여 현재 Windows Server IB - <5개 라이선스 | 현재 온-프레미스 Windows Server(즉, EOL 이후 버전)가 있는 고객입니다. 고객에게 5개 미만의 라이선스가 있습니다. 고객에게 Azure에 대한 전파 점수가 있습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - 온-프레미스 Windows Server 마이그레이션 - 클라우드 Ascent propensity 없이 현재 Windows Server IB - 5개 이상의 라이선스 | 현재 온-프레미스 Windows Server(즉, EOL 이후 버전)가 있는 고객입니다. 고객에게 5개 이상의 라이선스가 있습니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - 온-프레미스 Windows Server 마이그레이션 - 클라우드 Ascent propensity 없이 현재 Windows Server IB - <5개 라이선스 | 현재 온-프레미스 Windows Server(즉, EOL 이후 버전)가 있는 고객입니다. 고객에게 5개 미만의 라이선스가 있습니다. 고객에게는 전파 점수가 없습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - Azure SQL 또는 SQL VM(가상 머신)으로 마이그레이션 - Cloud Ascent propensity를 사용하여 현재 SQL Server IB - 5개 이상의 라이선스 | 현재 온-프레미스 SQL Server 있는 고객(즉, EOL 이후 버전). 고객에게 5개 이상의 라이선스가 있습니다. 고객에게는 전파 점수가 있습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
| 마이그레이션 - Azure SQL 또는 SQL VM으로 마이그레이션 - Cloud Ascent propensity를 사용하여 현재 SQL Server IB - <5개 라이선스 | 현재 온-프레미스 SQL Server 있는 고객(즉, EOL 이후 버전). 고객에게 5개 미만의 라이선스가 있습니다. 고객에게는 전파 점수가 있습니다. 파트너는 이 고객을 대상으로 Azure로 마이그레이션해야 합니다. | 
...
| 마이그레이션 - OSS - Azure의 Linux | Linux를 이용한 기존 고객. 파트너는 Azure로 마이그레이션하기 위해이 고객을 대상으로 해야 합니다. | 
