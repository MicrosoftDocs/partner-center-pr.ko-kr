...
청구서를 보려면 **대시보드** 메뉴로 이동한 다음 **청구**를 선택합니다. 이 청구 페이지에는 청구 내역과 추세, 이번 달 미지급액, 청구서 및 조정 파일의 링크, 최근 결제가 표시됩니다.
...
<li>크레딧 또는 조정은 적용된 후 다음 달의 청구 송장에 조정 및 크레딧이 후불로 표시됩니다.</li>
</ul></td>
</tr>
<tr class="even">
<td>세금</td>
