...
Microsoft 파트너는 하나 이상의 라이선싱 프로그램, 채널 또는 규약에 참여할 수 있습니다. 파트너 센터 대시보드에서 작업 하는 경우이는 CSP (클라우드 솔루션 공급자) 프로그램 또는 Microsoft 파트너 네트워크 (MPN) 프로그램과 같은 프로그램을 포함할 수 있습니다. 기타 라이선스 프로그램에는 EA (기업계약) 라이선스, VL (볼륨 라이선스), OEM 라이선스 프로그램, Software 바우처 교육 또는 프로그램 또는 오픈 라이선스 프로그램이 포함 됩니다.

각 프로그램에는 특정 계약과 관련 된 계약이 있습니다. 마찬가지로, 사용 하는 특정 제품에는 사용과 관련 된 추가적인 제품별 사용권 계약이 있을 수 있습니다.

이러한 프로그램이 작동 하는 방식에 대 한 질문이 있는 경우 이러한 리소스는 도움이 될 수 있습니다.
...
다음 리소스에서 특정 라이선싱 프로그램에 대해 자세히 알아볼 수 있습니다.

>[!NOTE]
> 특정 프로그램에 등록 되어 있어야 여기에 표시 된 모든 리소스에 액세스할 수 있습니다. [MPN 프로그램](https://partner.microsoft.com/membership) 또는 [CSP 프로그램](https://partner.microsoft.com/membership/cloud-solution-provider)에서 등록 하는 방법에 대해 자세히 알아보세요.
...
|지불 및 바우처 작동 방식에 대 한 소프트웨어 보증 프로그램 및 관련 라이선스에 대해 자세히 알아보세요.  | [소프트웨어 보증 개요](https://www.microsoft.com/Licensing/licensing-programs/software-assurance-default.aspx) 또는 [소프트웨어 보증 이점 및 요구 사항](software-assurance-lp.md) |
|MPN 내부 사용 권한 또는 혜택에 대 한 세부 정보를 검토 합니다.  | [Microsoft 파트너 네트워크 프로그램 가이드](https://assets.microsoft.com/MPN-MAPS-Product-Usage-Guide.pdf)  |
|설치 전 키트 또는 교육과 같은 OEM 파트너 자료를 찾습니다.  | [Microsoft 장치 파트너 센터](https://devicepartner.microsoft.com/)  |
|OEM 고객 또는 소매 고객에 대 한 사용 질문 (전체 패키지 제품이 나 FPP 고객이 라고도 함)에 대 한 답변을 제공 합니다. Microsoft 또는 컴퓨터 제조업체에서 사용이 허가 된 소프트웨어를 사용 하는 고객을 위한 것입니다. *(이러한 용어는 볼륨 라이선스 프로그램의 고객에 게는 적용 되지 않습니다.)*  | [소매 (FPP) 사용 약관](https://www.microsoft.com/useterms)  |

## <a name="resources-associated-with-license-fulfillment-or-financing-options"></a>라이선스 처리 또는 금융 옵션과 관련 된 리소스

라이선스 처리, 지불 또는 요금제에 대 한 특정 질문이 있는 경우 첫 번째 연락 지점은 간접 공급자 (CSP 프로그램의 경우) 또는 프로그램 배포자입니다. 또한 다음과 같은 리소스를 유용 하 게 사용할 수 있습니다.

|원하는 작업  | 참조 항목  |
|:------------------|:--------------- |
|볼륨 라이선스 프로그램의 설치 미디어에 대 한 질문에 대답 합니다. | [라이선스 처리 페이지](https://www.microsoft.com/licensing/existing-customer/fulfillment.aspx)  |
|기업계약 (EA), 서버 및 클라우드 등록 (SCE), Open Value Subscription (OVS) 등록 프로그램에 대 한 온라인 서비스에 대 한 답변을 합니다.  | [Microsoft Volume License Center 교육 및 리소스](https://www.microsoft.com/Licensing/existing-customer/vlsc-training-and-resources.aspx)  |
|MPSA (Microsoft 제품 및 서비스 계약)와 관련 된 온라인 서비스에 대 한 답변을 질문 합니다.  | [Microsoft Business Center 교육 및 리소스](https://www.microsoft.com/licensing/existing-customer/business-center-training-and-resources.aspx#tab=2) 또는 [mpsa 라이선스 개요](https://www.microsoft.com/licensing/mpsa/default)  |  
|CSP (클라우드 솔루션 공급자) 프로그램과 관련 된 온라인 서비스에 대 한 대답을 제공 합니다.  | [CSP 구독을 고객에 게 판매 하는 방법](customer-subscriptions.md)  |
|Microsoft 지불 및 금융 옵션에 대 한 질문에 답변 합니다.  | [Microsoft 금융 프로그램 FAQ](https://download.microsoft.com/download/3/9/0/390DF0B3-8B15-4E65-AF5E-71A7280E7682/Microsoft-Financing-Program-FAQ-Customer_en-US.pdf)  |
...
Microsoft 파트너는 성공에 관련 된 다른 파트너의 도움을 요청할 수 있습니다. Microsoft 지원에서 도움을 요청할 수도 있습니다. 지원 전문가는 파트너 프로그램 문제, 예약 판매 지원, Microsoft 제품에 대 한 문제, 대금 청구 관련 문제를 해결 하는 데 사용할 수 있습니다.

[Microsoft Partner support](https://partner.microsoft.com/support/?stage=1) 로 이동 하 여 지원 옵션을 확인 하거나 지원 티켓을 시작 합니다.
