...
1.  [Microsoft 공식 간접 공급자 목록](https://partnercenter.microsoft.com/en-us/partner/find-a-provider)에서 귀사의 프로필을 검토합니다. 

    -   회사의 간접 공급자 프로필을 변경하려면 파트너 센터 지원 요청을 제출하고 이 요청에 회사 이름, 로고 및 각 위치에 대한 대상 URL을 포함합니다. 프로필은 2~3주 내에 업데이트됩니다.<br>
