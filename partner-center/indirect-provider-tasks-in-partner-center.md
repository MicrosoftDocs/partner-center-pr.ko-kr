...
## <a name="indirect-provider-tasks-in-the-partner-center"></a>파트너 센터에서 간접 공급자가
...
2.  간접 재판매인과의 관계 구축
    ...
    - 상호 작용할 수 있으며 거래 하는 재판매인, 파트너 센터에서 고객과 파트너 관계를 설정 해야 합니다. <br>
...
다음이 단계를 완료 하면 **파트너 센터** 메뉴에서 **간접 재판매인** 페이지에서 재판매인 파트너 관계를 관리할 수 있습니다.

> [!IMPORTANT]   
> 재판매인과 협력을 시작 하기 전에 CSP 프로그램에 간접 재판매인으로 등록 해야 하며 파트너 센터 계정이. CSP 등록에 대한 자세한 내용은 [CSP에서 간접 공급자와 파트너 되기](https://msdn.microsoft.com/partner-center/indirect-reseller-tasks-in-partner-center.md)를 참조하라고 재판매인에게 알려주세요. 
...
1. **파트너 센터** 메뉴에서 **간접 재판매인** 을 선택 합니다. 
...
3. **전자 메일에서 열기**를 선택하여 기본 전자 메일 응용 프로그램에서 메시지를 열거나 **클립보드에 복사**를 선택하여 메시지를 복사한 다음 전자 메일에 붙여 넣습니다. 작업을 마쳤으면 **완료**를 선택합니다.
    > [!IMPORTANT]  
    >  전자 메일 메시지에서 텍스트를 편집할 수 있지만 링크는 파트너 센터 계정에 맞게 개인화 포함 해야 합니다.
...
간접 재판매인을 사용 하려는 경우 기존 구독에 대 한 간접 재판매인을 포함 하 여 구독 세부 정보를 업데이트할 수 있습니다.

- 구독 세부 정보 페이지에서 **재판매인 (MPN ID)** 필드와 작업 하려고 하는 재판매인을 추가 합니다. 이렇게 하면 재판매인 적절 한 인센티브를 받게 됩니다.
...
오늘날 간접 공급자 순서를 배치 하 고 선택적으로 PartnerOnRecord로 간접 재판매인을 선택 하려면 파트너 센터 대시보드를 사용할 수 있습니다. 간접 재판매인을 선택 하지 않는 것이 메일은 계층 1 거래 및 간접 공급자와 같은 incentivize 했습니다. 하나 선택할 수행, 순서 2 계층 거래도 처리 하 고 우리가 incentivize 간접 공급자와 간접 재판매인 모두 적절 하 게 합니다.

 

됩니다 환경을 간접 공급자는 기존 구독에 대 한 PartnerOnRecord 업데이트할 수도 있습니다.

 

공급자는 PartnerOnRecord 관리 해야 기존 설명서 어떻게 간접에 있는 경우 알 수 있을까요 설정 하세요?
이 이유 않으므로 매우 중요 한 일련의 2 계층 거래 간접 공급자에 잘못 된 인센티브 지급액에 의해 올바르게 구성 되지 않은 것으로 보입니다. 시간이 지남에 따라 파트너 실현이 고 인센티브에는 backpay 가져오는 Microsoft 접근할 시작 합니다. 설명서 범위 없는 것이 영역에서 하나 못했다고 도움말에 싶습니다.
