...
## <a name="indirect-provider-tasks-in-the-partner-center"></a>파트너 센터에서 간접 공급자 작업
...
2.  간접 재판매인과의 관계 구축
    ...
    - 상호 작용 하 고 대리점 시스템과, 파트너 센터에서 상호 협력 관계를 설정 해야 합니다. <br>
...
다음이 단계를 완료 한 후에 reseller 파트너 관계를 관리할 수 있습니다 합니다 **간접 재판매인** 페이지에서 프로그램 **파트너 센터** 메뉴.

> [!IMPORTANT]   
> 재판매인과 함께 작업을 시작 하기 전에 CSP 프로그램에 대 한 간접 재판매인으로 등록 해야 하며 파트너 센터 계정이 합니다. CSP 등록에 대한 자세한 내용은 [CSP에서 간접 공급자와 파트너 되기](https://msdn.microsoft.com/partner-center/indirect-reseller-tasks-in-partner-center.md)를 참조하라고 재판매인에게 알려주세요. 

## <a name="connect-with-indirect-resellers"></a>간접 재판매인과의 관계 구축

파트너 센터에서 간접 재판매인 시스템과 상호 작용을 하를 사용 하 여 파트너 관계를 설정 해야 합니다. 간접 재판매인과 파트너가 되면 귀사와 재판매인 모두 공통 고객에게 서비스를 제공할 수 있게 됩니다.

파트너 관계를 설정하려면 재판매인에게 파트너 관계 요청 전자 메일을 보냅니다. 시작하기 전에 재판매인의 전자 메일 주소를 준비해 두세요. 

1. 선택 **간접 재판매인** 에서 프로그램 **파트너 센터** 메뉴. 
...
3. **전자 메일에서 열기**를 선택하여 기본 전자 메일 응용 프로그램에서 메시지를 열거나 **클립보드에 복사**를 선택하여 메시지를 복사한 다음 전자 메일에 붙여 넣습니다. 작업을 마쳤으면 **완료**를 선택합니다.
    > [!IMPORTANT]  
    >  전자 메일 메시지의 텍스트를 편집할 수 있지만 파트너 센터 계정에 대 한 개인 설정 된 대로 링크를 포함 해야 합니다.
...
간접 재판매자를 사용 하려는 경우 기존 구독에 대 한 간접 재판매자를 포함 하도록 구독 세부 정보를 업데이트할 수 있습니다.

- 구독 세부 정보 페이지에 **대리점 (MPN ID)** 필드를 사용 하 여 작업 하려면 reseller를 추가한 합니다. 이렇게 하면 재판매자가 적절 한 인센티브를 받게 됩니다.

| **이렇게 하려면** | **이 작업을 수행합니다** | **위치** |
|   ------------------   |   -------   |   -----   |
...
2.  새 고객을 할당할 간접 재판매인을 찾은 후 **새 고객 추가**를 선택합니다. 고객 세부 정보 양식에서 간접 재판매인이 이미 선택되어 있습니다. 고객의 세부 정보를 제공 하 고 선택한 **다음: 구독** 합니다. 
...
6.  주문을 제출하면 **확인** 페이지가 나타납니다. **설정 정보** 아래에 관리 사용자 계정 이름 및 임시 암호가 표시됩니다. 새 고객에게 보낼 수 있도록 사용자 계정 이름 및 암호 정보를 복사해 둡니다. 
    > [!IMPORTANT]  
    > 이 페이지를 닫은 후 다시이 정보에 액세스 할 수 없으므로 사용자 계정 이름 및 암호를 기록해를 확인 해야 합니다.
