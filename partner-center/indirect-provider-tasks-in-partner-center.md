...
> [!IMPORTANT]   
> 재판매인과 협력을 시작 하기 전에 CSP 프로그램에 간접 재판매인으로 등록 해야 하며 파트너 센터 계정이 있어야 합니다. CSP 등록에 대한 자세한 내용은 [CSP에서 간접 공급자와 파트너 되기](https://msdn.microsoft.com/partner-center/indirect-reseller-tasks-in-partner-center.md)를 참조하라고 재판매인에게 알려주세요. 
...
3. **전자 메일에서 열기**를 선택하여 기본 전자 메일 응용 프로그램에서 메시지를 열거나 **클립보드에 복사**를 선택하여 메시지를 복사한 다음 전자 메일에 붙여 넣습니다. 작업을 마쳤으면 **완료**를 선택합니다.
    > [!IMPORTANT]  
    >  전자 메일 메시지에서 텍스트를 편집할 수 있지만 파트너 센터 계정에 맞게 개인화 링크를 포함 해야 합니다.
