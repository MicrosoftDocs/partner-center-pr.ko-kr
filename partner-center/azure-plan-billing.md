...
Azure 플랜에 따른 청구는 잘 조정된 단일 청구 날짜와 월별 청구 기간을 사용하는 간소화된 청구 환경입니다.
...
5. 자세한 청구 정보는 청구서 조정 파일 및 일일 평가 사용량 파일을 검토하세요.
   ...
   :::image type="content" source="images/azure/invoice1.png" alt-text="청구":::
...
- 아래 예제를 살펴보세요.
  ...
  - 미터가 7/8 – 7/31에 **관리형 서비스에 대한 파트너 획득 크레딧** 자격을 획득했습니다(유효 단가는 소매 가격에서 파트너 획득 크레딧을 뺀 가격).
   ...
   :::image type="content" source="images/azure/pecfinal.png" alt-text="청구":::
...
:::image type="content" source="images/azure/azurespend.png" alt-text="청구":::
