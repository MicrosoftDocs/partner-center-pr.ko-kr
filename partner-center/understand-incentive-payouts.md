...
|결제                       |**유료** 또는 **보류 중** 을 선택 하 고 원하는 대로 정렬 합니다. 특정 결제에 대 한 자세한 내용을 **보려면 보기**를 선택 합니다. 지급 송금 명세서의 복사본을 다운로드하려면 **다운로드**를 선택합니다. 트랜잭션 기록 데이터를 표시 하는 데 최대 24 시간이 걸릴 수 있으므로 관련 소득을 즉시 볼 수 없습니다.  |
...
>[!NOTE]
>트랜잭션 요약 보고서에는 프로그램 또는 소득이 모두 표시 되지 않습니다. 집계 된 레버에만 초점을 맞춘 요약입니다. 개별 트랜잭션을 보려면 [트랜잭션 기록 보고서](#transaction-history-page)를 다운로드 합니다.
