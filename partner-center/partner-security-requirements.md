...
- 기준 정책은 향후 몇 달 동안 유지될 것이며 2020년 2월 말 중단될 예정입니다.
...
서비스 계정을 비롯한 각 사용자에게 MFA를 적용하는 것이 요구 사항이므로 파트너 디렉터리에서 인증에 사용자 자격 증명을 활용하는 모든 자동화 또는 통합이 영향을 받습니다. 따라서 이러한 상황에서 사용되는 계정을 식별하는 것이 중요합니다. 고려할 다음 샘플 애플리케이션 또는 서비스 목록을 참조하세요.
