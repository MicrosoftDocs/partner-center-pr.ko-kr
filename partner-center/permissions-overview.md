...
각 역할이 파트너 센터에서 특정 작업을 수행 하는 사용자가 특정 권한 함께 제공 됩니다. 모든 사람 작동 파트너 센터에서 역할을 할당 해야 합니다.

조직의 규모에 따라 일부 사용자 위치에 걸쳐 또는 한 위치에 대해서만 작동 않을 수 있습니다. 

예를 들면 다음과 같습니다.

- 전역 관리자는 법적 비즈니스 및; 특정 위치에 대 한 관리자 될 수 있습니다. 또는 전역 관리자는 비즈니스 위치 중 하나만 대 한 관리자 될 수 있습니다. 
...
<li><p>파트너 센터에 대 한 지원 티켓 만들기</p></li>
