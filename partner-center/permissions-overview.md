...
||• 보기 계약, 가격 목록 및 제품
||• 뷰를 만들고 파트너 사용자 관리|
||  보기, 만들기 및 대금 청구, 송장 및 여러 파일 관리
|사용자 관리 관리자   | • 뷰를 만들고 사용자 관리
||• 모든 파트너 프로필 보기
||• 뷰를 만들고 파트너 사용자 관리  |
...
|**역할** | **수행할 수 있는 작업**|
|----------------------------|:----------------------------|
|MPN 파트너 관리자|• 뷰를 만들고 파트너 서비스 요청 관리||
||• 보기 법적, 회사, 비즈니스 및 MPN 프로필
...
||--고객 데이터 분석을 보고 하는 중
|| 회사 내 다른 사용자 역할을 볼 수 있지만 역할을 할당할 수 없습니다.
|계정 관리자| 위치 추가
|| 관리자는 계정과 관련 하 여 프로필 관리 
