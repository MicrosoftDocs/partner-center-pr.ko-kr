...
description: 파트너 대시보드에서 작업 해야 하는 모든 직원에 게 역할을 할당 되어야 합니다.
author: labrenne
...
대시보드에서 각 역할 특정 작업을 수행 하는 사용자가 특정 권한 함께 제공 됩니다. 모든 사람 작동 대시보드에서 역할이 할당 되어야 합니다.

조직의 규모에 따라 일부 사용자 위치에 걸쳐 또는 한 위치에 대해서만 작동 수 있습니다. 
