...
- [각 PCI 표시기의 임계값](partner-contribution-indicators.md#thresholds-for-each-pci-metric)

- [각 PCI 표시기의 세부 정의](partner-contribution-indicators.md#detailed-definitions-of-pci-metrics)

- 파트너 센터에서 PCI 차트에 [액세스 하 고 읽는 방법](partner-contribution-indicators.md#how-to-access-and-read-the-charts)

## <a name="overview-of-partner-contribution-indicators"></a>파트너 기여 지표 개요

파트너 기여 지표는 파트너의 성공적인 고객 결과를 구동 하는 파트너의 영향을 전체적으로 측정 하 여 파트너가 CBA (Cloud Business Applications) MPN 역량을 고성능과 하 고 유지 관리 하는 경우 시장에서 차별화 된 차이를 제공 합니다.

PCI를 사용 하는 경우 파트너는 성공적인 배포 및 사용량 증가로 인 한 고객 성공의 주요 측정을 위해 크레딧을 받고, 기술 기능을 계속 투자 하 고 확장할 수 있는 보상을 받습니다.
...
### <a name="maximum-scores-you-can-achieve-for-each-indicator"></a>각 표시기에 대해 달성할 수 있는 최대 점수
...
각 PCI 메트릭에는 회사 최대 포인트를 얻을 수 있는 Microsoft 설정 임계값이 있습니다. 이러한 임계값은 클라우드 Business Applications 역량을 실현 하기 위한 고객 참여 및 재무 및 작업 경로에 따라 다릅니다. 개발 된 시장에서 작동 하는 파트너와 시장 개발 에서만 작동 하는 파트너에 대 한 임계값도 다릅니다. 국가의 **개발** 또는 **개발** 은 [Microsoft 파트너 네트워크 정의](https://assetsprod.microsoft.com/mpn/mpn-developed-and-developing-countries.pdf)를 기준으로 합니다.
...
Net new 수익은 [이 문서의 앞부분에서 설명](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)하는 성능 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. 다음은 net new 수익을 정의 하 고 해당 점수를 계산 하는 방법에 대 한 자세한 내용입니다.
...
Net customer 추가는 [이 문서 앞부분에서 설명](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)하는 성능 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. Net customer 추가가 정의 되는 방법 및이 범주의 점이 계산 되는 방식에 대 한 자세한 내용은 다음과 같습니다.

- Net customer 추가는 10 개의 점이 가능한 최대 수를 사용 하 여 후행 12 개월 동안 합산 됩니다.
...
기능 컨설턴트는 [이 문서 앞부분에서 설명한](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)기능 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. 다음은 함수형 컨설턴트 표시기가 정의 되는 방법 및이 범주의 점이 계산 되는 방식에 대 한 자세한 내용입니다.
...
개발자는 [이 문서 앞부분에서 설명](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)하는 기능 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. 개발자 표시기가 정의 되는 방법 및이 범주의 점이 계산 되는 방식에 대 한 자세한 내용은 다음과 같습니다.
...
새 대량 배포는 [이 문서의 앞 부분에서 설명](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)하는 고객 성공 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. 새 대량 배포 표시기가 정의 되는 방법 및이 범주의 점이 계산 되는 방법에 대 한 자세한 내용은 다음과 같습니다.

- 새 대량 배포는 12 개월 동안 사용할 수 있는 최대 20 개의 점으로 합산 됩니다.

- 새 대량 배포는 고객 참여와 재정 및 운영에 대해 다르게 정의 됩니다.
...
- 파트너는 구독 수준에서 테 넌 트에 연결 됩니다. 구독은 고객 참여 제품 또는 재무 및 운영 제품에 매핑됩니다.
...
월별 활성 사용자 증가는 [이 문서의 앞 부분에서 설명](partner-contribution-indicators.md#pci-scoring-based-on-seven-key-indicators)하는 고객 성공 표시기와 7 개의 주요 파트너 기여 지표 중 하나입니다. 월별 활성 사용자 증가가 정의 되는 방법 및이 범주의 점이 계산 되는 방법에 대 한 자세한 내용은 다음과 같습니다.
...
- 파트너는 구독 수준에서 테 넌 트에 연결 됩니다. 구독은 고객 참여 또는 재무 및 운영 제품에 매핑됩니다.
...
## <a name="how-to-access-and-read-the-charts"></a>차트에 액세스 하 고 읽는 방법

이 섹션에서는 파트너 센터 대시보드에서 파트너 기여 지표에 액세스 하는 방법과 관련 차트를 읽는 방법을 설명 합니다.

### <a name="access-partner-contribution-indicators"></a>액세스 파트너 기여 지표
...
다음 이미지는 파트너 센터의 파트너 기여 지표 페이지에서 영역 및 차트의 일부를 읽는 방법을 보여 줍니다.
...
더 많은 PCI [교육 비디오 및 정보 리소스를](https://partner.microsoft.com/asset/collection/pci-learn#/)봅니다.
