...
<br>2021년 1월부터 새 수익 요구 사항이 추가됩니다. 직접 청구 파트너로 등록된 파트너는 지난 12개월 동안 파트너 글로벌 계정 수준에서 CSP 프로그램 수익에서 최소 USD$300K를 거래해야 합니다.

기존 직접 청구 테넌트를 사용하여 간접 대리점 프로그램에 등록할 수 있습니다.

## <a name="get-started"></a>시작하기

1. 파트너 센터 및 MPN(Microsoft 파트너 네트워크) ID의 파트너 프로필이 최신 상태인지 확인합니다.
...
4. 지금 등록을 선택합니다. 간접 대리점 비즈니스는 직접 비즈니스에 사용하는 것과 동일한 Azure AD(Microsoft Azure Active Directory) 테넌트 를 사용합니다.
...
2. 고객 **페이지에서** 기존 고객을 선택하고 **빠른 링크** 아이콘을 선택하여 고객의 요약 보기를 확장합니다.

3. **간접 공급자에서 간접 공급자의** **고객 이전을** 선택합니다.
...
2. **고객** 페이지에서 원하는 고객을 선택하고 빠른 링크 아이콘을 선택하여 고객의 요약 보기를 확장합니다.
...
6. **구독 전송에서** 검토할 전송 요청을 선택합니다.

7. 적절하게 **수락(또는** **거부)을** 선택합니다.
