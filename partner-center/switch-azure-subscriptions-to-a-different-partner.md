...
>[!Note]  
>이번에는 직접 또는 간접 공급자만 구독을 전송할 수 있습니다.
>현재 Office 365, Enterprise Mobility Suite 또는 Microsoft Dynamics CRM 구독에 대 한 클라우드 솔루션 공급자 구독의 파트너를 변경할 수 없습니다.
...
- 현재 파트너의 연락처 정보 및 Microsoft ID. 파트너 센터 메뉴에서 **계정 설정** &gt; **조직 프로필**을 선택 하 고 여기에 나열 된 **Microsoft ID**, **조직 이름**및 **주소** 를 사용 합니다.
...
**2**- 원래 Azure 구독 ID는 유지되며 Azure 관리 포털뿐만 아니라 파트너 센터에도 표시됩니다. 이 ID는 사용자의 조정 파일에 나타납니다.  **지원 티켓을 기록 하는 경우 두 Id를 모두 사용 해야 합니다.**
...
**PS C:\\&gt; Connect-azurermaccount-테 넌 트 "CustomerDomainName"**
