...
|<span data-ttu-id="e75c2-141">없음</span><span class="sxs-lookup"><span data-stu-id="e75c2-141">None</span></span> | <span data-ttu-id="e75c2-142">주소가 올바르지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-142">Address is incorrect.</span></span> | <span data-ttu-id="e75c2-143">없음</span><span class="sxs-lookup"><span data-stu-id="e75c2-143">None</span></span> |
...
- <span data-ttu-id="e75c2-158">2021년 4월 30일: 샘플 응답 및 우편 번호 정보 업데이트</span><span class="sxs-lookup"><span data-stu-id="e75c2-158">April 30, 2021: Updates for sample response and Zip code details</span></span>
...
<span data-ttu-id="e75c2-171">새 EAC의 이점은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-171">Benefits of the new EAC include:</span></span>
...
### <a name="categories"></a><span data-ttu-id="e75c2-184">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-184">Categories</span></span>
...
- <span data-ttu-id="e75c2-215">날짜: 2021-03-25</span><span class="sxs-lookup"><span data-stu-id="e75c2-215">Date: 2021-03-25</span></span>
...
2. <span data-ttu-id="e75c2-226">파트너가 다음 국가의 신규 또는 기존 고객과 함께 비즈니스를 수행합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-226">The partner does business with new or existing customers in the following countries:</span></span>
    ...
    - <span data-ttu-id="e75c2-236">남수단</span><span class="sxs-lookup"><span data-stu-id="e75c2-236">South Sudan</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="e75c2-256">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-256">Next steps</span></span>
...
### <a name="impacted-audience"></a><span data-ttu-id="e75c2-270">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-270">Impacted audience</span></span>
...
### <a name="categories"></a><span data-ttu-id="e75c2-285">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-285">Categories</span></span>
...
<span data-ttu-id="e75c2-298">고객 디렉터리 역할 시나리오를 지원하기 위한 새 [리소스 및 작업 유형](/partner-center/develop/auditing-resources)이 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-298">Added new [resource and operation types](/partner-center/develop/auditing-resources) for supporting the customer directory role scenario.</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="e75c2-317">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-317">Next Steps</span></span>
...
<span data-ttu-id="e75c2-329">아래에서 이 CSP 상업용 Marketplace 제품 인센티브에 대해 계속 알아보고, 오늘 고객에게 연락하여 지속적인 성공 및 디지털 변환을 가능하게 해주는 올바른 제품을 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-329">Continue learning about this CSP Commercial Marketplace Offer incentive below and contact your customers today to identify the right offers to enable their continued success and digital transformation.</span></span>
...
### <a name="questions"></a><span data-ttu-id="e75c2-346">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-346">Questions?</span></span>  
...
| ------ |----------|
| <span data-ttu-id="e75c2-389">Power BI Pro(비영리 직원 가격)</span><span class="sxs-lookup"><span data-stu-id="e75c2-389">Power BI Pro (Nonprofit Staff Pricing)</span></span>  |   <span data-ttu-id="e75c2-390">cabdfc93-5786-4224-bfd3-35d58f833b35</span><span class="sxs-lookup"><span data-stu-id="e75c2-390">cabdfc93-5786-4224-bfd3-35d58f833b35</span></span> |
...
### <a name="summary"></a><span data-ttu-id="e75c2-429">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-429">Summary</span></span>
...
### <a name="questions"></a><span data-ttu-id="e75c2-442">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-442">Questions?</span></span>
...
________________
## <a name="update-to-cloud-solution-provider-csp-program-evolution-and-open-license-program-changes"></a><a name="9"></a><span data-ttu-id="e75c2-444">CSP(클라우드 솔루션 공급자) 프로그램 진화 및 오픈 라이선스 프로그램 변경 사항에 대한 업데이트</span><span class="sxs-lookup"><span data-stu-id="e75c2-444">Update to Cloud Solution Provider (CSP) program evolution and Open License program changes</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-445">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-445">Categories</span></span>

- <span data-ttu-id="e75c2-446">날짜: 2021-03-15</span><span class="sxs-lookup"><span data-stu-id="e75c2-446">Date: 2021-03-15</span></span>
- <span data-ttu-id="e75c2-447">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-447">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-448">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-448">Summary</span></span>

<span data-ttu-id="e75c2-449">새로운 상용 및 공공 부문 영구 소프트웨어 제품이 오픈 라이선스 프로그램의 변경 사항과 함께 CSP(클라우드 솔루션 공급자) 프로그램에 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-449">New commercial and public sector perpetual software offers are coming to the Cloud Solution Provider (CSP) program along with changes to the Open Licensing program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-450">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-450">Impacted audience</span></span>

<span data-ttu-id="e75c2-451">오픈 라이선스 프로그램뿐만 아니라 모든 CSP 파트너 거래 영구 소프트웨어를 통해 판매되는 상업적 배포자 및 관리 재판매인</span><span class="sxs-lookup"><span data-stu-id="e75c2-451">Commercial distributors and managed resellers selling through the Open License program, as well as all CSP partners transacting perpetual software</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-452">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-452">Details</span></span>

<span data-ttu-id="e75c2-453">2020년 9월 Microsoft는 파트너를 위한 온-프레미스 소프트웨어의 가용성을 포함하여 CSP 프로그램의 파트너에 대한 기회를 확장하는 디지털 변환 과정에서 일련의 단계를 [발표](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/)했습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-453">In September 2020, Microsoft [announced](https://blogs.partner.microsoft.com/mpn/expanding-opportunities-for-partners-in-the-cloud-solution-provider-program/) a series of steps in our digital transformation journey to expand opportunities to partners in the CSP program, including the availability of on-premises software for partners.</span></span> <span data-ttu-id="e75c2-454">이러한 변화를 통해 파트너는 CSP의 소프트웨어 라이선스를 활용하여 비즈니스를 성장시키고 범위를 확장하여 오늘날의 클라우드 우선 세계에서 성공을 거둘 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-454">These changes enable partners to grow their business and extend their reach by leveraging software licenses in CSP, positioning them for success in today’s cloud-first world.</span></span> <span data-ttu-id="e75c2-455">또한 고객의 클라우드 전환을 지원하고 파트너에게 고객 하이브리드 클라우드 환경에 필요한 유연성을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-455">They also empower customers’ transitions to the cloud and give partners the flexibility needed for customer hybrid cloud environments.</span></span>

<span data-ttu-id="e75c2-456">이와 같은 디지털 전환 과정을 계속 진행하면서 다음과 같은 변경 사항을 발표합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-456">In continuation of this digital transformation, we are announcing the following changes:</span></span>

- <span data-ttu-id="e75c2-457">2021년 7월 1일: 오픈 라이선스 프로그램 가격표에 새 SKU, 제품 또는 프로모션이 추가되지 않습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-457">July 1, 2021:  No new SKUs, products, or promotions will be added to the Open License program price list.</span></span>

- <span data-ttu-id="e75c2-458">2021년 7월 7일: 두 개의 상용 제품인 Get Genuine Windows 및 Visual Studio Professional과 공공 부문 제품(정부, 교육 및 비영리 – [공지](./2020-december.md#9) 참조)이 CSP 영구 소프트웨어 가격표에 추가됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-458">July 7, 2021:  Two commercial offers, Get Genuine Windows and Visual Studio Professional, and public sector offers (government, education and nonprofit – see [announcement](./2020-december.md#9)) will be added to the CSP perpetual software price list.</span></span>  <span data-ttu-id="e75c2-459">가격표는 파트너 센터의 [판매 > 가격 및 제안](https://partnercenter.microsoft.com/pcv/sales) 페이지에 있는 소프트웨어 섹션에서 찾을 수 있으며 이 날짜에 다시 게시됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-459">The price list can be found in the Software section of the [Sell > Pricing & Offers](https://partnercenter.microsoft.com/pcv/sales) page in Partner Center and will be republished on this date.</span></span>

<span data-ttu-id="e75c2-460">CSP 프로그램 발전 및 Open License 프로그램 변경에 대한 자세한 내용은 아래 **다음 단계** 를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-460">For full details regarding the CSP program evolution and Open License program changes, please see **Next Steps** below.</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-461">다음 단계:</span><span class="sxs-lookup"><span data-stu-id="e75c2-461">Next Steps:</span></span>

- <span data-ttu-id="e75c2-462">CSP 프로그램 진화: [클라우드 솔루션 공급자 프로그램의 영구 소프트웨어](https://partner.microsoft.com/resources/collection/software-in-csp#/) 준비 자료를 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-462">CSP Program evolution:  Review the [Perpetual software in the Cloud Solution Provider program](https://partner.microsoft.com/resources/collection/software-in-csp#/) readiness materials.</span></span> <span data-ttu-id="e75c2-463">이 [준비 맵](https://partner.microsoft.com/resources/detail/software-in-csp-readiness-map-pdf)을 사용하여 역할에 필요한 정보를 신속하게 찾을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-463">Use this [readiness map](https://partner.microsoft.com/resources/detail/software-in-csp-readiness-map-pdf) to quickly locate the right information for your role.</span></span>

- <span data-ttu-id="e75c2-464">오픈 라이선스 프로그램 변경: [CSP 프로그램 진화 및 오픈 라이선스 프로그램 변경](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) 준비 자료를 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-464">Open License program changes:  Review the [CSP program evolution and Open License program changes](https://partner.microsoft.com/resources/collection/csp-open-evolution-to-a-better-experience#/) readiness materials.</span></span> <span data-ttu-id="e75c2-465">이 [준비 맵](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf)을 사용하여 역할에 필요한 정보를 신속하게 찾을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-465">Use this [readiness map](https://partner.microsoft.com/resources/detail/csp-open-evolution-to-a-better-experience-readiness-map-pdf) to quickly locate the right information for your role.</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-466">질문</span><span class="sxs-lookup"><span data-stu-id="e75c2-466">Questions</span></span>

<span data-ttu-id="e75c2-467">추가 질문은 관련 CSP Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-467">For any further questions please check your relevant CSP Yammer communities.</span></span>

_______________
## <a name="update-to-a-previous-announcement-premium-assessments-an-add-on-to-compliance-manager"></a><a name="8"></a><span data-ttu-id="e75c2-468">이전 공지에 대한 업데이트: Compliance Manager의 추가 기능인 프리미엄 평가</span><span class="sxs-lookup"><span data-stu-id="e75c2-468">Update to a previous announcement: Premium Assessments, an add-on to Compliance Manager</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-469">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-469">Categories</span></span>

- <span data-ttu-id="e75c2-470">날짜: 2021-03-15</span><span class="sxs-lookup"><span data-stu-id="e75c2-470">Date: 2021-03-15</span></span>
- <span data-ttu-id="e75c2-471">비즈니스 성장</span><span class="sxs-lookup"><span data-stu-id="e75c2-471">Grow your business</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-472">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-472">Summary</span></span>

<span data-ttu-id="e75c2-473">평가판 제품은 가격표에 나열되지 않으며 제거됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-473">The trial offers shouldn’t have been listed on the price list and will be removed.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-474">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-474">Impacted audience</span></span>

<span data-ttu-id="e75c2-475">클라우드 솔루션 공급자를 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-475">Partners transacting through Cloud Solution Provider</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-476">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-476">Details</span></span>

<span data-ttu-id="e75c2-477">평가판 제품은 가격표에 포함되지 않았어야 했습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-477">The trial offers shouldn’t have been included in the price list.</span></span> <span data-ttu-id="e75c2-478">이들 제품은 2021년 5월 1일 가격표에서 제거됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-478">These will be removed from the May 1, 2021 price list.</span></span>

<span data-ttu-id="e75c2-479">원래 공지는 [여기](./2021-february.md#4)에 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-479">The original announcement is [here](./2021-february.md#4).</span></span>

### <a name="additional-resources"></a><span data-ttu-id="e75c2-480">추가 자료</span><span class="sxs-lookup"><span data-stu-id="e75c2-480">Additional resources</span></span>

- [<span data-ttu-id="e75c2-481">Microsoft 365 E5 보안 및 규정 준수</span><span class="sxs-lookup"><span data-stu-id="e75c2-481">Microsoft 365 E5 security and compliance</span></span>](https://www.microsoft.com/licensing/product-licensing/microsoft-365-enterprise?activetab=m365-enterprise:primaryr5)

- [<span data-ttu-id="e75c2-482">Microsoft Compliance Manager에서 평가 빌드 및 관리 - Microsoft 365 Compliance</span><span class="sxs-lookup"><span data-stu-id="e75c2-482">Build and manage assessments in Microsoft Compliance Manager - Microsoft 365 Compliance</span></span>](/microsoft-365/compliance/compliance-manager-assessments)

### <a name="next-steps"></a><span data-ttu-id="e75c2-483">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-483">Next steps</span></span>

<span data-ttu-id="e75c2-484">이 항목에 대한 리소스를 검토하고, 이 정보를 조직 내의 적절한 관련자와 공유합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-484">Review the resources about this topic, and share this information with the appropriate stakeholders in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-485">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-485">Questions?</span></span>

<span data-ttu-id="e75c2-486">이 제품에 대한 질문이 있는 경우 관련 Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-486">For questions about these offers, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-solutions-from-one-commercial-partner-ocp-go-to-market-gtm-to-the-microsoft-commercial-marketplace"></a><a name="7"></a><span data-ttu-id="e75c2-487">OCP(One Commercial Partner) GTM(Go-to Market)에서 Microsoft 상업용 Marketplace로 솔루션 마이그레이션</span><span class="sxs-lookup"><span data-stu-id="e75c2-487">Migrate your solutions from One Commercial Partner (OCP) go-to market (GTM) to the Microsoft commercial marketplace</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-488">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-488">Categories</span></span>

- <span data-ttu-id="e75c2-489">날짜: 2021-03-12</span><span class="sxs-lookup"><span data-stu-id="e75c2-489">Date: 2021-03-12</span></span>
- <span data-ttu-id="e75c2-490">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-490">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-491">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-491">Summary</span></span>

<span data-ttu-id="e75c2-492">2021년 3월 29일부터 OCP(One Commercial Partner) GTM(Go-to Market) 기능을 제한하는 것으로 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-492">From March 29, 2021, you will begin to experience limited One Commercial Partner (OCP) go-to market (GTM) capabilities.</span></span> <span data-ttu-id="e75c2-493">파트너 센터에서 상업용 Marketplace로 솔루션을 마이그레이션하는 것이 좋습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-493">We encourage you to migrate your solutions to the commercial marketplace in Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-494">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-494">Impacted audience</span></span>

<span data-ttu-id="e75c2-495">OCP GTM에서 솔루션과 공동 판매하는 조직</span><span class="sxs-lookup"><span data-stu-id="e75c2-495">Organizations co-selling with solutions in OCP GTM</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-496">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-496">Details</span></span>

<span data-ttu-id="e75c2-497">2020년 12월에 Microsoft OCP GTM 도구에서 파트너 센터의 Microsoft 상업 시장으로 이동하기 시작했습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-497">In December 2020, we started our journey from the Microsoft OCP GTM tool to the Microsoft commercial marketplace in Partner Center.</span></span> <span data-ttu-id="e75c2-498">이러한 전환은 수백만 고객에게 솔루션을 선보이고 다른 Microsoft 및 파트너 판매자와 양방향으로 기회를 공유하며 혁신적인 솔루션을 공동 판매할 수 있는 상용 시장의 기능을 확장합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-498">This transition expands the capabilities of the commercial marketplace where you can showcase your solutions to millions of customers, bidirectionally share opportunities with other Microsoft and partner sellers, and jointly sell innovative solutions.</span></span>

<span data-ttu-id="e75c2-499">전환의 다음 마일스톤은 2021년 3월 29일에 진행됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-499">The next milestone in the transition will take place on March 29, 2021.</span></span> <span data-ttu-id="e75c2-500">이때 일부 필드가 읽기 전용으로 되는 제한된 OCP GTM 기능을 경험하게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-500">That’s when you’ll begin to experience limited OCP GTM capabilities, with some fields becoming read-only.</span></span> <span data-ttu-id="e75c2-501">현재 OCP GTM의 솔루션과 공동 판매 중인 경우 솔루션을 상용 시장으로 마이그레이션하여 기능을 활용하고 게시 환경을 단순화하는 것이 좋습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-501">If you’re currently co-selling with solutions in OCP GTM, we encourage you to migrate your solutions to the commercial marketplace to take advantage of its capabilities and simplify your publishing experience.</span></span>

<span data-ttu-id="e75c2-502">상업용 Marketplace로 전환하면 파트너 센터가 공동 판매 게시 환경의 주 대상이 됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-502">Moving to the commercial marketplace makes Partner Center the primary destination for the co-sell publishing experience.</span></span> <span data-ttu-id="e75c2-503">Microsoft 제품에 사용되는 것과 동일한 채널 및 제품 내 환경을 통해 솔루션을 공유 고객과 연결하여 비즈니스를 계속 성장시킬 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-503">It’s where you can continue to grow your business by connecting your solutions with our shared customers through the same channels and in-product experiences that we use for Microsoft products.</span></span> <span data-ttu-id="e75c2-504">[상업용 Marketplace에 대해 자세히 알아보세요](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span><span class="sxs-lookup"><span data-stu-id="e75c2-504">[Learn more about the commercial marketplace](https://blogs.partner.microsoft.com/mpn/getting-started-with-the-microsoft-commercial-marketplace/).</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-505">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-505">Next steps</span></span>

- <span data-ttu-id="e75c2-506">솔루션을 아직 이동하지 않은 경우 [전환 가이드](/azure/marketplace/co-sell-solution-migration)에 설명된 지침을 따르거나 [단계별 비디오 자습서](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4)를 참조하여 모든 마이그레이션 작업을 완료하고 상업용 Marketplace에 솔루션을 게시하기 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-506">If you have not yet moved your solutions, follow the instructions detailed in the [transition guide](/azure/marketplace/co-sell-solution-migration) or view the [step-by-step video tutorial](https://partner.microsoft.com/asset/detail/ocp-gtm-to-the-microsoft-commercial-marketplace-mp4) to complete all migration activities and start publishing your solution(s) in the commercial marketplace.</span></span>

- <span data-ttu-id="e75c2-507">OCP GTM의 제한된 기능 환경과 관련된 질문은 [Microsoft 상업용 Marketplace FAQ에서 게시하기 위한 공동 판매 요구 사항](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf)을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-507">For questions regarding the limited capability experience in OCP GTM, view the [Co-sell requirements to publish in the Microsoft commercial marketplace FAQ](https://partner.microsoft.com/resources/detail/co-sell-requirements-publish-commercial-marketplace-faq-pdf).</span></span> <span data-ttu-id="e75c2-508">("2021년 3월 29일부터 시작되는 OCP GTM 제한된 기능" 섹션을 참조하세요.)</span><span class="sxs-lookup"><span data-stu-id="e75c2-508">(See the section “OCP GTM limited capabilities starting March 29, 2021.”)</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-509">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-509">Questions?</span></span>

<span data-ttu-id="e75c2-510">궁금한 사항이 있거나 추가 정보가 필요한 경우 [지원 팀](https://partner.microsoft.com/support/?stage=1)에게 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-510">Contact [Support](https://partner.microsoft.com/support/?stage=1) if you have any questions or need more information.</span></span>

________________
## <a name="programmatic-access-to-commercial-marketplace-analytics"></a><a name="6"></a><span data-ttu-id="e75c2-511">상업용 Marketplace 분석에 대한 프로그래매틱 액세스</span><span class="sxs-lookup"><span data-stu-id="e75c2-511">Programmatic access to commercial marketplace analytics</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-512">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-512">Categories</span></span>

- <span data-ttu-id="e75c2-513">날짜: 2021-03-10</span><span class="sxs-lookup"><span data-stu-id="e75c2-513">Date: 2021-03-10</span></span>
- <span data-ttu-id="e75c2-514">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-514">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-515">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-515">Summary</span></span>

<span data-ttu-id="e75c2-516">파트너는 이제 분석 보고서에 프로그래밍 방식으로 액세스하여 상업용 Marketplace에서 판매를 모니터링하고, 성능을 평가하고, 제품을 최적화할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-516">Partners can now programmatically access analytics reports to monitor sales, evaluate performance, and optimize offers in the commercial marketplace.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-517">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-517">Impacted audience</span></span>

<span data-ttu-id="e75c2-518">상업용 Marketplace의 제품을 사용하는 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-518">Partners with offers in the commercial marketplace.</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-519">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-519">Details</span></span>

<span data-ttu-id="e75c2-520">상업적 마켓플레이스 보고서에 액세스하기 위한 API를 사용하면 분석 데이터의 사용자 지정 보고서를 비동기적으로 예약할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-520">The API for accessing commercial marketplace reports enable you to schedule custom reports of your analytics data asynchronously.</span></span>

<span data-ttu-id="e75c2-521">이 기능을 사용하면 사용자의 요구에 따라 보고 쿼리 및 템플릿을 정의하고, 일정을 설정하고, 예약된 주기로 적시에 신뢰할 수 있는 보고서를 가져올 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-521">The capability enables you to define reporting queries and templates based on your needs, set a schedule, and get timely and trustworthy reports at scheduled intervals.</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-522">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-522">Next steps</span></span>

<span data-ttu-id="e75c2-523">자세한 내용은 [분석에 대한 프로그래매틱 액세스 시작](/azure/marketplace/analytics-get-started)을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-523">To learn more, see [Get started with programmatic access to analytics](/azure/marketplace/analytics-get-started).</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-524">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-524">Questions?</span></span>

<span data-ttu-id="e75c2-525">추가 질문이 있는 경우 [고객 지원](https://go.microsoft.com/fwlink/?linkid=2165533)으로 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-525">Contact [Support](https://go.microsoft.com/fwlink/?linkid=2165533) if you have any further questions.</span></span>

________________
## <a name="expanding-the-new-commerce-experience-in-the-cloud-solution-provider-csp-program-for-azure-to-russia"></a><a name="5"></a><span data-ttu-id="e75c2-526">Azure용 CSP(클라우드 솔루션 공급자) 프로그램의 새로운 상거래 경험을 러시아로 확장</span><span class="sxs-lookup"><span data-stu-id="e75c2-526">Expanding the new commerce experience in the Cloud Solution Provider (CSP) program for Azure to Russia</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-527">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-527">Categories</span></span>

- <span data-ttu-id="e75c2-528">날짜: 2021-03-10</span><span class="sxs-lookup"><span data-stu-id="e75c2-528">Date: 2021-03-10</span></span>
- <span data-ttu-id="e75c2-529">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-529">Capabilities</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-530">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-530">Impacted audience</span></span>

<span data-ttu-id="e75c2-531">CSP(클라우드 솔루션 공급자) 프로그램을 통해 거래하는 러시아의 모든 파트너.</span><span class="sxs-lookup"><span data-stu-id="e75c2-531">All partners in Russia transacting through the Cloud Solution Provider (CSP) program.</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-532">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-532">Details</span></span>

<span data-ttu-id="e75c2-533">2021년 3월 10일부터 **러시아 Azure용 CSP의 새로운 상거래 환경** 을 사용할 수 있게 되어 기쁘게 생각합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-533">Starting March 10 2021, we’re excited to announce the availability of the **new commerce experience in CSP for Azure in Russia**.</span></span> <span data-ttu-id="e75c2-534">이 경험은 고객이 Azure 서비스를 구매하고 사용하는 방식을 간소화하고 개선합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-534">This experience will streamline and improve the way customers buy and consume Azure services.</span></span> <span data-ttu-id="e75c2-535">또한 CSP 프로그램의 파트너에게 판매 활동 전반에 걸친 Azure 가격 책정, 글로벌 일관성을 위한 USD 가격 책정, 청구 날짜 조정 및 Azure Cost Management에 대한 액세스를 일관된 보기로 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-535">It will also give partners in the CSP program a consistent view of Azure pricing across sales motions, USD pricing for global consistency, billing date alignment, and access to Azure Cost Management.</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-536">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-536">Next steps</span></span>

<span data-ttu-id="e75c2-537">새로운 Azure 상거래 경험을 소개하고 추가 정보를 제공할 수 있는 몇 가지 리소스가 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-537">There are several resources available introducing the new Azure commerce experience and providing additional information.</span></span> <span data-ttu-id="e75c2-538">[CSP 프로그램 업데이트 리소스 갤러리](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/)에서 최신 FAQ, 데크, 비디오 등을 찾아보세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-538">Find the latest FAQs, decks, video and more in the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources/collection/new-azure-experience-in-csp#/).</span></span>

________________
## <a name="partner-center-software-license-key-and-download-fulfillment"></a><a name="4"></a><span data-ttu-id="e75c2-539">파트너 센터 소프트웨어 라이선스 키 및 다운로드 이행</span><span class="sxs-lookup"><span data-stu-id="e75c2-539">Partner Center software license key and download fulfillment</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-540">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-540">Categories</span></span>

- <span data-ttu-id="e75c2-541">날짜: 2021-03-04</span><span class="sxs-lookup"><span data-stu-id="e75c2-541">Date: 2021-03-04</span></span>
- <span data-ttu-id="e75c2-542">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-542">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-543">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-543">Summary</span></span>

<span data-ttu-id="e75c2-544">파트너 센터 소프트웨어 다운로드 및 라이선스 키 이행 기능이 복구되었습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-544">The Partner Center software download and license key fulfillment capability has been reinstated.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-545">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-545">Impacted audience</span></span>

<span data-ttu-id="e75c2-546">파트너 센터를 통해 정품 및 서버 구독 소프트웨어 주문을 거래하는 모든 CSP(클라우드 솔루션 공급자) 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-546">All Cloud Solution Provider (CSP) partners transacting perpetual and server subscription software orders through Partner Center</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-547">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-547">Details</span></span>

<span data-ttu-id="e75c2-548">파트너의 피드백에 따라 파트너 센터에서 영구적인 서버 구독 소프트웨어 주문의 소프트웨어 및 라이선스 키를 얻을 수 있도록 파트너 센터 이행 기능을 복원 중입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-548">In response to partner feedback, we’re reinstating the Partner Center fulfillment capability to obtain software and license keys for perpetual and server subscription software orders.</span></span> <span data-ttu-id="e75c2-549">이 기능은 2021년 1월 19일에 제거되기 이전 상태로 복원됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-549">It will be restored to its previous state prior to being removed on January 19, 2021.</span></span> <span data-ttu-id="e75c2-550">([공지](2020-september.md#17)를 참조하세요.)</span><span class="sxs-lookup"><span data-stu-id="e75c2-550">(See the [announcement](2020-september.md#17).)</span></span>

<span data-ttu-id="e75c2-551">소프트웨어 라이선스 키와 다운로드 링크는 매우 소중하고 인기가 많은 지적 자산입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-551">Note that software license keys and download links are valuable and highly sought-after intellectual property assets.</span></span> <span data-ttu-id="e75c2-552">유출될 경우 활성화 제한이 빠르게 삭제되어 고객 및 파트너 환경에 부정적인 영향을 미칠 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-552">If leaked, they can quickly be depleted of their activation limits and cause a negative customer and partner experience.</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-553">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-553">Next steps</span></span>

<span data-ttu-id="e75c2-554">소프트웨어 키 사용 및 배포에 대한 다음 리소스와 중요 지침을 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-554">Review the following resources for usage instructions and important guidance on software key distribution:</span></span>

- [<span data-ttu-id="e75c2-555">CSP 프로그램을 통해 온-프레미스 소프트웨어 판매</span><span class="sxs-lookup"><span data-stu-id="e75c2-555">Sell on-premises software through the CSP program</span></span>](../csp-on-premise-software.md)
- <span data-ttu-id="e75c2-556">[파트너 센터 새 상거래 운영 가이드](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf)(**소프트웨어 키 배포에 대한 지침** 섹션 참조)</span><span class="sxs-lookup"><span data-stu-id="e75c2-556">[Partner Center New Commerce Operations Guide](https://partner.microsoft.com/resources/detail/partner-center-new-commerce-operations-guide-pdf) (See the **Guidance on Software Key Distribution** section.)</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-557">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-557">Questions?</span></span>

<span data-ttu-id="e75c2-558">이 공지에 대한 추가 질문은 관련 Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-558">If you have any further questions about this notice, check your relevant Yammer communities.</span></span>

________________
## <a name="migrate-your-deals-from-partner-sales-connect-psc-to-partner-center"></a><span data-ttu-id="e75c2-559"><a name="3">PSC(Partner Sales Connect)에서 파트너 센터로 거래 마이그레이션</a></span><span class="sxs-lookup"><span data-stu-id="e75c2-559"><a name="3"></a>Migrate your deals from Partner Sales Connect (PSC) to Partner Center</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-560">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-560">Categories</span></span>

- <span data-ttu-id="e75c2-561">날짜: 2021-03-04</span><span class="sxs-lookup"><span data-stu-id="e75c2-561">Date: 2021-03-04</span></span>
- <span data-ttu-id="e75c2-562">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-562">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-563">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-563">Summary</span></span>

<span data-ttu-id="e75c2-564">2021년 3월 31일부터 PSC(Partner Sales Connect)가 읽기 전용 액세스로 전환되므로 PSC의 거래를 파트너 센터로 마이그레이션하는 것이 좋습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-564">Partner Sales Connect (PSC) will move to read-only access starting March 31, 2021, so we urge you to begin migrating your deals from PSC to Partner Center.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-565">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-565">Impacted audience</span></span>

<span data-ttu-id="e75c2-566">PSC에서 거래하는 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-566">Partners with deals in PSC</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-567">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-567">Details</span></span>

<span data-ttu-id="e75c2-568">동반 성장이라는 약속을 지키기 위한 방편 중 하나인 **Microsoft와 공동 판매** 는 파트너가 **검색되고, 전문 지식을 제공하고, 고객 범위를 확장** 하여 긍정적인 고객 결과를 얻을 수 있는 경로입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-568">As part of our shared commitment to growth, **co-sell with Microsoft** is the path for you to **be discovered, deliver your expertise, and expand your customer footprint** for positive customer outcomes.</span></span> <span data-ttu-id="e75c2-569">평균 거래 속도가 일반 판매보다 **3.5배 빠르기 때문에** 파트너 센터에서 공동 판매 환경을 관리하면 직접 고객, 파트너 및 Microsoft 판매자 채널을 통해 판매하고 전체 추천 파이프라인을 한 곳에서 관리할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-569">With an average deal that’s **3.5 times faster** than normal, managing your co-sell experience in Partner Center allows you to sell across the direct customer, partner, and Microsoft seller channels, and manage your entire referral pipeline in one location.</span></span>

<span data-ttu-id="e75c2-570">**2021년 3월 31일** 부터 **PSC** 가 **읽기 전용 액세스** 로 전환되므로 파트너 센터로 이동하여 개선된 기능을 사용하는 것이 좋습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-570">**PSC** will move to **read-only access** starting **March 31, 2021**, so we urge you to start your move to Partner Center and access these capability improvements:</span></span> 

- <span data-ttu-id="e75c2-571">필요한 지원의 종류에 따라 Microsoft와 공유하는 거래를 적절한 판매자에게 **보다 정확하게 라우팅** 합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-571">**More accurate routing** of the deals that you share with Microsoft to the right seller, based on the type of assistance you need.</span></span>
- <span data-ttu-id="e75c2-572">인센티브 대상 솔루션을 결정하고 ISV Connect 프로그램 조건을 충족하기 위한 **거래 자격 사전 평가** 를 도입했으며, 승인 프로세스 및 POE(최종 실행 증명서) 입증이 간소화될 것입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-572">**Upfront deal eligibility validation** for incentive-eligible solutions and to meet the ISV Connect program criteria, simplifying the approval process and final proof of execution (POE) attestation.</span></span>
- <span data-ttu-id="e75c2-573">공동 판매 기회와 영업부에서 확인한 잠재 고객을 모두 한 곳에서 관리하는 **원활한 사용자 환경** 을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-573">**Seamless user experience** to manage all your co-sell opportunities and sales qualified leads in one place.</span></span>

<span data-ttu-id="e75c2-574">또한 최근에는 파트너의 전환을 도와주기 위해 파트너 센터에 새로운 기능을 추가했습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-574">We’ve also recently added new features in Partner Center to assist in your move:</span></span>

- [<span data-ttu-id="e75c2-575">공동 판매 기회를 대량으로 작업</span><span class="sxs-lookup"><span data-stu-id="e75c2-575">Bulk operations for co-sell opportunities</span></span>](../bulk-operations.md)
- <span data-ttu-id="e75c2-576">[거래 마이그레이션 기능](../psc-to-pc.md)(**PSC 거래 마이그레이션** 섹션 참조)</span><span class="sxs-lookup"><span data-stu-id="e75c2-576">[Deal migration feature](../psc-to-pc.md) (See the **PSC Deals migration** section.)</span></span>

<span data-ttu-id="e75c2-577">파트너 센터에서 공동 판매 환경을 사용하면 영업 팀은 잠재 고객 및 기회를 창출하고, 거래를 완료하고, 지속적인 고객 관계를 만드는 데 더 많은 시간을 투자할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-577">Using the co-sell experience in Partner Center, your sales teams will have more time to focus on nurturing leads and opportunities, closing deals, and creating lasting customer relationships.</span></span>

### <a name="next-steps"></a><span data-ttu-id="e75c2-578">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-578">Next steps</span></span>

<span data-ttu-id="e75c2-579">파트너 센터 [전환 가이드](../psc-to-pc.md)를 사용하여 PSC의 거래를 파트너 센터로 마이그레이션하는 단계를 알아보세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-579">Use the Partner Center [transition guide](../psc-to-pc.md) to walk you through the steps to migrate your deals from PSC to Partner Center.</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-580">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-580">Questions?</span></span>

<span data-ttu-id="e75c2-581">추가 질문은 [고객 지원](https://partner.microsoft.com/support/?stage=1)으로 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-581">For any further questions, contact [Support](https://partner.microsoft.com/support/?stage=1).</span></span>

________________
## <a name="new-microsoft-dynamics-365-products-and-offers-available-on-april-1-2021"></a><a name="2"></a><span data-ttu-id="e75c2-582">2021년 4월 1일에 사용 가능한 새로운 Microsoft Dynamics 365 제품 및 제안</span><span class="sxs-lookup"><span data-stu-id="e75c2-582">New Microsoft Dynamics 365 products and offers available on April 1, 2021</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-583">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-583">Categories</span></span>

- <span data-ttu-id="e75c2-584">날짜: 2021-03-04</span><span class="sxs-lookup"><span data-stu-id="e75c2-584">Date: 2021-03-04</span></span>
- <span data-ttu-id="e75c2-585">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-585">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-586">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-586">Summary</span></span>

<span data-ttu-id="e75c2-587">2021년 4월 1일에 Microsoft는 CSP(클라우드 솔루션 공급자) 프로그램에 대한 여러 가지 신제품을 출시할 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-587">On April 1, 2021, Microsoft will be launching several new products and offers for the Cloud Solution Provider (CSP) program.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-588">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-588">Impacted audience</span></span>

<span data-ttu-id="e75c2-589">CSP(클라우드 솔루션 공급자) 프로그램을 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-589">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-590">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-590">Details</span></span>

<span data-ttu-id="e75c2-591">2021년 4월 1일에 Microsoft는 다음과 같은 신제품을 출시할 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-591">On April 1, 2021, Microsoft will be launching the following new products and offers:</span></span>

- <span data-ttu-id="e75c2-592">Power BI Premium Per User</span><span class="sxs-lookup"><span data-stu-id="e75c2-592">Power BI Premium Per User</span></span>
- <span data-ttu-id="e75c2-593">Customer Voice and Marketing USL 지역 및 세그먼트 확장</span><span class="sxs-lookup"><span data-stu-id="e75c2-593">Customer Voice and Marketing USL geo and segment expansion</span></span>

<span data-ttu-id="e75c2-594">**Power BI Premium Per User**</span><span class="sxs-lookup"><span data-stu-id="e75c2-594">**Power BI Premium Per User**</span></span>

<span data-ttu-id="e75c2-595">Microsoft 최초의 사용자 단위 Power BI Premium 제품이 곧 출시됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-595">Microsoft will introduce the first per-user Power BI Premium offers.</span></span> <span data-ttu-id="e75c2-596">Power BI Premium은 현재 용량 구성으로만 판매됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-596">Power BI Premium is currently sold only in a capacity construct.</span></span> <span data-ttu-id="e75c2-597">Power BI Premium Per User는 엔터프라이즈 BI(비즈니스 인텔리전스) 및 분석 기능에 대한 액세스를 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-597">Power BI Premium Per User provides access to enterprise business intelligence (BI) and analytics capabilities.</span></span> <span data-ttu-id="e75c2-598">유연한 개별 사용자 단위 라이선스는 중소기업에 적합합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-598">Its flexible individual seat licensing caters to small and medium-sized businesses.</span></span>

<span data-ttu-id="e75c2-599">이 제품에 대한 자세한 내용은 [Power BI 릴리스 정보](/power-platform-release-plan/2020wave2/power-bi/planned-features)를 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-599">Review the [Power BI release details](/power-platform-release-plan/2020wave2/power-bi/planned-features) to learn more about this offer.</span></span>


<span data-ttu-id="e75c2-600">**솔루션 세부 정보**</span><span class="sxs-lookup"><span data-stu-id="e75c2-600">**Offer details**</span></span>

<span data-ttu-id="e75c2-601">제품 이름은 가격표 미리 보기와 약간 다릅니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-601">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="e75c2-602">Offer name</span><span class="sxs-lookup"><span data-stu-id="e75c2-602">Offer name</span></span> | <span data-ttu-id="e75c2-603">제품 ID</span><span class="sxs-lookup"><span data-stu-id="e75c2-603">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="e75c2-604">Power BI Premium Per User</span><span class="sxs-lookup"><span data-stu-id="e75c2-604">Power BI Premium Per User</span></span> | <span data-ttu-id="e75c2-605">9c810018-9356-4903-95ab-eeb956289290</span><span class="sxs-lookup"><span data-stu-id="e75c2-605">9c810018-9356-4903-95ab-eeb956289290</span></span> | 
| <span data-ttu-id="e75c2-606">Power BI Premium Per User for Faculty</span><span class="sxs-lookup"><span data-stu-id="e75c2-606">Power BI Premium Per User for Faculty</span></span> | <span data-ttu-id="e75c2-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span><span class="sxs-lookup"><span data-stu-id="e75c2-607">3affc44f-f372-4ad5-8657-aadd9574fce0</span></span> | 
| <span data-ttu-id="e75c2-608">Power BI Premium Per User for Students</span><span class="sxs-lookup"><span data-stu-id="e75c2-608">Power BI Premium Per User for Students</span></span> | <span data-ttu-id="e75c2-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span><span class="sxs-lookup"><span data-stu-id="e75c2-609">657eea87-d0b0-4c89-8c8e-9b04395bd940</span></span> | 
| <span data-ttu-id="e75c2-610">Power BI Premium Per User(비영리 직원 가격)</span><span class="sxs-lookup"><span data-stu-id="e75c2-610">Power BI Premium Per User (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="e75c2-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span><span class="sxs-lookup"><span data-stu-id="e75c2-611">7a0a856c-059f-45dd-9d26-ae27992e706a</span></span> | 
| <span data-ttu-id="e75c2-612">Power BI Premium Per User Add-On</span><span class="sxs-lookup"><span data-stu-id="e75c2-612">Power BI Premium Per User Add-On</span></span> | <span data-ttu-id="e75c2-613">244ff87e-5925-44a0-bf31-cea189719b58</span><span class="sxs-lookup"><span data-stu-id="e75c2-613">244ff87e-5925-44a0-bf31-cea189719b58</span></span> | 
| <span data-ttu-id="e75c2-614">Power BI Premium Per User Add-On for Faculty</span><span class="sxs-lookup"><span data-stu-id="e75c2-614">Power BI Premium Per User Add-On for Faculty</span></span> | <span data-ttu-id="e75c2-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span><span class="sxs-lookup"><span data-stu-id="e75c2-615">5da849bd-b8f7-4340-b4f4-3a9eaeb8987e</span></span> | 
| <span data-ttu-id="e75c2-616">Power BI Premium Per User Add-On for Students</span><span class="sxs-lookup"><span data-stu-id="e75c2-616">Power BI Premium Per User Add-On for Students</span></span> | <span data-ttu-id="e75c2-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span><span class="sxs-lookup"><span data-stu-id="e75c2-617">cf62d70d-5af5-422a-bda8-97936402ac8e</span></span> | 
| <span data-ttu-id="e75c2-618">Power BI Premium Per User Add-On(비영리 직원 가격)</span><span class="sxs-lookup"><span data-stu-id="e75c2-618">Power BI Premium Per User Add-On (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="e75c2-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span><span class="sxs-lookup"><span data-stu-id="e75c2-619">31c03289-47ab-4ab0-8df1-03742c127ac6</span></span> | 

<span data-ttu-id="e75c2-620">**Customer Voice and Marketing USL 지역 및 세그먼트 확장**</span><span class="sxs-lookup"><span data-stu-id="e75c2-620">**Customer Voice and Marketing USL geo and segment expansion**</span></span>

<span data-ttu-id="e75c2-621">2020년 12월 출시의 후속 작업으로 Dynamics 365 Customer Voice and Marketing USL 제품이 새로운 국가와 비영리 및 교육 SKU를 추가하도록 변경되었습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-621">As a follow-up to the December 2020 launch, Dynamics 365 Customer Voice and Marketing USL offers have been changed to add new countries and more nonprofit and educational SKUs.</span></span>

| <span data-ttu-id="e75c2-622">Offer name</span><span class="sxs-lookup"><span data-stu-id="e75c2-622">Offer name</span></span> | <span data-ttu-id="e75c2-623">제품 ID</span><span class="sxs-lookup"><span data-stu-id="e75c2-623">Offer ID</span></span> |
| ------ |----------- |
| <span data-ttu-id="e75c2-624">Dynamics 365 Customer Voice USL(비영리 직원 가격)</span><span class="sxs-lookup"><span data-stu-id="e75c2-624">Dynamics 365 Customer Voice USL (Nonprofit Staff Pricing)</span></span> | <span data-ttu-id="e75c2-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span><span class="sxs-lookup"><span data-stu-id="e75c2-625">7a8642a5-481e-4906-a642-b56dbeeb62a0</span></span> |
| <span data-ttu-id="e75c2-626">Dynamics 365 Customer Voice USL for Faculty</span><span class="sxs-lookup"><span data-stu-id="e75c2-626">Dynamics 365 Customer Voice USL for Faculty</span></span> | <span data-ttu-id="e75c2-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span><span class="sxs-lookup"><span data-stu-id="e75c2-627">85162d70-9676-4cf6-a4bc-a0d6672f2657</span></span> |

<span data-ttu-id="e75c2-628">이 제품에 대해 자세히 알아보려면 다음 페이지를 방문하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-628">Visit the following pages to find out more about these offers:</span></span>

- [<span data-ttu-id="e75c2-629">Dynamics 365 Customer Service Voice 홈 페이지</span><span class="sxs-lookup"><span data-stu-id="e75c2-629">Dynamics 365 Customer Service Voice home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)
- [<span data-ttu-id="e75c2-630">Dynamics 365 Marketing 홈 페이지</span><span class="sxs-lookup"><span data-stu-id="e75c2-630">Dynamics 365 Marketing home page</span></span>](https://dynamics.microsoft.com/customer-voice/overview/)

### <a name="next-steps"></a><span data-ttu-id="e75c2-631">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-631">Next steps</span></span>

<span data-ttu-id="e75c2-632">이 토픽에 대한 리소스를 검토하고, 이 정보를 조직 내의 적절한 관계자와 공유합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-632">Review the resources on this topic, and share this information with the appropriate stakeholders in your organization.</span></span>  

### <a name="questions"></a><span data-ttu-id="e75c2-633">궁금한 점이 더 있나요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-633">Questions?</span></span>

<span data-ttu-id="e75c2-634">이 제품에 대한 질문이 있는 경우 관련 Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-634">For any questions about these offers, check your relevant Yammer communities.</span></span> 

________________
## <a name="microsoft-universal-print-now-available-in-some-suites"></a><a name="1"></a><span data-ttu-id="e75c2-635">현재 일부 제품군에서 Microsoft 유니버설 인쇄 사용 가능</span><span class="sxs-lookup"><span data-stu-id="e75c2-635">Microsoft Universal Print now available in some suites</span></span>

### <a name="categories"></a><span data-ttu-id="e75c2-636">범주</span><span class="sxs-lookup"><span data-stu-id="e75c2-636">Categories</span></span>

- <span data-ttu-id="e75c2-637">날짜: 2021-03-03</span><span class="sxs-lookup"><span data-stu-id="e75c2-637">Date: 2021-03-03</span></span>
- <span data-ttu-id="e75c2-638">기능</span><span class="sxs-lookup"><span data-stu-id="e75c2-638">Capabilities</span></span>

### <a name="summary"></a><span data-ttu-id="e75c2-639">요약</span><span class="sxs-lookup"><span data-stu-id="e75c2-639">Summary</span></span>

<span data-ttu-id="e75c2-640">Microsoft 유니버설 인쇄는 2021년 3월 1일부터 일부 Microsoft 365 제품군 내에서 독립 실행형 추가 기능으로 거래에 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-640">Microsoft Universal Print will be available to transact within select Microsoft 365 suites and as a standalone add-on from March 1, 2021.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="e75c2-641">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="e75c2-641">Impacted audience</span></span>

<span data-ttu-id="e75c2-642">CSP(클라우드 솔루션 공급자) 프로그램을 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="e75c2-642">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="e75c2-643">세부 정보</span><span class="sxs-lookup"><span data-stu-id="e75c2-643">Details</span></span>

<span data-ttu-id="e75c2-644">[유니버설 인쇄](https://aka.ms/universalprint)는 Windows 디바이스에서 Azure에 등록된 프린터로 인쇄할 수 있게 해주는 Microsoft 365 인쇄 서비스이며, 온-프레미스 인쇄 서버가 필요 없습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-644">[Universal Print](https://aka.ms/universalprint) is a Microsoft 365 print service that removes the need for on-premises print servers, and enables Windows devices to print to Azure-registered printers.</span></span> <span data-ttu-id="e75c2-645">2021년 3월 1일부터 거래에 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-645">It will be available to transact from March 1, 2021.</span></span>

<span data-ttu-id="e75c2-646">작업자는 드라이버 없는 인쇄, 간소화된 위치 기반 프린터 검색, 오랜 학습 기간이 필요 없는 직관적인 인쇄 환경이라는 장점을 누릴 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-646">Workers benefit from driverless printing, streamlined location-based printer discovery, and an intuitive printing experience with no learning curve.</span></span> <span data-ttu-id="e75c2-647">Azure AD(Azure Active Directory)에 조인된 디바이스는 기존 Azure AD 자격 증명을 사용하여 안전하게 인쇄합니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-647">Devices that are joined to Azure Active Directory (Azure AD) use existing Azure AD credentials to print securely.</span></span> <span data-ttu-id="e75c2-648">관리자는 Azure Portal에서 인쇄를 관리하며, 유니버설 인쇄가 기본 지원되므로 프린터를 쉽게 연결할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-648">Administrators manage printing by using the Azure portal, and can easily connect printers with native support for Universal Print.</span></span> <span data-ttu-id="e75c2-649">유니버설 인쇄는 유니버설 인쇄 커넥터 소프트웨어를 사용하여 호환되지 않는 프린터와 함께 배포할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-649">Universal Print can be deployed with non-compatible printers by using Universal Print connector software.</span></span>

<span data-ttu-id="e75c2-650">유니버설 인쇄는 출시 시 Windows E3, A3, E5, A5 및 Microsoft 365 BP, F3, E3, A3, E5, A5에 백필됩니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-650">Universal Print will be backfilled at launch to Windows E3, A3, E5, and A5, and Microsoft 365 BP, F3, E3, A3, E5, and A5.</span></span>  

<span data-ttu-id="e75c2-651">**솔루션 세부 정보**</span><span class="sxs-lookup"><span data-stu-id="e75c2-651">**Offer details**</span></span>

<span data-ttu-id="e75c2-652">제품 이름은 가격표 미리 보기와 약간 다릅니다.</span><span class="sxs-lookup"><span data-stu-id="e75c2-652">Note that the offer name differs slightly from the price list preview.</span></span>

| <span data-ttu-id="e75c2-653">Offer name</span><span class="sxs-lookup"><span data-stu-id="e75c2-653">Offer name</span></span> | <span data-ttu-id="e75c2-654">제품 ID</span><span class="sxs-lookup"><span data-stu-id="e75c2-654">Offer ID</span></span> | <span data-ttu-id="e75c2-655">소재 ID</span><span class="sxs-lookup"><span data-stu-id="e75c2-655">Material ID</span></span> |
| ------ |----------- |----------- |  
| <span data-ttu-id="e75c2-656">유니버설 인쇄 볼륨 추가(작업 500개) - Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="e75c2-656">Universal Print volume add-on (500 jobs) - Microsoft 365</span></span>  | <span data-ttu-id="e75c2-657">cb131356-45ee-4ae2-8537-873b706c8e75</span><span class="sxs-lookup"><span data-stu-id="e75c2-657">cb131356-45ee-4ae2-8537-873b706c8e75</span></span>     | <span data-ttu-id="e75c2-658">9BI-00004</span><span class="sxs-lookup"><span data-stu-id="e75c2-658">9BI-00004</span></span>   |
| <span data-ttu-id="e75c2-659">교직원용 유니버설 인쇄 볼륨 추가(작업 500개) - Microsoft 365</span><span class="sxs-lookup"><span data-stu-id="e75c2-659">Universal Print volume add-on (500 jobs) for faculty - Microsoft 365</span></span>   | <span data-ttu-id="e75c2-660">477bee81-9872-43d6-91d3-c72390bfcf49</span><span class="sxs-lookup"><span data-stu-id="e75c2-660">477bee81-9872-43d6-91d3-c72390bfcf49</span></span>   | <span data-ttu-id="e75c2-661">9BK-00004</span><span class="sxs-lookup"><span data-stu-id="e75c2-661">9BK-00004</span></span>   |
| <span data-ttu-id="e75c2-662">유니버설 인쇄 볼륨 추가(작업 500개) - Windows</span><span class="sxs-lookup"><span data-stu-id="e75c2-662">Universal Print volume add-on (500 jobs) - Windows</span></span>    | <span data-ttu-id="e75c2-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span><span class="sxs-lookup"><span data-stu-id="e75c2-663">d3ddc493-5741-4e0d-a02d-07edbb0bb72e</span></span>   | <span data-ttu-id="e75c2-664">9BI-00002</span><span class="sxs-lookup"><span data-stu-id="e75c2-664">9BI-00002</span></span>   |
| <span data-ttu-id="e75c2-665">교직원용 유니버설 인쇄 볼륨 추가(작업 500개) - Windows</span><span class="sxs-lookup"><span data-stu-id="e75c2-665">Universal Print volume add-on (500 jobs) for faculty - Windows</span></span>   |  <span data-ttu-id="e75c2-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span><span class="sxs-lookup"><span data-stu-id="e75c2-666">d0862f05-80f5-4fd4-8432-fe72dd893cc7</span></span>  | <span data-ttu-id="e75c2-667">9BK-00002</span><span class="sxs-lookup"><span data-stu-id="e75c2-667">9BK-00002</span></span>   |

### <a name="next-steps"></a><span data-ttu-id="e75c2-668">다음 단계</span><span class="sxs-lookup"><span data-stu-id="e75c2-668">Next steps</span></span>

<span data-ttu-id="e75c2-669">가격표와 [유니버설 인쇄 개요](/universal-print/fundamentals/universal-print-whatis)를 숙지하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-669">Familiarize yourself with the price list and the [Universal Print overview](/universal-print/fundamentals/universal-print-whatis).</span></span> <span data-ttu-id="e75c2-670">이 정보를 조직 내의 모든 해당 담당자와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-670">Share this information with all appropriate contacts in your organization.</span></span>

### <a name="questions"></a><span data-ttu-id="e75c2-671">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="e75c2-671">Questions?</span></span>

<span data-ttu-id="e75c2-672">이 제품에 대한 질문이 있는 경우 관련 Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="e75c2-672">For any questions about these offers, check your relevant Yammer communities.</span></span>