...
### <a name="summary"></a><span data-ttu-id="d1a39-110">요약</span><span class="sxs-lookup"><span data-stu-id="d1a39-110">Summary</span></span>
...
- <span data-ttu-id="d1a39-122">날짜: 2020-11-18</span><span class="sxs-lookup"><span data-stu-id="d1a39-122">Date: 2020-11-18</span></span>
...
- <span data-ttu-id="d1a39-135">조직 프로필</span><span class="sxs-lookup"><span data-stu-id="d1a39-135">Organization profile</span></span>
...
### <a name="details"></a><span data-ttu-id="d1a39-151">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-151">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="d1a39-167">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-167">Categories</span></span>
...
### <a name="details"></a><span data-ttu-id="d1a39-185">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-185">Details</span></span>
...
|<span data-ttu-id="d1a39-351">{baseURL}/v1/customers/{customer-tenant-id}/transfers</span><span class="sxs-lookup"><span data-stu-id="d1a39-351">{baseURL}/v1/customers/{customer-tenant-id}/transfers</span></span>|[<span data-ttu-id="d1a39-352">고객의 모든 전송 정보 가져오기</span><span class="sxs-lookup"><span data-stu-id="d1a39-352">Get all of a customer's transfers</span></span>](/partner-center/develop/get-subscription-registration-status)| 
...
### <a name="what-happened-next"></a><span data-ttu-id="d1a39-370">그 후 진행 상황:</span><span class="sxs-lookup"><span data-stu-id="d1a39-370">What happened next:</span></span>
...
<span data-ttu-id="d1a39-398">이제 교육 고객 유효성 검사 프로세스에 대한 파트너 센터 API 업데이트 및 UI(사용자 인터페이스) 향상을 위한 테스트를 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-398">Testing is now available for Partner Center API updates and UI enhancements for the Education customer validation process.</span></span>
...
<span data-ttu-id="d1a39-414">**도서관 및 박물관 고객**</span><span class="sxs-lookup"><span data-stu-id="d1a39-414">**Library and Museum customers**</span></span>
...
### <a name="categories"></a><span data-ttu-id="d1a39-425">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-425">Categories</span></span>
...
<span data-ttu-id="d1a39-433">2020년 11월 5일부터 Partner University의 상업용 라이선싱 파트너 콘텐츠도 운영 준비 갤러리에서 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-433">Starting November 5, 2020, Commercial Licensing partner content from Partner University will also be available on the Operations Readiness Gallery.</span></span> <span data-ttu-id="d1a39-434">이를 통해 운영 준비 갤러리에 있는 기존의 운영 및 상업용 라이선싱 파트너 출시 콘텐츠와 Partner University의 지속적인 상업용 라이선싱 파트너 콘텐츠를 통합합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-434">This consolidates the already existing operational and Commercial Licensing partner launch content on the Operations Readiness Gallery with our enduring Commercial Licensing partner content from Partner University.</span></span> <span data-ttu-id="d1a39-435">따라서 파트너에게 보다 원활한 준비 환경이 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-435">It will thus provide partners a more seamless readiness experience.</span></span> <span data-ttu-id="d1a39-436">다음 컬렉션이 운영 준비 갤러리에 추가되었습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-436">The following collections have been added to the Operations Readiness Gallery:</span></span>

- [<span data-ttu-id="d1a39-437">Microsoft Azure - 제품 및 라이선싱</span><span class="sxs-lookup"><span data-stu-id="d1a39-437">Microsoft Azure - Offers and Licensing</span></span>](https://partner.microsoft.com/resources/collection/microsoft-azure-offers-and-licensing#/)
- [<span data-ttu-id="d1a39-438">상업용 라이선싱 - CSP 스포트라이트 호출</span><span class="sxs-lookup"><span data-stu-id="d1a39-438">Commercial Licensing - CSP Spotlight Call</span></span>](https://partner.microsoft.com/resources/collection/commercial-licensing-csp-spotlight-call#/)
- [<span data-ttu-id="d1a39-439">상업용 라이선싱 - 라이선싱 업데이트 통화</span><span class="sxs-lookup"><span data-stu-id="d1a39-439">Commercial Licensing - Licensing Updates Call</span></span>](https://partner.microsoft.com/resources/collection/commercial-licensing-licensing-updates-call#/)

### <a name="next-steps"></a><span data-ttu-id="d1a39-440">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-440">Next steps</span></span>

<span data-ttu-id="d1a39-441">이 정보를 조직 내의 모든 해당 담당자와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-441">Share this information with all appropriate contacts in your organization.</span></span>

________________

## <a name="microsoft-teams-rooms-premium-sku-launch"></a><a name="5"></a><span data-ttu-id="d1a39-442">Microsoft Teams 룸 프리미엄 SKU 시작</span><span class="sxs-lookup"><span data-stu-id="d1a39-442">Microsoft Teams Rooms Premium SKU launch</span></span>

### <a name="categories"></a><span data-ttu-id="d1a39-443">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-443">Categories</span></span>

- <span data-ttu-id="d1a39-444">날짜: 2020-11-3</span><span class="sxs-lookup"><span data-stu-id="d1a39-444">Date: 2020-11-3</span></span>
- <span data-ttu-id="d1a39-445">제품/시장</span><span class="sxs-lookup"><span data-stu-id="d1a39-445">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="d1a39-446">요약</span><span class="sxs-lookup"><span data-stu-id="d1a39-446">Summary</span></span>

<span data-ttu-id="d1a39-447">CSP(클라우드 솔루션 공급자) 프로그램을 통한 Microsoft Teams용 Microsoft Teams 룸 프리미엄 SKU가 현재 제공되고 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-447">Microsoft Teams Rooms Premium SKU for Microsoft Teams through the Cloud Solution Provider (CSP) program is now available.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d1a39-448">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="d1a39-448">Impacted audience</span></span>

<span data-ttu-id="d1a39-449">CSP(클라우드 솔루션 공급자) 프로그램을 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="d1a39-449">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="d1a39-450">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-450">Details</span></span>

<span data-ttu-id="d1a39-451">새로운 Microsoft Teams 룸용 Microsoft Teams 룸 프리미엄 SKU는 이제 파트너를 통해 CSP를 구매하는 고객에게 매월 디바이스당 USD50으로 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-451">The new Microsoft Teams Rooms Premium SKU for Microsoft Teams Rooms is now available to your customers purchasing CSP through you at USD50 per device per month.</span></span> <span data-ttu-id="d1a39-452">Microsoft Teams 룸 프리미엄 SKU는 Microsoft Teams 룸 표준 SKU(이전에는 미팅룸 라이선스라고 함)에 대한 대안입니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-452">The Microsoft Teams Rooms Premium SKU is an alternative to the Microsoft Teams Rooms Standard SKU (previously called Meeting Room License).</span></span> <span data-ttu-id="d1a39-453">이 SKU에는 Microsoft Teams, 비즈니스용 Skype Online, Intune을 관리하는 데 필요한 라이선스와 같은 표준 제품의 모든 항목이 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-453">This SKU includes everything in the standard offering, such as the necessary licenses for Microsoft Teams, Skype for Business Online, and Intune management.</span></span> <span data-ttu-id="d1a39-454">또한 이 제품을 사용하면 PSTN(공중 전화망)을 통합하는 데 필요한 전화 시스템과 오디오 회의(가능한 경우)를 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-454">The offering also enables Phone System—necessary for Public Switched Telephone Network (PSTN) integration—and Audio Conferencing, where available.</span></span> 

<span data-ttu-id="d1a39-455">프리미엄 제품을 사용하면 고객이 새로 릴리스된 Microsoft Teams 룸 관리 서비스에 액세스할 수 있습니다. 이 서비스에서는 전문가가 고객을 대신하여 미팅룸의 관리 및 운영을 처리합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-455">With the premium offering, customers have access to the newly released Microsoft Teams Rooms Managed Services, where experts handle the management and operations for meeting rooms on behalf of the customer.</span></span> <span data-ttu-id="d1a39-456">이 클라우드 기반 IT 관리 및 모니터링 서비스는 Microsoft Teams 룸 디바이스와 주변 장치를 최신 상태로 안전하게 유지합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-456">This cloud-based IT management and monitoring service keeps Microsoft Teams Rooms devices and their peripherals up to date and secure.</span></span> <span data-ttu-id="d1a39-457">또한 훌륭한 실내 환경에 최적화된 환경을 유지하면서 사전에 모니터링 및 관리됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-457">They’re also proactively monitored and managed, maintaining an environment optimized for a great in-room experience.</span></span>

#### <a name="released-at-launch"></a><span data-ttu-id="d1a39-458">출시와 함께 릴리스</span><span class="sxs-lookup"><span data-stu-id="d1a39-458">Released at launch</span></span>

   |****|<span data-ttu-id="d1a39-459">**Microsoft Teams 룸 표준 USD15/월 디바이스**</span><span class="sxs-lookup"><span data-stu-id="d1a39-459">**Microsoft Teams Rooms Standard USD15 device per month**</span></span>|<span data-ttu-id="d1a39-460">**Microsoft Teams 룸 프리미엄 USD50/월 디바이스**</span><span class="sxs-lookup"><span data-stu-id="d1a39-460">**Microsoft Teams Rooms Premium USD50 device per month**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="d1a39-461">비즈니스용 Skype</span><span class="sxs-lookup"><span data-stu-id="d1a39-461">Skype for Business</span></span>|<span data-ttu-id="d1a39-462">Yes</span><span class="sxs-lookup"><span data-stu-id="d1a39-462">Yes</span></span>| |
   |<span data-ttu-id="d1a39-463">Microsoft Teams</span><span class="sxs-lookup"><span data-stu-id="d1a39-463">Microsoft Teams</span></span>|<span data-ttu-id="d1a39-464">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-464">Yes</span></span>|<span data-ttu-id="d1a39-465">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-465">Yes</span></span>|
   |<span data-ttu-id="d1a39-466">전화 시스템</span><span class="sxs-lookup"><span data-stu-id="d1a39-466">Phone System</span></span>|<span data-ttu-id="d1a39-467">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-467">Yes</span></span>|<span data-ttu-id="d1a39-468">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-468">Yes</span></span>|
   |<span data-ttu-id="d1a39-469">오디오 회의</span><span class="sxs-lookup"><span data-stu-id="d1a39-469">Audio Conferencing</span></span>|<span data-ttu-id="d1a39-470">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-470">Yes</span></span>|<span data-ttu-id="d1a39-471">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-471">Yes</span></span>|
   |<span data-ttu-id="d1a39-472">Microsoft Intune</span><span class="sxs-lookup"><span data-stu-id="d1a39-472">Microsoft Intune</span></span>|<span data-ttu-id="d1a39-473">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-473">Yes</span></span>|<span data-ttu-id="d1a39-474">예</span><span class="sxs-lookup"><span data-stu-id="d1a39-474">Yes</span></span>|
   | |<span data-ttu-id="d1a39-475">Microsoft Teams 룸 표준 USD15/월 디바이스</span><span class="sxs-lookup"><span data-stu-id="d1a39-475">Microsoft Teams Rooms Standard USD15 per device per month</span></span>|<span data-ttu-id="d1a39-476">Microsoft Teams 룸 프리미엄 USD50/월 디바이스</span><span class="sxs-lookup"><span data-stu-id="d1a39-476">Microsoft Teams Rooms Premium USD50 per device per month</span></span>|
   |<span data-ttu-id="d1a39-477">Microsoft Teams 룸 관리 서비스</span><span class="sxs-lookup"><span data-stu-id="d1a39-477">Microsoft Teams Rooms Managed Services</span></span>| |<span data-ttu-id="d1a39-478">Yes</span><span class="sxs-lookup"><span data-stu-id="d1a39-478">Yes</span></span>|
   |<span data-ttu-id="d1a39-479">전 세계 사용 가능</span><span class="sxs-lookup"><span data-stu-id="d1a39-479">Worldwide availability</span></span>|<span data-ttu-id="d1a39-480">Yes</span><span class="sxs-lookup"><span data-stu-id="d1a39-480">Yes</span></span>|<span data-ttu-id="d1a39-481">시장 선택 시</span><span class="sxs-lookup"><span data-stu-id="d1a39-481">In select markets</span></span>|

#### <a name="microsoft-teams-rooms-managed-services"></a><span data-ttu-id="d1a39-482">Microsoft Teams 룸 관리 서비스</span><span class="sxs-lookup"><span data-stu-id="d1a39-482">Microsoft Teams Rooms Managed Services</span></span>

- <span data-ttu-id="d1a39-483">자동 관리: 패칭, 구성 관리 등을 포함한 룸 시스템에 대한 연중 무휴 관리</span><span class="sxs-lookup"><span data-stu-id="d1a39-483">Proactive management: 24x7x365 management of your room systems including patching, configuration management, and more.</span></span>
- <span data-ttu-id="d1a39-484">실시간 모니터링 및 근본 원인 분석: 모니터링 및 검색: 필요한 경우 Microsoft에서 고객과 협력하여 추진하는 오케스트레이션된 인시던트 관리 응답을 사용하여 모니터링 및 검색</span><span class="sxs-lookup"><span data-stu-id="d1a39-484">Real-time monitoring and root-cause analysis: Monitoring and detection with orchestrated incident management response driven by Microsoft in coordination with the customer, when needed.</span></span> <span data-ttu-id="d1a39-485">모바일 앱을 사용하면 이동 중에도 알림을 받을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-485">The mobile app allows you to stay alerted on-the-go.</span></span>
- <span data-ttu-id="d1a39-486">관리되는 업데이트: 애플리케이션, Windows KB 및 펌웨어 업데이트 관리 및 제공</span><span class="sxs-lookup"><span data-stu-id="d1a39-486">Managed updates: Management and delivery of application, Windows KB, and firmware updates.</span></span>
- <span data-ttu-id="d1a39-487">보안 위협 보호: Microsoft Defender Advanced Threat Protection을 통한 보안 위협 보호.</span><span class="sxs-lookup"><span data-stu-id="d1a39-487">Security threat protection: Security threat protection via Microsoft Defender Advanced Threat Protection.</span></span>
- <span data-ttu-id="d1a39-488">고객 지원: 자동화되지 않은 사례에 대한 지원 인시던트 수정을 사용하여 전용 서비스 운영 센터를 통해 연중 무휴 티켓 지원</span><span class="sxs-lookup"><span data-stu-id="d1a39-488">Customer support: 24x7x365 ticket support through our dedicated service operations center with assisted incident remediation for non-automated cases.</span></span> <span data-ttu-id="d1a39-489">세분화된 역할 기반 액세스 제어.</span><span class="sxs-lookup"><span data-stu-id="d1a39-489">Granular role-based access control.</span></span>
- <span data-ttu-id="d1a39-490">인사이트 및 추천 사항: 고객에 대해 집계된 인사이트 및 룸 상태, 재고, 사용 현황, 온라인 회의 및 인시던트 추세에 대한 보고서</span><span class="sxs-lookup"><span data-stu-id="d1a39-490">Insights and recommendations: Aggregated insights across customers and reports on room health, inventory, usage, online meetings, and incident trends.</span></span>

#### <a name="offer-details"></a><span data-ttu-id="d1a39-491">솔루션 세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-491">Offer details</span></span>

   |<span data-ttu-id="d1a39-492">**제품 이름**</span><span class="sxs-lookup"><span data-stu-id="d1a39-492">**Offer name**</span></span>|<span data-ttu-id="d1a39-493">**제품 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-493">**Offer ID**</span></span>|<span data-ttu-id="d1a39-494">**소재 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-494">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="d1a39-495">Teams 룸 프리미엄</span><span class="sxs-lookup"><span data-stu-id="d1a39-495">Teams Rooms Premium</span></span>|<span data-ttu-id="d1a39-496">5db9aa31-f039-4740-b122-a33514e4c492</span><span class="sxs-lookup"><span data-stu-id="d1a39-496">5db9aa31-f039-4740-b122-a33514e4c492</span></span>|<span data-ttu-id="d1a39-497">6XB-00007</span><span class="sxs-lookup"><span data-stu-id="d1a39-497">6XB-00007</span></span>|
   |<span data-ttu-id="d1a39-498">Teams 룸 프리미엄(미국 및 캐나다)</span><span class="sxs-lookup"><span data-stu-id="d1a39-498">Teams Rooms Premium (USA and CAN)</span></span>|<span data-ttu-id="d1a39-499">03070f91-cc77-4c2e-b269-4a214b3698ab</span><span class="sxs-lookup"><span data-stu-id="d1a39-499">03070f91-cc77-4c2e-b269-4a214b3698ab</span></span>|<span data-ttu-id="d1a39-500">6XB-00008</span><span class="sxs-lookup"><span data-stu-id="d1a39-500">6XB-00008</span></span>|
   |<span data-ttu-id="d1a39-501">교직원용 Teams 룸 프리미엄</span><span class="sxs-lookup"><span data-stu-id="d1a39-501">Teams Rooms Premium for faculty</span></span>|<span data-ttu-id="d1a39-502">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span><span class="sxs-lookup"><span data-stu-id="d1a39-502">d0c9a9a9-c9b6-41d7-9148-b60115c36c95</span></span>|<span data-ttu-id="d1a39-503">6Y5-00005</span><span class="sxs-lookup"><span data-stu-id="d1a39-503">6Y5-00005</span></span>|

### <a name="next-steps"></a><span data-ttu-id="d1a39-504">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-504">Next steps</span></span>

- <span data-ttu-id="d1a39-505">새 제품 및 지리적 가용성을 숙지하려면 [FAQ(질문과 대답)]()를 방문하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-505">Familiarize yourself with the new offer and its geographical availability, visit the [frequently asked questions (FAQ)]().</span></span>
- <span data-ttu-id="d1a39-506">새 제품 및 지리적 가용성에 익숙해지세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-506">Become familiar with the new offer and its geographical availability.</span></span> 
- <span data-ttu-id="d1a39-507">Microsoft 룸 및 관련 제품에 대한 자세한 내용은 [Microsoft Team 룸](https://rooms.microsoft.com/)을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-507">Learn more about Microsoft Rooms and related offers at [Microsoft Team Rooms](https://rooms.microsoft.com/).</span></span>
- <span data-ttu-id="d1a39-508">[Teams 파트너 가이드](https://aka.ms/teamscallingmeetingsguide)를 사용하여 Teams 미팅룸과 관련된 사례를 개발하고 공동 판매 준비 제안을 작성합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-508">Use the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide) to develop your practice with Teams Meeting Rooms, and create a Co-sell Ready offer.</span></span>
- <span data-ttu-id="d1a39-509">제품 솔루션 및 서비스에 대해 자세히 알아보려면 [Microsoft Teams 룸 FAQ](https://aka.ms/PartnerMTRFAQ)를 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-509">Review the [Microsoft Teams Rooms FAQ](https://aka.ms/PartnerMTRFAQ) to learn more about the product solution and services.</span></span> 
- <span data-ttu-id="d1a39-510">이 정보를 조직 내 모든 관련 담당자와 공유하고, 상향 판매 및 교차 판매 기회를 파악합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-510">Share this information with all appropriate contacts in your organization and understand the upsell and cross-sell opportunities.</span></span>

________________

## <a name="new-microsoft-teams-advanced-communications-skus-for-government-community-cloud-gcc-coming-soon"></a><a name="4"></a><span data-ttu-id="d1a39-511">GCC(정부 커뮤니티 클라우드)를 위한 새로운 Microsoft Teams 고급 통신 SKU가 곧 출시 예정</span><span class="sxs-lookup"><span data-stu-id="d1a39-511">New Microsoft Teams Advanced Communications SKUs for Government Community Cloud (GCC) coming soon</span></span>

### <a name="categories"></a><span data-ttu-id="d1a39-512">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-512">Categories</span></span>

- <span data-ttu-id="d1a39-513">날짜: 2020-11-2</span><span class="sxs-lookup"><span data-stu-id="d1a39-513">Date: 2020-11-2</span></span>
- <span data-ttu-id="d1a39-514">제품/시장</span><span class="sxs-lookup"><span data-stu-id="d1a39-514">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="d1a39-515">요약</span><span class="sxs-lookup"><span data-stu-id="d1a39-515">Summary</span></span>

<span data-ttu-id="d1a39-516">2020년 12월 1일부터 GCC의 Microsoft Teams를 위한 새로운 고급 통신 추가 기능 SKU가 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-516">The new Advanced Communications add-on SKU for Microsoft Teams in GCC will be available from December 1, 2020.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d1a39-517">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="d1a39-517">Impacted audience</span></span>

<span data-ttu-id="d1a39-518">CSP(클라우드 솔루션 공급자) 프로그램을 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="d1a39-518">All partners transacting through the Cloud Solution Provider (CSP) program</span></span>

### <a name="details"></a><span data-ttu-id="d1a39-519">설명</span><span class="sxs-lookup"><span data-stu-id="d1a39-519">Details</span></span>

<span data-ttu-id="d1a39-520">GCC의 Microsoft Teams를 위한 새로운 고급 통신 추가 기능은 이제 사용자 1인당 월 USD12에 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-520">The new Advanced Communications add-on for Microsoft Teams in GCC is now available at USD12 per user per month.</span></span> <span data-ttu-id="d1a39-521">추가 기능 SKU는 Microsoft Teams를 포함하고 있는 다른 Microsoft 365 제품군을 보유하고 있어야만 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-521">The add-on SKUs can be purchased on top of any other Microsoft 365 suite that contains Microsoft Teams.</span></span> <span data-ttu-id="d1a39-522">고급 통신은 대규모 회의, 통신 정책, 통합 및 IT 관리를 위한 고급 도구에 새로운 기능 세트를 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-522">Advanced Communications provides a new set of capabilities for large meetings, communication policies, integrations, and advanced tools for IT management.</span></span> 

#### <a name="offer-details"></a><span data-ttu-id="d1a39-523">솔루션 세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-523">Offer details</span></span>

   |<span data-ttu-id="d1a39-524">**제품 이름**</span><span class="sxs-lookup"><span data-stu-id="d1a39-524">**Offer name**</span></span>|<span data-ttu-id="d1a39-525">**제품 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-525">**Offer ID**</span></span>|<span data-ttu-id="d1a39-526">**소재 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-526">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="d1a39-527">GCC용 고급 통신</span><span class="sxs-lookup"><span data-stu-id="d1a39-527">Advanced Communications for GCC</span></span>|<span data-ttu-id="d1a39-528">56fe76f5-f4ba-4fac-9561-d0daf59b01a1</span><span class="sxs-lookup"><span data-stu-id="d1a39-528">56fe76f5-f4ba-4fac-9561-d0daf59b01a1</span></span>|<span data-ttu-id="d1a39-529">7FB-00003</span><span class="sxs-lookup"><span data-stu-id="d1a39-529">7FB-00003</span></span>|

#### <a name="frequently-asked-questions"></a><span data-ttu-id="d1a39-530">질문과 대답</span><span class="sxs-lookup"><span data-stu-id="d1a39-530">Frequently asked questions</span></span> 

<span data-ttu-id="d1a39-531">**고급 통신이란?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-531">**What is Advanced Communications?**</span></span> <span data-ttu-id="d1a39-532">고객은 이 새로운 Microsoft Teams 추가 기능을 통해 통신 환경을 더욱 향상시킬 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-532">This new Microsoft Teams add-on enables customers to further enhance their communication experience.</span></span> <span data-ttu-id="d1a39-533">고객이 구독하는 Microsoft 365 SKU를 기반으로 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-533">It can be purchased on top of any Microsoft 365 SKU that they are subscribed to.</span></span>

<span data-ttu-id="d1a39-534">**가격은 얼마나 되나요?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-534">**How much does it cost?**</span></span> <span data-ttu-id="d1a39-535">상용 ERP는 사용자 1인당 월 USD12입니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-535">The commercial ERP is USD12 per user per month.</span></span>

<span data-ttu-id="d1a39-536">**어떤 고객이 추가 기능을 구매할 수 있나요?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-536">**Which customers can purchase the add-on?**</span></span> <span data-ttu-id="d1a39-537">GCC 고객은 추가 기능을 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-537">GCC customers can purchase the add-on.</span></span>

<span data-ttu-id="d1a39-538">**어떻게 구입할 수 있나요?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-538">**How can it be purchased?**</span></span> <span data-ttu-id="d1a39-539">추가 기능은 기업계약, 기업계약 구독, 교육 솔루션 등록, CSP 또는 웹 다이렉트를 통해 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-539">The add-on can be purchased through Enterprise Agreement, Enterprise Agreement Subscription, Enrollment for Education Solutions, CSP, or Web Direct.</span></span>

<span data-ttu-id="d1a39-540">**어디에서 판매되나요?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-540">**Where can it be sold?**</span></span> <span data-ttu-id="d1a39-541">미국 시장에서 판매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-541">It can be sold in US markets.</span></span>

<span data-ttu-id="d1a39-542">**필수 구성 요소는 무엇인가요?**</span><span class="sxs-lookup"><span data-stu-id="d1a39-542">**What are the prerequisites?**</span></span> <span data-ttu-id="d1a39-543">Microsoft Teams를 포함하는 Microsoft 365 또는 Office 365 제품군은 이 추가 기능을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-543">Any Microsoft 365 or Office 365 suite that includes Microsoft Teams can have this add-on.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d1a39-544">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-544">Next steps</span></span>

<span data-ttu-id="d1a39-545">이 정보를 조직 내 관련 담당자와 공유하고 상향 판매 및 교차 판매 기회를 파악합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-545">Share this information with the relevant contacts in your organization and understand the upsell and cross-sell opportunities.</span></span> <span data-ttu-id="d1a39-546">[Teams 파트너 가이드](https://aka.ms/teamscallingmeetingsguide)의 리소스 섹션을 검토합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-546">Review the resources section of the [Teams Partner Guide](https://aka.ms/teamscallingmeetingsguide).</span></span>

________________

## <a name="dynamics-365-recently-launched-and-upcoming-new-offers-and-products"></a><a name="3"></a><span data-ttu-id="d1a39-547">Dynamics 365: 최근에 출시되었으며 곧 출시될 새로운 서비스 및 제품입니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-547">Dynamics 365: Recently launched and upcoming new offers and products</span></span>

### <a name="categories"></a><span data-ttu-id="d1a39-548">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-548">Categories</span></span>

- <span data-ttu-id="d1a39-549">날짜: 2020-11-2</span><span class="sxs-lookup"><span data-stu-id="d1a39-549">Date: 2020-11-2</span></span>
- <span data-ttu-id="d1a39-550">제품/시장</span><span class="sxs-lookup"><span data-stu-id="d1a39-550">Offers/Markets</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d1a39-551">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="d1a39-551">Impacted audience</span></span>

<span data-ttu-id="d1a39-552">직접 공급자, 간접 공급자 및 간접 재판매인</span><span class="sxs-lookup"><span data-stu-id="d1a39-552">Direct providers, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="d1a39-553">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-553">Details</span></span>

#### <a name="new-offers"></a><span data-ttu-id="d1a39-554">새 제품</span><span class="sxs-lookup"><span data-stu-id="d1a39-554">New offers</span></span>

<span data-ttu-id="d1a39-555">2020년 11월 1일 Microsoft는 Dynamics 365 Project Operations를 릴리스했고 상용 고객을 위한 Dynamics 365 PSA(Project Service Automation)를 제거했습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-555">On November 1, 2020, Microsoft released Dynamics 365 Project Operations offers and removed Dynamics 365 Project Service Automation (PSA) for commercial customers.</span></span> <span data-ttu-id="d1a39-556">이 커뮤니케이션은 이번 출시 및 새로운 ISV(독립 소프트웨어 공급업체) 포함 서비스의 이중 사용 권한 매핑과 관련된 추가 정보를 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-556">This communication provides additional information regarding dual use rights mapping from this launch and new independent software vendor (ISV) embedded offers.</span></span>

#### <a name="project-operations-isv-embed-offers"></a><span data-ttu-id="d1a39-557">Project Operations ISV 포함 서비스</span><span class="sxs-lookup"><span data-stu-id="d1a39-557">Project Operations ISV Embed offers</span></span>

<span data-ttu-id="d1a39-558">2020년 11월 1일 Microsoft는 CSP(클라우드 솔루션 공급자) 고객을 위해 Dynamics 365 for Project Operations용 36개월 ISV 포함 서비스 3가지를 추가로 릴리스했습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-558">On November 1, 2020, Microsoft released three additional 36-month ISV Embed offers for Dynamics 365 for Project Operations to Cloud Solution Provider (CSP) customers.</span></span> <span data-ttu-id="d1a39-559">SKU 세부 정보는 [Dynamics CSP 제품 - 2020년 11월 Excel 문서](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-xls)의 Project Operations 탭을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-559">See the Project Operations tab in the [Dynamics CSP Offers-November 2020 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-xls) for the SKU details.</span></span>

#### <a name="project-operations-dual-use-rights-mapping"></a><span data-ttu-id="d1a39-560">Project Operations 이중 사용 권한 매핑</span><span class="sxs-lookup"><span data-stu-id="d1a39-560">Project Operations dual-use rights mapping</span></span>

<span data-ttu-id="d1a39-561">다음 표에서 Project Operations 서비스에 대한 Dynamics 365 이중 사용 권한 온-프레미스 매핑에 대한 정보를 확인할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-561">You can find information on Dynamics 365 dual use rights on-premises mapping for the Project Operations offers in the following table:</span></span>

   |<span data-ttu-id="d1a39-562">**D365 Operations 서비스**</span><span class="sxs-lookup"><span data-stu-id="d1a39-562">**D365 Operations offer**</span></span>|<span data-ttu-id="d1a39-563">**D365 온-프레미스 이중 사용 권한 매핑**</span><span class="sxs-lookup"><span data-stu-id="d1a39-563">**D365 on-premises dual use rights mapping**</span></span>|
   |-------------------|:------|
   |<span data-ttu-id="d1a39-564">D365 Operations 서비스</span><span class="sxs-lookup"><span data-stu-id="d1a39-564">D365 Operations offer</span></span>|<span data-ttu-id="d1a39-565">D365 온-프레미스 이중 사용 권한 매핑</span><span class="sxs-lookup"><span data-stu-id="d1a39-565">D365 on-premises dual use rights mapping</span></span>|
   |<span data-ttu-id="d1a39-566">D365 Project Operations</span><span class="sxs-lookup"><span data-stu-id="d1a39-566">D365 Project Operations</span></span>|<span data-ttu-id="d1a39-567">Dyn365 Project Operations SKU(109108477)를 사용하는 D365 for Operations, 온-프레미스(AX 서버)</span><span class="sxs-lookup"><span data-stu-id="d1a39-567">D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)</span></span>|
   |<span data-ttu-id="d1a39-568">D365 Project Operations Attach</span><span class="sxs-lookup"><span data-stu-id="d1a39-568">D365 Project Operations Attach</span></span>|<span data-ttu-id="d1a39-569">Dyn365 Project Operations SKU(109108477)를 사용하는 D365 for Operations, 온-프레미스(AX 서버)</span><span class="sxs-lookup"><span data-stu-id="d1a39-569">D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)</span></span>|
   |<span data-ttu-id="d1a39-570">D365 Finance with Project Operations</span><span class="sxs-lookup"><span data-stu-id="d1a39-570">D365 Finance with Project Operations</span></span>|<span data-ttu-id="d1a39-571">Dyn365 Project Operations SKU(109108477)를 사용하는 D365 for Operations, 온-프레미스(AX 서버)</span><span class="sxs-lookup"><span data-stu-id="d1a39-571">D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)</span></span>|
   |<span data-ttu-id="d1a39-572">D365 Finance Attach with Project Operations</span><span class="sxs-lookup"><span data-stu-id="d1a39-572">D365 Finance Attach with Project Operations</span></span>|<span data-ttu-id="d1a39-573">Dyn365 Project Operations SKU(109108477)를 사용하는 D365 for Operations, 온-프레미스(AX 서버)</span><span class="sxs-lookup"><span data-stu-id="d1a39-573">D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)</span></span>|
   |<span data-ttu-id="d1a39-574">D365 통합 운영 – Project Operations를 사용한 활동</span><span class="sxs-lookup"><span data-stu-id="d1a39-574">D365 Unified Operations – Activity with Project Operations</span></span>|<span data-ttu-id="d1a39-575">Dyn365 Project Operations SKU(109108477)를 사용하는 D365 for Operations, 온-프레미스(AX 서버)</span><span class="sxs-lookup"><span data-stu-id="d1a39-575">D365 for Operations, on-prem (AX Server) using the Dyn365 Project Operations SKU (109108477)</span></span>|

#### <a name="previously-announced"></a><span data-ttu-id="d1a39-576">이전에 공지됨</span><span class="sxs-lookup"><span data-stu-id="d1a39-576">Previously announced</span></span>

<span data-ttu-id="d1a39-577">2020년 11월 1일 Microsoft는 CSP를 위해 다음과 같이 새롭게 업데이트된 Dynamics 365 및 Power Platform 서비스 및 제품을 릴리스했습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-577">On November 1, 2020, Microsoft released the following new and updated Dynamics 365 and Power Platform offers and products for CSP:</span></span>

- <span data-ttu-id="d1a39-578">Dynamics 365 고객의 소리 USL</span><span class="sxs-lookup"><span data-stu-id="d1a39-578">Dynamics 365 Customer Voice USL</span></span> 

<span data-ttu-id="d1a39-579">제품 ID 세부 정보는 [Dynamics CSP 제품 - 2020년 11월 Excel 문서](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls)의 Project Operations 탭을 검토합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-579">Review the Project Operations tab in the [Dynamics CSP Offers-November 2020 Excel document](https://partner.microsoft.com/resources/detail/dynamics-csp-offers-november-2020-xls) for the offer ID details.</span></span>

<span data-ttu-id="d1a39-580">Microsoft Dynamics 365 고객의 소리 홈 페이지에서 더 많은 리소스를 찾아볼 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-580">You can find more resources on the Microsoft Dynamics 365 Customer Voice home page.</span></span>

### <a name="next-steps"></a><span data-ttu-id="d1a39-581">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-581">Next steps</span></span>

<span data-ttu-id="d1a39-582">이 정보를 조직 내의 관련 담당자와 공유합니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-582">Share this information with the relevant people in your organization.</span></span>

________________

## <a name="introducing-microsoft-365-business-voice-for-nonprofit-organizations"></a><a name="2"></a><span data-ttu-id="d1a39-583">비영리 조직용 Microsoft 365 Business Voice 소개</span><span class="sxs-lookup"><span data-stu-id="d1a39-583">Introducing Microsoft 365 Business Voice for nonprofit organizations</span></span>

### <a name="categories"></a><span data-ttu-id="d1a39-584">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-584">Categories</span></span>

- <span data-ttu-id="d1a39-585">날짜: 2020-11-2</span><span class="sxs-lookup"><span data-stu-id="d1a39-585">Date: 2020-11-2</span></span>
- <span data-ttu-id="d1a39-586">제품/시장</span><span class="sxs-lookup"><span data-stu-id="d1a39-586">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="d1a39-587">요약</span><span class="sxs-lookup"><span data-stu-id="d1a39-587">Summary</span></span>

<span data-ttu-id="d1a39-588">2020년 11월 1일 Microsoft는 비영리 조직을 위해 Microsoft 365 Business Voice용 새 SKU를 도입했습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-588">On November 1 2020, Microsoft introduced new SKUs for Microsoft 365 Business Voice for nonprofit organizations.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d1a39-589">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="d1a39-589">Impacted audience</span></span>

<span data-ttu-id="d1a39-590">직접 공급자, 간접 공급자 및 간접 재판매인</span><span class="sxs-lookup"><span data-stu-id="d1a39-590">Direct providers, indirect providers, and indirect resellers</span></span>

### <a name="details"></a><span data-ttu-id="d1a39-591">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-591">Details</span></span>

<span data-ttu-id="d1a39-592">2020년 11월 1일 Microsoft는 Business Voice용 새 SKU를 도입했습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-592">On November 1, 2020, Microsoft introduced new SKUs for Business Voice.</span></span> <span data-ttu-id="d1a39-593">전체 제품군은 캐나다, 영국 및 미국에서 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-593">The full suite is available in Canada, the United Kingdom, and the United States.</span></span> <span data-ttu-id="d1a39-594">통화 플랜이 없는 Business Voice는 다른 모든 국가에서 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-594">Business Voice without Calling Plan will be available in all other markets.</span></span> 

<span data-ttu-id="d1a39-595">Microsoft 365 Business Voice는 Office 365에 기본 제공되는 중소 규모 기업용 클라우드 기반 전화 시스템입니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-595">Microsoft 365 Business Voice is a cloud-based phone system for small- and medium-sized businesses, which are built into Office 365.</span></span> <span data-ttu-id="d1a39-596">고객의 Office 365 구독에 Business Voice를 추가하면 단일 애플리케이션인 Microsoft Teams에서 통화, 채팅 및 미팅이 포함된 올인원 통신 및 협업 솔루션이 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-596">Adding Business Voice to a customer's Office 365 subscription delivers an all-in-one communication and collaboration solution with calling, chat, and meetings in a single application, Microsoft Teams.</span></span>

<span data-ttu-id="d1a39-597">가격 책정에 대한 자세한 내용은 가격표를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-597">Refer to the price list for pricing details.</span></span>

<span data-ttu-id="d1a39-598">최대 300명의 사용자를 위해 다음 구독에 Microsoft 365 Business Voice를 추가할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-598">Microsoft 365 Business Voice can be added onto the following subscriptions for up to 300 users:</span></span>

- <span data-ttu-id="d1a39-599">Office 365: Business Essentials, Business Premium, A1, E1, A3, E3</span><span class="sxs-lookup"><span data-stu-id="d1a39-599">Office 365: Business Essentials, Business Premium, A1, E1, A3, and E3</span></span>
- <span data-ttu-id="d1a39-600">Microsoft 365: Business, A3, E3</span><span class="sxs-lookup"><span data-stu-id="d1a39-600">Microsoft 365: Business, A3, and E3</span></span>


### <a name="next-steps"></a><span data-ttu-id="d1a39-601">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-601">Next steps</span></span>

- <span data-ttu-id="d1a39-602">미리 보기 가격표를 숙지하고 정보를 조직 내의 모든 해당 담당자와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-602">Familiarize yourself and share the information in the preview price list with all appropriate contacts in your organization.</span></span> 
- <span data-ttu-id="d1a39-603">클라우드 솔루션 공급자 프로그램 업데이트 리소스 갤러리에서 모든 준비 자료를 검토합니다. [중소기업용 Microsoft 365 Business Voice 소개](https://partner.microsoft.com/resources/collection/m365-voice-smb#/)</span><span class="sxs-lookup"><span data-stu-id="d1a39-603">Review all readiness materials on the Cloud Solution Provider Program Updates resource gallery: [Introducing Microsoft 365 Business Voice for small and medium businesses](https://partner.microsoft.com/resources/collection/m365-voice-smb#/).</span></span> 

________________

## <a name="cloud-solution-provider-csp-promo-for-microsoft-365-business-voice-is-now-available"></a><a name="1"></a><span data-ttu-id="d1a39-604">이제 Microsoft 365 Business Voice용 CSP(클라우드 솔루션 공급자) 프로모션을 사용할 수 있음</span><span class="sxs-lookup"><span data-stu-id="d1a39-604">Cloud Solution Provider (CSP) promo for Microsoft 365 Business Voice is now available</span></span>

### <a name="categories"></a><span data-ttu-id="d1a39-605">범주</span><span class="sxs-lookup"><span data-stu-id="d1a39-605">Categories</span></span>

- <span data-ttu-id="d1a39-606">날짜: 2020-11-2</span><span class="sxs-lookup"><span data-stu-id="d1a39-606">Date: 2020-11-2</span></span>
- <span data-ttu-id="d1a39-607">제품/시장</span><span class="sxs-lookup"><span data-stu-id="d1a39-607">Offers/Markets</span></span>

### <a name="summary"></a><span data-ttu-id="d1a39-608">요약</span><span class="sxs-lookup"><span data-stu-id="d1a39-608">Summary</span></span>

<span data-ttu-id="d1a39-609">통화 플랜이 있는 Microsoft 365 Business Voice 및 통화 플랜이 없는 Microsoft 365 Business Voice의 신규 및 갱신 구독에 대해 요금 할인 혜택이 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-609">Discount pricing available for New and renewal subscriptions of Microsoft 365 Business Voice with Calling Plan and Microsoft 365 Business Voice without Calling Plan.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="d1a39-610">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="d1a39-610">Impacted audience</span></span>

<span data-ttu-id="d1a39-611">CSP 프로그램을 통해 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="d1a39-611">All partners transacting through the CSP program</span></span>

### <a name="details"></a><span data-ttu-id="d1a39-612">세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-612">Details</span></span>

<span data-ttu-id="d1a39-613">2020년 11월 1일부터 2021년 4월 30일까지 통화 플랜이 있는 Microsoft 365 Business Voice 및 통화 플랜이 없는 Microsoft 365 Business Voice의 신규 및 갱신 구독은 가격 할인을 받을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-613">Effective November 1, 2020 through April 30, 2021, new and renewal subscriptions of Microsoft 365 Business Voice with Calling Plan and Microsoft 365 Business Voice without Calling Plan are subject to discount pricing.</span></span> <span data-ttu-id="d1a39-614">통화 플랜이 있는 Microsoft 365 Business Voice는 12개월 동안 25% 할인이, 통화 플랜이 없는 Microsoft 365 Business Voice는 12개월 동안 33% 할인이 적용됩니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-614">Microsoft 365 Business Voice with Calling Plan is subject to a 25 percent discount for 12 months, and Microsoft 365 Business Voice without Calling Plan is subject to a 33 percent discount for 12 months.</span></span> 

#### <a name="offer-details"></a><span data-ttu-id="d1a39-615">솔루션 세부 정보</span><span class="sxs-lookup"><span data-stu-id="d1a39-615">Offer details</span></span>

   |<span data-ttu-id="d1a39-616">**제품 이름**</span><span class="sxs-lookup"><span data-stu-id="d1a39-616">**Offer name**</span></span>|<span data-ttu-id="d1a39-617">**제품 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-617">**Offer ID**</span></span>|<span data-ttu-id="d1a39-618">**소재 ID**</span><span class="sxs-lookup"><span data-stu-id="d1a39-618">**Material ID**</span></span>|
   |-------------------|:------|:------|
   |<span data-ttu-id="d1a39-619">Microsoft 365 Business Voice 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-619">Microsoft 365 Business Voice Adoption Promo</span></span>|<span data-ttu-id="d1a39-620">e7d1d0fa-b769-45c7-aaea-c3e6f7402691</span><span class="sxs-lookup"><span data-stu-id="d1a39-620">e7d1d0fa-b769-45c7-aaea-c3e6f7402691</span></span>|<span data-ttu-id="d1a39-621">PZX-00006</span><span class="sxs-lookup"><span data-stu-id="d1a39-621">PZX-00006</span></span>|
   |<span data-ttu-id="d1a39-622">Microsoft 365 Business Voice 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-622">Microsoft 365 Business Voice Adoption Promo</span></span>|<span data-ttu-id="d1a39-623">ef3ff6bb-a288-4a56-9204-97b37ff9a0b8</span><span class="sxs-lookup"><span data-stu-id="d1a39-623">ef3ff6bb-a288-4a56-9204-97b37ff9a0b8</span></span>|<span data-ttu-id="d1a39-624">PZW-00019</span><span class="sxs-lookup"><span data-stu-id="d1a39-624">PZW-00019</span></span>|
   |<span data-ttu-id="d1a39-625">Microsoft 365 Business Voice(미국) 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-625">Microsoft 365 Business Voice (US) Adoption Promo</span></span>|<span data-ttu-id="d1a39-626">4244aed3-90ae-4754-8dc8-37f2e8d84e85</span><span class="sxs-lookup"><span data-stu-id="d1a39-626">4244aed3-90ae-4754-8dc8-37f2e8d84e85</span></span>|<span data-ttu-id="d1a39-627">PZW-00020</span><span class="sxs-lookup"><span data-stu-id="d1a39-627">PZW-00020</span></span>|
   |<span data-ttu-id="d1a39-628">Microsoft 365 Business Voice(통화 플랜 제외) 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-628">Microsoft 365 Business Voice (without calling plan) Adoption Promo</span></span>|<span data-ttu-id="d1a39-629">b71df433-6fd9-4549-886d-577f7aa06070</span><span class="sxs-lookup"><span data-stu-id="d1a39-629">b71df433-6fd9-4549-886d-577f7aa06070</span></span>|<span data-ttu-id="d1a39-630">PZY-00019</span><span class="sxs-lookup"><span data-stu-id="d1a39-630">PZY-00019</span></span>|
   |<span data-ttu-id="d1a39-631">Microsoft 365 Business Voice(통화 플랜 제외) 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-631">Microsoft 365 Business Voice (without calling plan) Adoption Promo</span></span>|<span data-ttu-id="d1a39-632">4ba4d580-4902-42b0-8411-a27358dd5405</span><span class="sxs-lookup"><span data-stu-id="d1a39-632">4ba4d580-4902-42b0-8411-a27358dd5405</span></span>|<span data-ttu-id="d1a39-633">PZY-00016</span><span class="sxs-lookup"><span data-stu-id="d1a39-633">PZY-00016</span></span>|
   |<span data-ttu-id="d1a39-634">Microsoft 365 Business Voice(통화 플랜 제외) 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-634">Microsoft 365 Business Voice (without calling plan) Adoption Promo</span></span>|<span data-ttu-id="d1a39-635">bbfd896b-e3d4-45ba-9319-14104d400069</span><span class="sxs-lookup"><span data-stu-id="d1a39-635">bbfd896b-e3d4-45ba-9319-14104d400069</span></span>|<span data-ttu-id="d1a39-636">PZY-00018</span><span class="sxs-lookup"><span data-stu-id="d1a39-636">PZY-00018</span></span>|
   |<span data-ttu-id="d1a39-637">미국용 Microsoft 365 Business Voice(통화 플랜 제외) 도입 프로모션</span><span class="sxs-lookup"><span data-stu-id="d1a39-637">Microsoft 365 Business Voice (without Calling Plan) for US Adoption Promo</span></span>|<span data-ttu-id="d1a39-638">9b05d0b7-cfb4-42f1-9cc3-f698dba2838e</span><span class="sxs-lookup"><span data-stu-id="d1a39-638">9b05d0b7-cfb4-42f1-9cc3-f698dba2838e</span></span>|<span data-ttu-id="d1a39-639">PZY-00017</span><span class="sxs-lookup"><span data-stu-id="d1a39-639">PZY-00017</span></span>|

<span data-ttu-id="d1a39-640">이러한 프로모션은 다음 고객에게 영향을 줍니다.</span><span class="sxs-lookup"><span data-stu-id="d1a39-640">These promotions affect the following customers:</span></span>

- <span data-ttu-id="d1a39-641">순 신규 고객 테넌트</span><span class="sxs-lookup"><span data-stu-id="d1a39-641">Net new customer tenants</span></span>
- <span data-ttu-id="d1a39-642">CSP, 웹 다이렉트 또는 기타 Microsoft 상업 채널의 Business Voice 또는 오디오 회의 라이선스에 대해 활성화하지 않았거나 최근에 구독을 취소하지 않은(지난 30일 이내) 기존 고객 테넌트</span><span class="sxs-lookup"><span data-stu-id="d1a39-642">Existing customer tenants who do not have an active or recently canceled (within the last 30 days) subscription on any Business Voice or Audio Conferencing license on CSP, Web Direct, or any other Microsoft commercial channel</span></span>

#### <a name="additional-resources"></a><span data-ttu-id="d1a39-643">추가 리소스</span><span class="sxs-lookup"><span data-stu-id="d1a39-643">Additional resources</span></span>

- <span data-ttu-id="d1a39-644">Business Voice에 대한 자세한 내용은 [Microsoft 365 Business Voice 파트너 페이지](https://www.microsoft.com/microsoft-365/partners/businessvoice)를 방문하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-644">Visit the [Microsoft 365 Business Voice partner page](https://www.microsoft.com/microsoft-365/partners/businessvoice) to learn more about Business Voice.</span></span> 
- <span data-ttu-id="d1a39-645">관련 [파트너 FAQ](https://www.microsoft.com/microsoft-365/partners/resources/faq-business-voice-audio-conferencing-promo)에서 이 프로모션에 대해 자세히 알아보세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-645">Learn more about this promotion in the related [Partner FAQ](https://www.microsoft.com/microsoft-365/partners/resources/faq-business-voice-audio-conferencing-promo).</span></span>

### <a name="next-steps"></a><span data-ttu-id="d1a39-646">다음 단계</span><span class="sxs-lookup"><span data-stu-id="d1a39-646">Next steps</span></span>

- <span data-ttu-id="d1a39-647">이러한 미팅 및 통화 프로모션 기회를 숙지하고 이 정보를 조직 내의 모든 해당 담당자와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-647">Familiarize yourself with these meeting and calling promo opportunities and share this information with all appropriate contacts in your organization.</span></span>
- <span data-ttu-id="d1a39-648">이러한 프로모션을 Microsoft 365 판매 프로모션에 통합하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-648">Incorporate these promotions in your Microsoft 365 sales motions.</span></span>
- <span data-ttu-id="d1a39-649">Teams에 Business Voice를 추가하는 가치에 대해 고객의 인식을 제고하세요.</span><span class="sxs-lookup"><span data-stu-id="d1a39-649">Drive awareness among customers about the value of adding Business Voice to Teams.</span></span> 
