...
### <a name="summary"></a><span data-ttu-id="fb8c0-112">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-112">Summary</span></span>
...
### <a name="categories"></a><span data-ttu-id="fb8c0-140">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-140">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="fb8c0-157">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-157">Next steps</span></span>
...
<span data-ttu-id="fb8c0-170">클라우드 솔루션 공급자 프로그램의 EUR 가격표를 통해 M365 E3을 거래하는 모든 파트너</span><span class="sxs-lookup"><span data-stu-id="fb8c0-170">All partners transacting M365 E3 through the EUR price list in the Cloud Solution Provider program.</span></span>
...
### <a name="categories"></a><span data-ttu-id="fb8c0-184">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-184">Categories</span></span>
...
### <a name="next-steps"></a><span data-ttu-id="fb8c0-201">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-201">Next steps</span></span>
...
### <a name="summary"></a><span data-ttu-id="fb8c0-230">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-230">Summary</span></span>
...
### <a name="details"></a><span data-ttu-id="fb8c0-296">세부 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-296">Details</span></span>
...
### <a name="categories"></a><span data-ttu-id="fb8c0-315">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-315">Categories</span></span>
...
<span data-ttu-id="fb8c0-331">이번 출시를 위해 기존에 생성된 제품 ID는 다음과 같습니다. 무인 라이선스용 Microsoft 365 E3: ec3ac2d1-dd66-475a-95c8-59c32c472778</span><span class="sxs-lookup"><span data-stu-id="fb8c0-331">The original offer ID created for this launch was: Microsoft 365 E3 for unattended license: ec3ac2d1-dd66-475a-95c8-59c32c472778</span></span>
...
### <a name="categories"></a><span data-ttu-id="fb8c0-341">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-341">Categories</span></span>
...
<span data-ttu-id="fb8c0-360">가격표에서 다음과 같은 제품 ID를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-360">Please refer to the following offer IDs in the price list:</span></span>
...
<span data-ttu-id="fb8c0-377">위와 같은 변경 사항에 더해, Microsoft는 Office 365 Advanced Compliance 및 AIP(Azure Information Protection) 플랜 2를 중단합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-377">In addition to the changes above, Microsoft is sunsetting Office 365 Advanced Compliance and Azure Information Protection (AIP) Plan 2.</span></span> <span data-ttu-id="fb8c0-378">해당 제품은 2020년 4월 1일부터 순 신규 고객을 위한 가격표에서 사용할 수 없으며, 기존 고객의 경우 자동 갱신이 비활성화되었습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-378">From April 1, 2020, these offers are no longer available on the price list for net new customers, and auto-renew has been turned off for existing customers.</span></span>
...
<span data-ttu-id="fb8c0-406">파트너가 증가하는 원격 및 스마트 작업 요구에 부응할 수 있도록 지원하기 위해 특별히 마련된 새 Office 365 E1 평가판을 CSP에서 제공하게 되었음을 발표하게 되어 기쁘게 생각합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-406">We're excited to announce a new Office 365 E1 Trial in CSP, created specifically to support the partner response to the growing needs for remote and smart working.</span></span> <span data-ttu-id="fb8c0-407">이 평가판 제품은 2020년 4월 1일부터 추가 공지가 있을 때까지 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-407">This trial offer is available from April 1, 2020 until further notice.</span></span>

<span data-ttu-id="fb8c0-408">CSP Office 365 E1 평가판은 현재 Microsoft Teams CSP 평가판(Exchange 및 2GB의 스토리지 불포함) 외에 이제 추가로 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-408">CSP Office 365 E1 Trial is now available in addition to the current Microsoft Teams CSP Trial (which has no Exchange and 2 GB of storage).</span></span> <span data-ttu-id="fb8c0-409">새 평가판은 Office 365 E1 평가판과 같은 기능을 제공하며 최대 3,000명의 사용자가 6개월간 별도 비용 없이 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-409">The new trial will have equivalent functionality to the Office 365 E1 trial, and it will provide 6 months of free use for up to 3,000 users.</span></span> <span data-ttu-id="fb8c0-410">CSP를 통해 사용할 수 있는 이 제품을 통해 파트너는 평가판 환경을 시작하고 관리할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-410">Available through CSP, this offer allows partners to initiate and manage the trial experience.</span></span>

### <a name="offer-id"></a><span data-ttu-id="fb8c0-411">제품 ID</span><span class="sxs-lookup"><span data-stu-id="fb8c0-411">Offer ID</span></span>

- <span data-ttu-id="fb8c0-412">표시 이름: Office 365 E1 평가판</span><span class="sxs-lookup"><span data-stu-id="fb8c0-412">Display name: Office 365 E1 Trial</span></span>
- <span data-ttu-id="fb8c0-413">평가판 제품 ID: c0c1386f-4a95-466b-8974-cefd71414def</span><span class="sxs-lookup"><span data-stu-id="fb8c0-413">Trial offer ID: c0c1386f-4a95-466b-8974-cefd71414def</span></span>

<span data-ttu-id="fb8c0-414">이 제품은 2020년 4월 1일부터 프로덕션 가격표에서 즉시 구매할 수 있게 되었습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-414">This offer has been made available immediately to purchase on the production price list from April 1, 2020.</span></span>

### <a name="next-steps"></a><span data-ttu-id="fb8c0-415">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-415">Next steps</span></span>

- [<span data-ttu-id="fb8c0-416">CSP Office 365 E1 평가판 FAQ 검토</span><span class="sxs-lookup"><span data-stu-id="fb8c0-416">Review the CSP Office 365 E1 trial FAQ</span></span>](https://aka.ms/CSPE1OfferFAQ)
- [<span data-ttu-id="fb8c0-417">Microsoft Teams 평가판 및 제품에 대해 자세히 알아보기</span><span class="sxs-lookup"><span data-stu-id="fb8c0-417">Learn more about Microsoft Teams trials and offers</span></span>](https://www.microsoft.com/microsoft-365/partners/resources/teams-offers-and-trials-comparison)
- [<span data-ttu-id="fb8c0-418">파트너에 대한 최신 원격 작업 지침 살펴보기</span><span class="sxs-lookup"><span data-stu-id="fb8c0-418">Explore the latest remote work guidance for partners</span></span>](https://aka.ms/partnerremotework)
- [<span data-ttu-id="fb8c0-419">파트너에 대한 추가 평가판 자산 확인</span><span class="sxs-lookup"><span data-stu-id="fb8c0-419">Check out additional trial assets for partners</span></span>](https://aka.ms/E1TrialPartnerBOM)

<span data-ttu-id="fb8c0-420">다음 주에 추가 지침이 게시될 예정이므로 [파트너 센터](https://partner.microsoft.com/resources/collection/O365E1-trial-now-available-CSP-partners#/) 및 파트너 리소스를 정기적으로 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-420">Check the [Partner Center](https://partner.microsoft.com/resources/collection/O365E1-trial-now-available-CSP-partners#/) and partner resources regularly as we will be publishing more guidance in the coming week.</span></span>

### <a name="questions"></a><span data-ttu-id="fb8c0-421">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="fb8c0-421">Questions?</span></span>

<span data-ttu-id="fb8c0-422">이 제품에 대한 질문이 있는 경우 관련 Yammer 커뮤니티를 확인하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-422">If you have questions about these offers, check your relevant Yammer communities.</span></span> <span data-ttu-id="fb8c0-423">다른 문제의 경우 파트너 센터 지원에서 티켓을 제출하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-423">For other issues, please submit a ticket at Partner Center Support.</span></span>

_________________

## <a name="dynamics-365---new-products-released"></a><a id="4"/></a><span data-ttu-id="fb8c0-424">Dynamics 365 - 새 제품이 릴리스됨</span><span class="sxs-lookup"><span data-stu-id="fb8c0-424">Dynamics 365 - New products released</span></span>

### <a name="categories"></a><span data-ttu-id="fb8c0-425">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-425">Categories</span></span>

- <span data-ttu-id="fb8c0-426">날짜: 2020-04-06</span><span class="sxs-lookup"><span data-stu-id="fb8c0-426">Date: 2020-04-06</span></span>
- <span data-ttu-id="fb8c0-427">다음을 입력합니다. 제품/시장</span><span class="sxs-lookup"><span data-stu-id="fb8c0-427">Type: Offers/Markets</span></span>
- <span data-ttu-id="fb8c0-428">상태: 지금 이용 가능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-428">Status: Now Available</span></span>
- [<span data-ttu-id="fb8c0-429">자세한 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-429">Learn more</span></span>](https://partner.microsoft.com/resources/collection/partner-security-requirements#/)

### <a name="summary"></a><span data-ttu-id="fb8c0-430">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-430">Summary</span></span>

<span data-ttu-id="fb8c0-431">Microsoft는 2020년 4월 1일에 추가 Dynamics 365 제품을 릴리스했습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-431">On April 1, 2020, Microsoft released additional Dynamics 365 products.</span></span> <span data-ttu-id="fb8c0-432">Dynamics 365에 대한 추가 새 제품은 2020년 5월 1일에 릴리스될 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-432">Additional new offers for Dynamics 365 will be released on May 1, 2020.</span></span>
<span data-ttu-id="fb8c0-433">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="fb8c0-433">Impacted audience</span></span>

<span data-ttu-id="fb8c0-434">CSP(클라우드 솔루션 공급자) 프로그램을 통해 Dynamics 365를 제공하는 파트너.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-434">Partners offering Dynamics 365 through the Cloud Solution Provider (CSP) program.</span></span> <span data-ttu-id="fb8c0-435">달리 지정되지 않은 한, 이 업데이트는 전 세계 모든 위치와 관련이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-435">These updates relate to all locations worldwide, unless otherwise specified.</span></span>

### <a name="details"></a><span data-ttu-id="fb8c0-436">세부 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-436">Details</span></span>

<span data-ttu-id="fb8c0-437">Microsoft는 2020년 4월 1일에 Dynamics Business Central Online, Dynamics 비즈니스 앱 및 Power Platform의 새 제품을 릴리스했습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-437">On April 1, 2020, Microsoft released new products for Dynamics Business Central Online, and Dynamics Biz Apps and Power Platforms.</span></span> <span data-ttu-id="fb8c0-438">Dynamics 365에 대한 추가 새 제품은 2020년 5월 1일에 릴리스될 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-438">Additional new offers for Dynamics 365 will be released on May 1, 2020.</span></span>

### <a name="dynamics-business-central-online-offers"></a><span data-ttu-id="fb8c0-439">Dynamics Business Central Online 제품</span><span class="sxs-lookup"><span data-stu-id="fb8c0-439">Dynamics Business Central Online Offers</span></span>
<span data-ttu-id="fb8c0-440">2020년 4월 1일에 Dynamics Business Central Online 제품이 다음과 같이 변경되었습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-440">On April 1, 2020, the following changes were made to the Dynamics Business Central Online offers.</span></span>

- <span data-ttu-id="fb8c0-441">CSP의 Business Central용 새 Dynamics Business 제품</span><span class="sxs-lookup"><span data-stu-id="fb8c0-441">New Dynamics Business offers for Business Central in CSP</span></span>
- <span data-ttu-id="fb8c0-442">영업 전문가 및 고객 서비스 전문가 연결 SKU 업데이트</span><span class="sxs-lookup"><span data-stu-id="fb8c0-442">Update Sales Pro and Customer Service Pro Attach SKUs</span></span>

### <a name="dynamics-biz-apps-and-power-platform-products"></a><span data-ttu-id="fb8c0-443">Dynamics 비즈니스 앱 및 Power Platform 제품</span><span class="sxs-lookup"><span data-stu-id="fb8c0-443">Dynamics Biz Apps and Power Platform Products</span></span>

<span data-ttu-id="fb8c0-444">2020년 4월 1일에 Dynamics 비즈니스 앱 및 Power Platform 제품이 다음과 같이 변경되었습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-444">On April 1, 2020, the following changes were made to the Dynamics Biz Apps and Power Platform products.</span></span>

- <span data-ttu-id="fb8c0-445">자사 RPA(로봇 프로세스 자동화) 제품</span><span class="sxs-lookup"><span data-stu-id="fb8c0-445">First-party Robotic Process Automation (RPA) offers</span></span>
- <span data-ttu-id="fb8c0-446">RPA 제품용 새 봇 제품</span><span class="sxs-lookup"><span data-stu-id="fb8c0-446">New BOT product for RPA offers</span></span>

<span data-ttu-id="fb8c0-447">구체적인 변경 사항은 [여기](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)에서 Dynamics CSP Offer Updates-Mar 2020 파일을 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-447">Please see the specific changes in the Dynamics CSP Offer Updates-Mar 2020 file [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/).</span></span>

### <a name="robotic-process-automation"></a><span data-ttu-id="fb8c0-448">로봇 프로세스 자동화</span><span class="sxs-lookup"><span data-stu-id="fb8c0-448">Robotic Process Automation</span></span>

<span data-ttu-id="fb8c0-449">Microsoft는 2020년 5월 1일에 새 RPA 제품의 가용성을 교육 프로그램으로 확장합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-449">On May 1, 2020, Microsoft will be expanding the availability of new RPA offers into the Education programs.</span></span>
<span data-ttu-id="fb8c0-450">CSP의 승인된 교육 파트너 프로그램 변경 사항에 대해 자세히 알아보려면 [여기](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/)를 클릭하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-450">To learn more about changes to the Authorized Education Partner Program in CSP click [here](https://partner.microsoft.com/resources/collection/csp-aer-partner-qualification-retirement#/).</span></span> <span data-ttu-id="fb8c0-451">참고: 이는 파트너 센터의 기존 컬렉션 링크입니다).</span><span class="sxs-lookup"><span data-stu-id="fb8c0-451">NOTE: This is a link to an existing collection on Partner Center).</span></span>

<span data-ttu-id="fb8c0-452">새 SKU 정보의 관련 다운로드 섹션에서 첨부된 **Dynamics CSP Offer Updates-May 2020 파일**([여기](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/))을 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-452">Please review the attached **Dynamics CSP Offer Updates-May 2020 file** [here](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/) in the related download section for new SKU information.</span></span>

### <a name="ecommerce-changes"></a><span data-ttu-id="fb8c0-453">전자상거래 변경 사항</span><span class="sxs-lookup"><span data-stu-id="fb8c0-453">eCommerce changes</span></span>

<span data-ttu-id="fb8c0-454">2020년 4월 1일부터 전자상거래 제품은 최종 가격표에 표시 이름 및/또는 PFAM 변경 사항이 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-454">Effective April 1, 2020, eCommerce offers have display name and/or PFAM changes on the final price sheets.</span></span> <span data-ttu-id="fb8c0-455">변경 사항은 아래 표에 간략하게 나와 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-455">The changes are outlined in the table below.</span></span>

|<span data-ttu-id="fb8c0-456">**표시 이름 및/또는 PFAM 변경 사항**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-456">**Display Name and/or PFAM Change**</span></span>|<span data-ttu-id="fb8c0-457">**2020년 3월 1일**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-457">**March 1, 2020**</span></span>|<span data-ttu-id="fb8c0-458">**2020년 4월 1일**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-458">**April 1, 2020**</span></span>|
|-------------------|:------|:-----|
|<span data-ttu-id="fb8c0-459">표시 이름</span><span class="sxs-lookup"><span data-stu-id="fb8c0-459">Display Name</span></span>|<span data-ttu-id="fb8c0-460">전자상거래 평점 및 리뷰</span><span class="sxs-lookup"><span data-stu-id="fb8c0-460">eCommerce Ratings and Reviews</span></span>|<span data-ttu-id="fb8c0-461">상거래 평점 및 리뷰</span><span class="sxs-lookup"><span data-stu-id="fb8c0-461">Commerce Ratings and Reviews</span></span>|
|<span data-ttu-id="fb8c0-462">표시 이름</span><span class="sxs-lookup"><span data-stu-id="fb8c0-462">Display Name</span></span>|<span data-ttu-id="fb8c0-463">전자상거래 권장 사항</span><span class="sxs-lookup"><span data-stu-id="fb8c0-463">eCommerce Recommendations</span></span>|<span data-ttu-id="fb8c0-464">상거래 권장 사항</span><span class="sxs-lookup"><span data-stu-id="fb8c0-464">Commerce Recommendations</span></span>|
|<span data-ttu-id="fb8c0-465">표시 및 PFAM</span><span class="sxs-lookup"><span data-stu-id="fb8c0-465">Display and PFAM</span></span>|<span data-ttu-id="fb8c0-466">Dynamics 365 상거래 클라우드 배율 단위 기본</span><span class="sxs-lookup"><span data-stu-id="fb8c0-466">Dynamics 365 Commerce Cloud Scale Unit Basic</span></span>|<span data-ttu-id="fb8c0-467">Dynamics 365 상거래 배율 단위 기본 - 클라우드</span><span class="sxs-lookup"><span data-stu-id="fb8c0-467">Dynamics 365 Commerce Scale Unit Basic – Cloud</span></span>|
|<span data-ttu-id="fb8c0-468">표시 및 PFAM</span><span class="sxs-lookup"><span data-stu-id="fb8c0-468">Display and PFAM</span></span>|<span data-ttu-id="fb8c0-469">Dynamics 365 상거래 클라우드 배율 단위 표준</span><span class="sxs-lookup"><span data-stu-id="fb8c0-469">Dynamics 365 Commerce Cloud Scale Unit Standard</span></span>|<span data-ttu-id="fb8c0-470">Dynamics 365 상거래 배율 단위 기본 - 클라우드</span><span class="sxs-lookup"><span data-stu-id="fb8c0-470">Dynamics 365 Commerce Scale Unit Basic - Cloud</span></span>|
|<span data-ttu-id="fb8c0-471">표시 및 PFAM</span><span class="sxs-lookup"><span data-stu-id="fb8c0-471">Display and PFAM</span></span>|<span data-ttu-id="fb8c0-472">Dynamics 365 상거래 클라우드 배율 단위 프리미엄</span><span class="sxs-lookup"><span data-stu-id="fb8c0-472">Dynamics 365 Commerce Cloud Scale Unit Premium</span></span>|<span data-ttu-id="fb8c0-473">Dynamics 365 상거래 배율 단위 프리미엄 - 클라우드</span><span class="sxs-lookup"><span data-stu-id="fb8c0-473">Dynamics 365 Commerce Scale Unit Premium - Cloud</span></span>|

### <a name="additional-resources"></a><span data-ttu-id="fb8c0-474">추가 리소스</span><span class="sxs-lookup"><span data-stu-id="fb8c0-474">Additional resources</span></span>

- [<span data-ttu-id="fb8c0-475">Dynamics 365 홈페이지</span><span class="sxs-lookup"><span data-stu-id="fb8c0-475">Dynamics 365 Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-476">혼합 현실 앱 가이드 홈페이지</span><span class="sxs-lookup"><span data-stu-id="fb8c0-476">Mixed Reality Apps Guide Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-477">비즈니스 앱 사기 방지 홈페이지</span><span class="sxs-lookup"><span data-stu-id="fb8c0-477">Biz Apps Fraud Home Page</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-478">FY20 PowerApps 및 Flow 라이선싱 업데이트</span><span class="sxs-lookup"><span data-stu-id="fb8c0-478">FY20 PowerApps and Flow Licensing Updates</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-479">Microsoft Dynamics 365 라이선싱</span><span class="sxs-lookup"><span data-stu-id="fb8c0-479">Microsoft Dynamics 365 Licensing</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-480">Dynamics 365 및 Power Platform - 가용성, 데이터 위치, 언어 및 지역화 콘텐츠</span><span class="sxs-lookup"><span data-stu-id="fb8c0-480">Dynamics 365 and Power Platforms-Availability, data location, language, and localization content</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-481">FY20 새로운 기능 웨비나 시리즈</span><span class="sxs-lookup"><span data-stu-id="fb8c0-481">FY20 What's New Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-482">FY20 기술 준비 웨비나 시리즈</span><span class="sxs-lookup"><span data-stu-id="fb8c0-482">FY20 Technical Readiness Webinar Series</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)
- [<span data-ttu-id="fb8c0-483">RPA(로봇 프로세스 자동화)</span><span class="sxs-lookup"><span data-stu-id="fb8c0-483">Robotic Process Automation (RPA)</span></span>](https://partner.microsoft.com/resources/collection/Microsoft-Dynamics-365-product-releases-for-November-and-December-2019#/)

### <a name="next-steps"></a><span data-ttu-id="fb8c0-484">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-484">Next steps</span></span>

<span data-ttu-id="fb8c0-485">이 정보를 조직 내의 해당하는 연락처와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-485">Please share this information with appropriate contacts in your organization.</span></span> <span data-ttu-id="fb8c0-486">라이선싱 업데이트 및 가치 제안에 대한 자세한 내용은 "추가 리소스" 섹션 및 PartnerSource의 준비 상태 콘텐츠를 참조하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-486">For more details on the licensing updates and the value proposition, please familiarize yourself with our readiness content in the "Additional resources" section, and on PartnerSource.</span></span>

### <a name="questions"></a><span data-ttu-id="fb8c0-487">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="fb8c0-487">Questions?</span></span>

<span data-ttu-id="fb8c0-488">Microsoft에 대한 작업과 관련하여 도움이 필요한 경우 [고객 지원에 문의하세요](https://partner.microsoft.com/pcv/servicerequests/create).</span><span class="sxs-lookup"><span data-stu-id="fb8c0-488">For help strictly relating to your operations with Microsoft, please [reach out to support](https://partner.microsoft.com/pcv/servicerequests/create).</span></span>

_________________

## <a name="now-available---operations-readiness-resources-in-one-place"></a><a id="3"/></a><span data-ttu-id="fb8c0-489">지금 이용 가능 - 한곳에서 제공되는 Operations Readiness 리소스</span><span class="sxs-lookup"><span data-stu-id="fb8c0-489">Now available - Operations readiness resources in one place</span></span>

### <a name="categories"></a><span data-ttu-id="fb8c0-490">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-490">Categories</span></span>

- <span data-ttu-id="fb8c0-491">날짜: 2020-04-03</span><span class="sxs-lookup"><span data-stu-id="fb8c0-491">Date: 2020-04-03</span></span>
- <span data-ttu-id="fb8c0-492">다음을 입력합니다. 기능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-492">Type: Capabilities</span></span>
- <span data-ttu-id="fb8c0-493">상태: 지금 이용 가능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-493">Status: Now Available</span></span>
- [<span data-ttu-id="fb8c0-494">자세한 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-494">Learn more</span></span>](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/)

### <a name="impacted-audience"></a><span data-ttu-id="fb8c0-495">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="fb8c0-495">Impacted audience</span></span>
- <span data-ttu-id="fb8c0-496">모든 CSP 파트너</span><span class="sxs-lookup"><span data-stu-id="fb8c0-496">All CSP partners</span></span>

### <a name="summary"></a><span data-ttu-id="fb8c0-497">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-497">Summary</span></span>

<span data-ttu-id="fb8c0-498">현재 [Operations Readiness 리소스 위치](https://partner.microsoft.com/resources#/)가 라이브 상태이며 파트너에게 Operations Readiness 리소스를 한 위치에서 제공하여 모든 Microsoft 채널 및 프로그램에 대한 최신 업데이트 및 주요 작업 준비 리소스를 이전보다 쉽게 찾을 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-498">The [Operations Readiness resource location](https://partner.microsoft.com/resources#/) is now live, providing partners with one location for operations readiness resources, making it easier than ever to find the latest updates and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="fb8c0-499">CSP 프로그램 업데이트 리소스 갤러리 및 Microsoft Readiness 콘텐츠는 Operations Readiness 리소스 위치로 이동되었으며 CSP 프로그램 업데이트 리소스 갤러리([https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/))를 가리키는 URL이 Operations Readiness 리소스 위치를 가리키도록 업데이트되었습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-499">The CSP Program Updates Resource gallery and Microsoft Readiness content has been moved to the Operations Readiness resource location and the URL pointing to the CSP Program Update Resource Gallery ([https://partner.microsoft.com/resources#/](https://partner.microsoft.com/resources#/)) has been updated to point to the Operations Readiness resource location.</span></span>

<span data-ttu-id="fb8c0-500">이 새로운 환경과 앞으로 몇 주에 걸쳐 계속 개선될 일부 영역에 대한 자세한 내용은 [업데이트된 FAQ](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf)(여기)를 검토하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-500">Please review the [updated FAQ](https://assetsprod.microsoft.com/mpn/readiness-in-one-place-partner-login-faq.pdf) here for further details on this new experience and some areas that will continue to evolve over the next few weeks.</span></span>

<span data-ttu-id="fb8c0-501">**여러분의 피드백은 매우 중요합니다!**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-501">**Your feedback is important to us!**</span></span> <span data-ttu-id="fb8c0-502">새 Operations Readiness 리소스 위치를 사용하면서 계속해서 환경을 개선할 수 있도록 피드백을 남겨 주세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-502">As you use the new Operations Readiness location, we invite you to leave feedback so we can continue to improve your experience.</span></span> <span data-ttu-id="fb8c0-503">각 페이지 아래쪽에서 사용할 수 있는 **이 페이지가 도움이 되었나요? 예 | 아니요** 피드백 도구를 사용하여 피드백을 남길 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-503">You can do this by using the **Was this page helpful? Yes | No** feedback tool available at the bottom of each page.</span></span>

<span data-ttu-id="fb8c0-504">Microsoft는 모든 Microsoft 프로그램과 관련하여 커뮤니케이션하고 준비 자료를 제공하는 방식을 간소화합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-504">Microsoft is streamlining the way we communicate and provide readiness materials across all Microsoft programs.</span></span> <span data-ttu-id="fb8c0-505">[CSP 프로그램 업데이트 리소스 갤러리](https://partner.microsoft.com/resources#/)와 [Microsoft Readiness 사이트](https://www.microsoftreadiness.com/)의 자산이 결합된 단일 Operations Readiness 리소스 위치가 Microsoft 파트너 웹 사이트([https://partner.microsoft.com](https://partner.microsoft.com))에 도입됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-505">We are introducing one Operations Readiness resource location on the Microsoft partner website at [https://partner.microsoft.com](https://partner.microsoft.com) that will combine assets from the [CSP Program Updates Resource Gallery](https://partner.microsoft.com/resources#/) and the [Microsoft Readiness site](https://www.microsoftreadiness.com/).</span></span>

<span data-ttu-id="fb8c0-506">작업 준비 리소스가 한곳으로 통합되면 파트너가 최신 업데이트와 중요 공지 사항, 모든 Microsoft 채널 및 프로그램의 주요 작업 준비 리소스를 그 어느 때보다 쉽게 찾을 수 있게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-506">With one location for operations readiness resources, it will be easier than ever for partners to find the latest updates, critical announcements, and key operational readiness resources across all Microsoft channels and programs.</span></span> <span data-ttu-id="fb8c0-507">Single Sign-On 기능과 향상된 검색, 필터, 정렬 기능으로 각종 자료에 손쉽게 액세스하고 이용하며 Microsoft와 편리한 방식으로 비즈니스 거래를 수행할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-507">With a single sign-on experience and enhanced search, filter, and sort capabilities partners can easily access, consume, and prepare their businesses to successfully transact and do business with Microsoft in the way that works for them.</span></span>

### <a name="expanding-on-the-success-of-the-csp-program-updates-resource-gallery"></a><span data-ttu-id="fb8c0-508">CSP 프로그램 업데이트 리소스 갤러리와 유사한 구조:</span><span class="sxs-lookup"><span data-stu-id="fb8c0-508">Expanding on the success of the CSP Program Updates Resource Gallery:</span></span>

<span data-ttu-id="fb8c0-509">partner.microsoft.com의 작업 준비 리소스 사이트는 기존의 CSP 프로그램 업데이트 리소스 갤러리와 비슷하게 기능하며, 다음과 같은 개선 사항 및 수정 사항이 반영됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-509">The operations readiness resource location on partner.microsoft.com will function much like the current CSP Program Update Resource Gallery with some notable enhancements and modifications, including:</span></span>

- <span data-ttu-id="fb8c0-510">**프로그램 페이지:** 각 페이지는 해당 프로그램의 콘텐츠만 표시하도록 미리 필터가 적용되기 때문에 해당 프로그램의 최근 문서 업데이트를 쉽게 찾을 수 있게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-510">**Program Pages:** Finding the most recent document updates for a specific program will be made easy with pages that are pre-filtered to content only for that program.</span></span>
- <span data-ttu-id="fb8c0-511">**강력한 갤러리 검색:** 모든 프로그램과 콘텐츠에서 빠르고 간편하게 콘텐츠를 찾을 수 있도록 도와주는 콘텐츠 필터가 제공됩니다(예: CSP).</span><span class="sxs-lookup"><span data-stu-id="fb8c0-511">**Powerful gallery search:** Content filters will make finding content across programs and content faster and simpler, for example, CSP.</span></span>
- <span data-ttu-id="fb8c0-512">**공지:** 각 페이지는 해당 프로그램의 콘텐츠만 표시하도록 미리 필터가 적용되기 때문에 해당 프로그램의 최신 공지 사항과 최근 문서 업데이트를 쉽게 찾을 수 있게 됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-512">**Announcements:** Finding the latest announcements and most recent document updates for a specific program will be easier with pages that are pre-filtered to content only for that program.</span></span> <span data-ttu-id="fb8c0-513">CSP를 위한 프로그램 페이지도 제공되지만, CSP 공지는 계속해서 파트너 센터에 게시됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-513">There will be a program page for CSP as well however CSP announcements will continue to be posted in Partner Center.</span></span>
- <span data-ttu-id="fb8c0-514">**새 위치:** partner.microsoft.com의 새로운 작업 리소스 위치가 정식으로 공개되면 Microsoft Readiness 사이트와 CSP 프로그램 업데이트 리소스 갤러리에는 더 이상 액세스할 수 없으며 새로운 작업 리소스 사이트로 리디렉션됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-514">**New location:** Once the new location for operations resources is live on partner.microsoft.com, the Microsoft Readiness site and the CSP Program Updates Resource Gallery will no longer be accessible and will redirect users to the new operations resource location.</span></span> <span data-ttu-id="fb8c0-515">파트너는 콘텐츠 프로그램 필터를 사용하여 CSP 또는 다른 프로그램 리소스로 필터링할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-515">Partners will be able to leverage content program filters to filter to CSP or other specific program resources.</span></span>
- <span data-ttu-id="fb8c0-516">**확장된 콘텐츠:** Microsoft Readiness 사이트와 CSP 프로그램 업데이트 리소스 갤러리의 모든 최근 및 관련 콘텐츠가 새로운 작업 준비 사이트로 이전됩니다. 즉, 이제 더 많은 프로그램의 콘텐츠가 한곳에 정리됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-516">**Content expanded:** All recent and relevant content from the Microsoft Readiness site and the CSP Program Updates Resource Gallery will be relocated to the new operations readiness location meaning content for more programs will now be housed in one location.</span></span>

### <a name="next-steps"></a><span data-ttu-id="fb8c0-517">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-517">Next steps</span></span>

<span data-ttu-id="fb8c0-518">준비하려면 어떻게 해야 하나요?</span><span class="sxs-lookup"><span data-stu-id="fb8c0-518">What should you do to prepare?</span></span>

- <span data-ttu-id="fb8c0-519">갤러리 컬렉션 [출시 예정 - 한곳에서 제공되는 Operations Readiness 리소스](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/)에서 업데이트된 준비 자료를 검토하여 Operations Readiness 리소스의 새로운 Microsoft 파트너 웹 사이트 위치에 대해 **자세히 알아보세요**.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-519">**Learn more** about the new Microsoft partner website location for operations readiness resources by reviewing the updated readiness materials at the gallery collection [Coming soon - Operations readiness resources in one place](https://partner.microsoft.com/resources/collection/readiness-in-one-place#/).</span></span>
- <span data-ttu-id="fb8c0-520">**4월 파트너 커뮤니티 콜에 참석**하세요. 여기서는 새로운 환경에 대해 자세히 알아보고 질문할 수 있습니다([https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)).</span><span class="sxs-lookup"><span data-stu-id="fb8c0-520">**Attend an April partner community call** where you can learn more about the new experience and ask questions: [https://globalpbocomm.eventbuilder.com/GlobalCSP](https://globalpbocomm.eventbuilder.com/GlobalCSP)</span></span>

### <a name="questions"></a><span data-ttu-id="fb8c0-521">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="fb8c0-521">Questions?</span></span>

<span data-ttu-id="fb8c0-522">질문, 쿼리 또는 자세한 내용을 보려면 [지원](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp)에 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-522">Please [contact Support](https://partner.microsoft.com/dashboard/support/csp/servicerequests/create?category=csp) for questions, queries, or more information.</span></span>

### <a name="change-log"></a><span data-ttu-id="fb8c0-523">로그 변경</span><span class="sxs-lookup"><span data-stu-id="fb8c0-523">Change log</span></span>

- <span data-ttu-id="fb8c0-524">2020년 4월 3일: 지금 이용 가능으로 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="fb8c0-524">April 3, 2020: Updated to Now Available</span></span>
- <span data-ttu-id="fb8c0-525">2020년 3월 23일: CSP 프로그램 업데이트 리소스 갤러리의 Operations Readiness 리소스 위치로의 전환이 2020년 4월 3일로 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="fb8c0-525">March 23, 2020: CSP Program Updates Resource Gallery transition to Operations Readiness resource location updated to April 3, 2020</span></span>
- <span data-ttu-id="fb8c0-526">2020년 3월 9일: 30일 전 알림, 준비 자료가 업데이트됨</span><span class="sxs-lookup"><span data-stu-id="fb8c0-526">March 9, 2020: 30-Day notice, updated readiness materials</span></span>
- <span data-ttu-id="fb8c0-527">2020년 2월 14일: 원래 게시 날짜</span><span class="sxs-lookup"><span data-stu-id="fb8c0-527">February 14, 2020: Original publication date</span></span>

_________________

## <a name="microsoft-365-business-voice-available-to-csp-partners-from-april-1-2020"></a><a id="2"/></a><span data-ttu-id="fb8c0-528">2020년 4월 1일부터 CSP 파트너에게 Microsoft 365 Business Voice가 제공됨</span><span class="sxs-lookup"><span data-stu-id="fb8c0-528">Microsoft 365 Business Voice available to CSP partners from April 1, 2020</span></span>

### <a name="categories"></a><span data-ttu-id="fb8c0-529">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-529">Categories</span></span>

- <span data-ttu-id="fb8c0-530">날짜: 2020-04-01</span><span class="sxs-lookup"><span data-stu-id="fb8c0-530">Date: 2020-04-01</span></span>
- <span data-ttu-id="fb8c0-531">다음을 입력합니다. 제품/시장</span><span class="sxs-lookup"><span data-stu-id="fb8c0-531">Type: Offers/Markets</span></span>
- <span data-ttu-id="fb8c0-532">상태: 지금 이용 가능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-532">Status: Now Available</span></span>
- [<span data-ttu-id="fb8c0-533">자세한 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-533">Learn more</span></span>](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)

### <a name="summary"></a><span data-ttu-id="fb8c0-534">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-534">Summary</span></span>

<span data-ttu-id="fb8c0-535">중소기업용으로 빌드된 클라우드 기반 전화 시스템인 Microsoft 365 Business Voice는 2020년 4월 1일부터 여기에 나열된 국가에서 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-535">Microsoft 365 Business Voice, a cloud-based phone system built for small and medium businesses, will be available in the countries listed here from April 1, 2020.</span></span>

### <a name="impacted-audience"></a><span data-ttu-id="fb8c0-536">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="fb8c0-536">Impacted audience</span></span>

- <span data-ttu-id="fb8c0-537">여기에 나열된 [국가](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)에서 운영하는 모든 CSP 파트너.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-537">All CSP partners operating in [these countries](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/).</span></span>
- <span data-ttu-id="fb8c0-538">오스트레일리아의 파트너는 아래 지침을 확인해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-538">Partners in Australia should check our guidance below.</span></span>

### <a name="details"></a><span data-ttu-id="fb8c0-539">세부 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-539">Details</span></span>

<span data-ttu-id="fb8c0-540">Microsoft는 2020년 4월 1일에 추가 지역에 Microsoft 365 Business Voice를 도입합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-540">On April 1, 2020, Microsoft will introduce Microsoft 365 Business Voice to additional geographies.</span></span> <span data-ttu-id="fb8c0-541">Microsoft 365 Business Voice와 통화 플랜 불포함 Microsoft 365 Business Voice(직접 라우팅 사용)의 두 가지 제품을 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-541">Two offers will be available: Microsoft 365 Business Voice, and Microsoft 365 Business Voice Without Calling Plan (using direct routing).</span></span> <span data-ttu-id="fb8c0-542">두 제품 모두 미국에서 제공될 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-542">Both offers will be available in the U.S.</span></span>

### <a name="customer-value-proposition"></a><span data-ttu-id="fb8c0-543">고객 가치 제안</span><span class="sxs-lookup"><span data-stu-id="fb8c0-543">Customer value proposition</span></span>

<span data-ttu-id="fb8c0-544">Microsoft 365 Business Voice는 최대 300명의 사용자를 보유한 기업을 위한 클라우드 기반 전화 시스템입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-544">Microsoft 365 Business Voice is a cloud-based phone system for businesses of up to 300 users.</span></span> <span data-ttu-id="fb8c0-545">Microsoft Teams의 전화 번호로 전화를 걸고 받을 수 있는 기능을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-545">It provides the ability to make and receive calls from any phone number in Microsoft Teams.</span></span> <span data-ttu-id="fb8c0-546">Teams와 함께 통화, 채팅 및 모임을 결합하는 올인원 통신 솔루션을 제공합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-546">Together with Teams, it delivers an all-in-one communication solution combining calling, chat, and meetings.</span></span>

<span data-ttu-id="fb8c0-547">Microsoft 365 Business Voice는 컴퓨터, 스마트폰, 일반 전화기 등 업무가 수행되는 모든 곳에서 작동하는 단일 애플리케이션으로 생산성과 통신을 단순화 및 간소화합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-547">Microsoft 365 Business Voice simplifies and streamlines productivity and communications into a single application that works wherever businesses do: on computers, smart phones, and desk phones.</span></span> <span data-ttu-id="fb8c0-548">Microsoft 365 Business Voice의 이점은 다음과 같습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-548">The benefits of Microsoft 365 Business Voice include:</span></span>

- <span data-ttu-id="fb8c0-549">올인원 통신.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-549">All-in-one communication.</span></span> <span data-ttu-id="fb8c0-550">통화, 채팅, 모임, 일정 및 이메일을 통합하여 업무 수행 방식을 혁신합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-550">Transform how work gets done by unifying calling, chat, meetings, calendar, and email.</span></span>
- <span data-ttu-id="fb8c0-551">손쉬운 인텔리전트 통화.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-551">Easy and intelligent calling.</span></span> <span data-ttu-id="fb8c0-552">인텔리전스가 적용되어 더 유연하고 손쉽게 통신하므로 연결된 상태를 유지할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-552">Communicate with more flexibility, ease, and intelligence, so you can stay connected.</span></span>
- <span data-ttu-id="fb8c0-553">Microsoft 클라우드에서 제공됨.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-553">Delivered from the Microsoft cloud.</span></span> <span data-ttu-id="fb8c0-554">안정적이고 안전한 클라우드 기반 솔루션을 통해 자신감을 가지고 작업할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-554">Work confidently with a reliable and secure cloud-based solution.</span></span>

<span data-ttu-id="fb8c0-555">Microsoft 365 Business Voice는 다음 플랜에 대한 추가 기능으로 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-555">Microsoft 365 Business Voice is available as an add-on to the following plans:</span></span>

- <span data-ttu-id="fb8c0-556">Office 365 Business Essentials, Business Premium, F1, A1, E1, A3, E3</span><span class="sxs-lookup"><span data-stu-id="fb8c0-556">Office 365 Business Essentials, Business Premium, F1, A1, E1, A3, E3</span></span>
- <span data-ttu-id="fb8c0-557">Microsoft 365 Business, F1, A3, E3</span><span class="sxs-lookup"><span data-stu-id="fb8c0-557">Microsoft 365 Business, F1, A3, E3</span></span>

### <a name="partner-value-proposition"></a><span data-ttu-id="fb8c0-558">파트너 가치 제안</span><span class="sxs-lookup"><span data-stu-id="fb8c0-558">Partner value proposition</span></span>

<span data-ttu-id="fb8c0-559">파트너는 다음과 같은 방법으로 이 기회에서 수익을 창출할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-559">Partners can monetize this opportunity by:</span></span>

- <span data-ttu-id="fb8c0-560">통화 큐/자동 전화 교환이 포함된 전화 시스템을 사용하고, 네트워크 품질을 평가하거나, 직접 라우팅 및 오디오 회의를 구성합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-560">Enabling the phone system with Call Queues/Auto-Attendant, assessing the network quality, or configuring Direct Routing and audio conferencing.</span></span>
- <span data-ttu-id="fb8c0-561">사용자 채택/교육 서비스를 제공하여 조직에서 확실히 준비하도록 하고 최신 통신 도구인 Microsoft Teams 사용을 시작합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-561">Offering user adoption/training services to secure organization readiness and start using the modern communication tool, Microsoft Teams.</span></span>
- <span data-ttu-id="fb8c0-562">품질 보고, 디바이스 관리, 사용자 지원 등의 관리형 서비스를 통해 고객 환경을 지원하고 모니터링합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-562">Supporting and monitoring the customer environment with managed services like quality reporting, device management, and user support.</span></span>

<span data-ttu-id="fb8c0-563">**Microsoft 365 Business Voice(미국, 캐나다, 영국)**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-563">**Microsoft 365 Business Voice (United States, Canada, United Kingdom)**</span></span>

<span data-ttu-id="fb8c0-564">2019년 11월 영국 및 캐나다에서의 출시에 이어, 2020년 4월 1일에 통화 플랜 포함 Business Voice를 미국에서 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-564">On April 1, 2020, Business Voice with calling plans will be available for purchase in the United States, following our launch in the United Kingdom and Canada in November 2019.</span></span>

<span data-ttu-id="fb8c0-565">국제 통화 기능을 원하는 고객을 위해 추가 기능 제품도 제공됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-565">An add-on offer will also be available for those customers seeking international calling capabilities.</span></span>

- <span data-ttu-id="fb8c0-566">Microsoft 365 Business Voice: 9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span><span class="sxs-lookup"><span data-stu-id="fb8c0-566">Microsoft 365 Business Voice: 9f9f2c7b-c961-402b-9421-8e3c9207eeb3</span></span>
- <span data-ttu-id="fb8c0-567">SMB용 Microsoft 365 국제 통화 플랜: c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span><span class="sxs-lookup"><span data-stu-id="fb8c0-567">Microsoft 365 International Calling Plan for SMB: c01a89e5-d246-42d6-b21a-f4a1e9b04f56</span></span>

<span data-ttu-id="fb8c0-568">**통화 플랜 불포함 Microsoft 365 Business Voice(70개 이상 국가)**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-568">**Microsoft 365 Business Voice Without Calling Plan (70+ countries)**</span></span>

<span data-ttu-id="fb8c0-569">또는 2020년 4월 1일부터 전화 시스템 및 오디오 회의가 포함된 통화 플랜 불포함 Business Voice 제품을 구매할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-569">Alternatively, from April 1, 2020, you can purchase the Business Voice Without Calling Plan offer, which includes phone system and audio conferencing.</span></span> <span data-ttu-id="fb8c0-570">이 제품은 여기에 나열된 모든 국가에서 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-570">This offer is available in all countries listed here.</span></span>

- <span data-ttu-id="fb8c0-571">**미국만 해당:** 통화 플랜 불포함 Microsoft 365 Business Voice: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span><span class="sxs-lookup"><span data-stu-id="fb8c0-571">**United States only:** Microsoft 365 Business Voice Without Calling Plan: 39d77d0f-eb8f-4ebc-b618-692e1cc59c8f</span></span>
- <span data-ttu-id="fb8c0-572">**기타 국가:** 통화 플랜 불포함 Microsoft 365 Business Voice: cc69a07c-8c51-457f-bb2a-f21a62d6bede</span><span class="sxs-lookup"><span data-stu-id="fb8c0-572">**Rest of the world:** Microsoft 365 Business Voice Without Calling Plan: cc69a07c-8c51-457f-bb2a-f21a62d6bede</span></span>

<span data-ttu-id="fb8c0-573">이 제품에서 혜택을 얻는 방법을 이해하려면 현지 자회사와 소통하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-573">Please engage with your local subsidiary to understand how to benefit from this offer.</span></span>

### <a name="additional-guidance-for-partners-in-the-united-states-and-puerto-rico"></a><span data-ttu-id="fb8c0-574">미국 및 푸에르토리코의 파트너에 대한 추가 지침</span><span class="sxs-lookup"><span data-stu-id="fb8c0-574">Additional guidance for partners in the United States and Puerto Rico</span></span>

<span data-ttu-id="fb8c0-575">미국 및 푸에르토리코에서 Business Voice는 세금이 포함되어 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-575">In the US and Puerto Rico, Business Voice is a tax-inclusive offer.</span></span> <span data-ttu-id="fb8c0-576">파트너에게 청구되고 파트너가 Microsoft에 지불하는 가격에는 관련 미국 통신세 및 요금이 포함됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-576">The price billed to Partners and paid by Partners to Microsoft includes applicable US telco taxes and fees.</span></span> <span data-ttu-id="fb8c0-577">다른 시장에서는 일반적인 청구 프로세스에 따라 세금이 적용됩니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-577">In other markets, taxes will be applied per the normal invoicing process.</span></span> <span data-ttu-id="fb8c0-578">Business Voice 가격 인상을 결정하기 전에 세금 송금에 관해 변호사에게 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-578">Please talk to your legal counsel about remitting taxes, before deciding to mark-up Business Voice.</span></span> <span data-ttu-id="fb8c0-579">Business Voice 가격이 인상되면 파트너는 통신세를 송금하는 방법이 필요합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-579">If Business Voice is marked up, the Partner needs to a way to remit the telco taxes.</span></span> <span data-ttu-id="fb8c0-580">통신세를 송금하는 방법이 마련되지 않으면 파트너는 가격 인상에 대한 인상된 세금을 지불하지 않으므로 세금 위반이 발생합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-580">Otherwise, partner would not be paying the incremental tax on the mark-up, resulting in tax violations.</span></span> <span data-ttu-id="fb8c0-581">Microsoft는 미국에서 Business Voice에 대해 파트너에게 추가 CSP 인센티브를 제공하여 잠재적 이익 손실을 보상합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-581">Microsoft provides additional CSP incentives to partners for Business Voice in the US, to compensate for potential lack of margin.</span></span>

### <a name="guidance-for-partners-in-australia"></a><span data-ttu-id="fb8c0-582">오스트레일리아의 파트너를 위한 지침</span><span class="sxs-lookup"><span data-stu-id="fb8c0-582">Guidance for partners in Australia</span></span>

<span data-ttu-id="fb8c0-583">오스트레일리아의 파트너는 2020년 3월의 미리 보기 가격표에 통화 플랜 불포함 Microsoft 365 Business Voice가 표시되어 있긴 하지만, 2020년 4월 1일의 프로덕션 가격표에서 통화 플랜 불포함 Microsoft 365 Business Voice 제품을 사용할 수 없다는 점에 유의해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-583">Partners in Australia should be aware that the offer Microsoft 365 Business Voice Without Calling Plan will not be available on the production price list on April 1, 2020 – despite being available on the preview price list in March 2020.</span></span> <span data-ttu-id="fb8c0-584">이점 양해해 주시기 바랍니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-584">Thank you for your understanding.</span></span>

### <a name="further-countries"></a><span data-ttu-id="fb8c0-585">추가 국가</span><span class="sxs-lookup"><span data-stu-id="fb8c0-585">Further countries</span></span>

<span data-ttu-id="fb8c0-586">앞으로 점차 Office 365 및 Microsoft 365를 사용할 수 있는 모든 국가에 Microsoft 365 Business Voice가 제공되기를 기대합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-586">Over time, we hope to bring Microsoft 365 Business Voice to all countries where Office 365 and Microsoft 365 are available.</span></span>

### <a name="next-steps"></a><span data-ttu-id="fb8c0-587">다음 단계</span><span class="sxs-lookup"><span data-stu-id="fb8c0-587">Next steps</span></span>

- <span data-ttu-id="fb8c0-588">이 제품의 가치 제안에 대해 자세히 알아보고 Microsoft Teams 실무를 설정하고 통합하려면 파트너 갤러리를 확인하세요. [CSP의 Microsoft 365 Business Voice 가용성](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)</span><span class="sxs-lookup"><span data-stu-id="fb8c0-588">Check our partner gallery to know more about the value proposition of this offer, as well to establish, and consolidate your Microsoft Teams practice: [Microsoft 365 Business Voice availability in CSP](https://partner.microsoft.com/resources/collection/microsoft_365_business_voice_in_csp#/)</span></span>
- <span data-ttu-id="fb8c0-589">미리 보기 가격표를 숙지하고 이 정보를 조직 내의 모든 해당 담당자와 공유하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-589">Please familiarize yourself with the preview price list and share this information with all appropriate contacts in your organization.</span></span>
- <span data-ttu-id="fb8c0-590">이 제품과 효과적으로 시장에 진출하는 방법에 대해 자세히 알아보려면 현지 One Commercial Partner 팀과 소통하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-590">Please engage with your local One Commercial Partner team to know more about this offer and how to go to market effectively</span></span>

### <a name="questions"></a><span data-ttu-id="fb8c0-591">질문이 있으세요?</span><span class="sxs-lookup"><span data-stu-id="fb8c0-591">Questions?</span></span>

<span data-ttu-id="fb8c0-592">이 제품에 대한 추가 질문이 있는 경우 Microsoft One Commercial Partner 팀의 담당자에게 문의하세요.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-592">For any further questions about these offers, please contact your representative in the Microsoft One Commercial Partner team.</span></span>

### <a name="change-log"></a><span data-ttu-id="fb8c0-593">로그 변경</span><span class="sxs-lookup"><span data-stu-id="fb8c0-593">Change log</span></span>

- <span data-ttu-id="fb8c0-594">미국 고객에게 M365 Business Voice가 제공됨: 2020년 4월 1일</span><span class="sxs-lookup"><span data-stu-id="fb8c0-594">M365 Business Voice available for US customers: April 1, 2020</span></span>
- <span data-ttu-id="fb8c0-595">통화 플랜 불포함 M365 Business Voice 출시: 2020년 4월 1일</span><span class="sxs-lookup"><span data-stu-id="fb8c0-595">M365 Business Voice without calling plan launch: April 1, 2020</span></span>
- <span data-ttu-id="fb8c0-596">원래 게시 날짜: 2019년 11월 5일</span><span class="sxs-lookup"><span data-stu-id="fb8c0-596">Original publication date: November 5, 2019</span></span>

_________________

## <a name="act-now-partners-are-now-required-to-have-accepted-the-microsoft-partner-agreement"></a><a id="1"/></a><span data-ttu-id="fb8c0-597">지금 필요한 작업: 이제 파트너는 Microsoft 파트너 계약에 동의해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-597">Act now: Partners are now required to have accepted the Microsoft Partner Agreement.</span></span>

### <a name="categories"></a><span data-ttu-id="fb8c0-598">범주</span><span class="sxs-lookup"><span data-stu-id="fb8c0-598">Categories</span></span>

- <span data-ttu-id="fb8c0-599">날짜: 2020-04-01</span><span class="sxs-lookup"><span data-stu-id="fb8c0-599">Date: 2020-04-01</span></span>
- <span data-ttu-id="fb8c0-600">다음을 입력합니다. 기능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-600">Type: Capabilities</span></span>
- <span data-ttu-id="fb8c0-601">상태: 지금 이용 가능</span><span class="sxs-lookup"><span data-stu-id="fb8c0-601">Status: Now Available</span></span>
- [<span data-ttu-id="fb8c0-602">자세한 정보</span><span class="sxs-lookup"><span data-stu-id="fb8c0-602">Learn more</span></span>](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp)

### <a name="impacted-audience"></a><span data-ttu-id="fb8c0-603">영향을 받는 대상</span><span class="sxs-lookup"><span data-stu-id="fb8c0-603">Impacted audience</span></span>
<span data-ttu-id="fb8c0-604">모든 CSP 파트너.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-604">All CSP partners.</span></span>

<span data-ttu-id="fb8c0-605">**2020년 4월 1일 업데이트** 2020년 1월 31일까지 CSP(클라우드 솔루션 공급자) 프로그램의 모든 파트너는 거래하는 모든 CSP 테넌트에 대한 계약에 동의해야 합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-605">**April 1, 2020 Update** As of 31 January 2020, all partners in the Cloud Solution Provider (CSP) Program should have accepted the agreement for all of their transacting CSP tenants.</span></span> <span data-ttu-id="fb8c0-606">이전에 계약의 다음 구현 단계가 2020년 4월에 시작된다고 알려드렸습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-606">We previously communicated that the next phase of implementation for the agreement would begin in April 2020.</span></span><span data-ttu-id="fb8c0-607">  비즈니스 중단을 방지하기 위해 다음 구현 단계를 2020년 4월 이후로 연장하기로 결정했습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-607">  To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span> <span data-ttu-id="fb8c0-608">클라우드 솔루션 공급자 파트너 중 일부에게 MPA에 동의하는 데 문제가 있다는 피드백을 받았습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-608">We have received feedback from some of our Cloud Solution Provider Partners that they have experienced issues accepting the MPA.</span></span> <span data-ttu-id="fb8c0-609">이러한 상황에 따라 계약에 동의하는 데 문제가 있는 파트너를 지원하기 위한 Microsoft 리소스를 마련하기 위해 노력하고 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-609">Based on these circumstances, we are working toward ensuring Microsoft resources are in place to support partners who have been having trouble accepting the agreement.</span></span>

### <a name="summary"></a><span data-ttu-id="fb8c0-610">요약</span><span class="sxs-lookup"><span data-stu-id="fb8c0-610">Summary</span></span>
<span data-ttu-id="fb8c0-611">2020년 1월 31일부터 클라우드 솔루션 공급자 프로그램의 모든 파트너(간접 재판매인 포함)는 Microsoft 파트너 계약에 동의해야 중단 없이 신규 고객을 창출하거나 CSP 프로그램의 기존 고객을 위해 새로 주문할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-611">As of January 31, 2020, all partners in the Cloud Solution Provider program should have accepted the Microsoft Partner Agreement, including Indirect Resellers, to ensure no disruption of their ability to create new customers or place new orders for existing customers in the CSP program.</span></span> <span data-ttu-id="fb8c0-612">이제 CSP 프로그램의 모든 파트너에게 Microsoft 파트너 계약 동의는 필수입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-612">Acceptance of the Microsoft Partner Agreement is now required for all partners in the CSP program.</span></span>

<span data-ttu-id="fb8c0-613">2020년 4월부터:</span><span class="sxs-lookup"><span data-stu-id="fb8c0-613">Starting in April, 2020:</span></span>
- <span data-ttu-id="fb8c0-614">Microsoft 파트너 계약에 동의하지 않은 직접 청구 파트너 및 간접 공급자는 새로 주문할 수 없으며 기존 구독 관리만 가능합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-614">Direct Bill partners and Indirect Providers who have not accepted the Microsoft Partner Agreement will not be able to place new orders and will be limited to managing existing subscriptions only.</span></span>
- <span data-ttu-id="fb8c0-615">Microsoft 파트너 계약에 동의하지 않은 간접 재판매인은 더 이상 새 주문에 대해 공식 파트너 역할을 할 수 없습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-615">Indirect Resellers who have not accepted the Microsoft Partner Agreement will no longer be eligible to act as partner of record on new orders.</span></span>

<span data-ttu-id="fb8c0-616">**다음 작업을 아직 수행하지 않은 경우 즉시 완료하세요.**</span><span class="sxs-lookup"><span data-stu-id="fb8c0-616">**If you have not done so already, please complete the following actions immediately.**</span></span>

### <a name="actions-for-direct-bill-partners"></a><span data-ttu-id="fb8c0-617">직접 청구 파트너가 수행할 작업:</span><span class="sxs-lookup"><span data-stu-id="fb8c0-617">Actions for direct bill partners:</span></span>
1. <span data-ttu-id="fb8c0-618">조직의 주요 관련자에게 Microsoft 파트너 계약을 검토하도록 알립니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-618">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="fb8c0-619">전역 관리자 자격 증명을 사용하여 [파트너 센터의 CSP 개요 페이지](https://partner.microsoft.com/pcv/dashboard/overview)에서 Microsoft 파트너 계약에 동의합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-619">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>

<span data-ttu-id="fb8c0-620">추가 정보 및 리소스는 CSP 갤러리 페이지([여기](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/))를 통해 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-620">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

### <a name="actions-for-indirect-providers"></a><span data-ttu-id="fb8c0-621">간접 공급자가 수행할 작업</span><span class="sxs-lookup"><span data-stu-id="fb8c0-621">Actions for indirect providers</span></span>
1. <span data-ttu-id="fb8c0-622">조직의 주요 관련자에게 Microsoft 파트너 계약을 검토하도록 알립니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-622">Inform key stakeholders in your organization to review the Microsoft Partner Agreement.</span></span>
2. <span data-ttu-id="fb8c0-623">전역 관리자 자격 증명을 사용하여 [파트너 센터의 CSP 개요 페이지](https://partner.microsoft.com/pcv/dashboard/overview)에서 Microsoft 파트너 계약에 동의합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-623">Accept the Microsoft Partner Agreement on the [CSP Overview page on Partner Center](https://partner.microsoft.com/pcv/dashboard/overview) using Global Admin credentials.</span></span>
3. <span data-ttu-id="fb8c0-624">[API를 사용하여 간접 재판매인의 서명 상태를 확인합니다](https://docs.microsoft.com/partner-center/develop/verify-indirect-reseller-mpa-status).</span><span class="sxs-lookup"><span data-stu-id="fb8c0-624">Use the [API to verify your indirect reseller's signing status](https://docs.microsoft.com/partner-center/develop/verify-indirect-reseller-mpa-status).</span></span>
4. <span data-ttu-id="fb8c0-625">아래 작업을 완료하도록 간접 재판매인을 지원합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-625">Assist your indirect resellers with completing their actions below.</span></span>

<span data-ttu-id="fb8c0-626">추가 정보 및 리소스는 CSP 갤러리 페이지([여기](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/))를 통해 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-626">More information and resources are available via the CSP Gallery page [here](https://partner.microsoft.com/resources/collection/new-microsoft-cloud-agreement-csp#/).</span></span>

<span data-ttu-id="fb8c0-627">Microsoft는 간접 공급자가 거래 적용 기능을 테스트하는 중에 발생하는 기술적인 문제에 대해 알고 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-627">We are aware of technical issues encountered by Indirect Providers testing the transactional enforcement capabilities.</span></span> <span data-ttu-id="fb8c0-628">이 문제는 2020년 4월까지 해결될 예정입니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-628">Those issues will be resolved by April, 2020.</span></span>

### <a name="actions-for-indirect-resellers"></a><span data-ttu-id="fb8c0-629">간접 재판매인이 수행할 작업</span><span class="sxs-lookup"><span data-stu-id="fb8c0-629">Actions for indirect resellers</span></span>
1. <span data-ttu-id="fb8c0-630">간접 재판매인으로 [파트너 센터에 온보딩](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/)하고 온보딩 프로세스의 일부로 Microsoft 파트너 계약에 동의합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-630">[Onboard to Partner Center](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/) as an indirect reseller and accept the Microsoft Partner Agreement as part of the onboarding process.</span></span>
2. <span data-ttu-id="fb8c0-631">이전에 간접 재판매인으로 파트너 센터에 온보딩한 경우 전역 관리자 자격 증명을 사용하여 [파트너 센터 대시보드 페이지](https://partner.microsoft.com/pcv/dashboard/overview)에서 Microsoft 파트너 계약에 동의합니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-631">If you have previously onboarded to Partner Center as an indirect reseller, accept the Microsoft Partner Agreement on the [Partner Center dashboard](https://partner.microsoft.com/pcv/dashboard/overview) page using Global Admin credentials.</span></span>
<span data-ttu-id="fb8c0-632">간접 재판매인 관련 정보 및 리소스는 재판매인 CSP 갤러리 페이지([여기](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/))를 통해 사용할 수 있습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-632">Indirect reseller specific information and resources are available via the reseller CSP Gallery page [here](https://partner.microsoft.com/resources/collection/indirect-reseller-onboarding-for-mpa-in-csp#/).</span></span>

### <a name="change-log"></a><span data-ttu-id="fb8c0-633">로그 변경</span><span class="sxs-lookup"><span data-stu-id="fb8c0-633">Change log</span></span>

- <span data-ttu-id="fb8c0-634">2020년 1월 14일: 원래 알림 게시됨.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-634">January 14, 2020: Original announcement published.</span></span>
- <span data-ttu-id="fb8c0-635">2020년 1월 24일: 웨비나 시리즈 초대가 2020년 1월 27일에 업데이트됨.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-635">January 24, 2020: Webinar Series invites updated for w/c 27th January 2020.</span></span>
- <span data-ttu-id="fb8c0-636">2020년 1월 31일: 웨비나 시리즈 초대가 2020년 2월로 업데이트됨.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-636">January 31, 2020: Webinar Series invites updated for February 2020.</span></span>
- <span data-ttu-id="fb8c0-637">2020년 2월 5일: 이제 Microsoft 파트너 계약 동의가 필수임.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-637">February 5, 2020: Microsoft Partner Agreement acceptance is now required.</span></span>
- <span data-ttu-id="fb8c0-638">2020년 3월 4일: 웨비나 시리즈 초대가 2020년 3월로 업데이트됨.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-638">March 4, 2020: Webinar Series invites updated for March 2020.</span></span>
- <span data-ttu-id="fb8c0-639">2020년 4월 1일: \*\* 업데이트\*\* - 비즈니스 중단을 방지하기 위해 다음 구현 단계를 2020년 4월 이후로 연장하기로 결정했습니다.</span><span class="sxs-lookup"><span data-stu-id="fb8c0-639">April 1, 2020: \*\* Update\*\* - To help prevent any disruption to business, we have decided to extend the next phase of implementation beyond April 2020.</span></span>
