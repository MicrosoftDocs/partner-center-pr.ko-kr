...
|:----------------|:--------------|:--------------|:--------------|:--------------|:--------------|
|라이선스 기반 및 사용량 기반 구독의 반복 요금 |[온라인 서비스 카탈로그](https://partner.microsoft.com/commerce/preferredoffers/list)의 모든 제품. Office 365, Microsoft 365, Azure Active Directory, Azure(종량제), Dynamics 365, PowerBI Pro 등이 있습니다. |파트너 센터 계정을 만들 때 선택한 날짜 |청구 날짜 이전의 월. |현재 위치한 국가/지역의 통화. 예를 들어 회사가 영국에 있는 경우 영국 파운드(GBP)로 요금이 청구됩니다. 회사가 인도에 있는 경우 인도 루피(INR)로 요금이 청구됩니다.  |아니요 |
...
|**구매 날짜**   |**청구 시작**  |**청구 종료**  |**단가**  |**수량**  |**합계** |**청구 유형** |
|:------:|:------:|:------:|:------:|:------:|:------:|:-----:|
|2019/6/10(라이선스 1개)      |2019/6/10   |2019/7/09         |$0                |1                 |$0            |신규 항목         |
...
|**구매 날짜**   |**청구 시작**  |**청구 종료**  |**단가**  |**수량**  |**합계** |**청구 유형** |
|:------:|:------:|:------:|:------:|:------:|:------:|:-----:|
|2019/6/10(라이선스 11개)      |2019/6/10   |2019/7/09         |$0                |11                |$0            |신규 항목         |
...
|:------:|:------:|:------:|:------:|:------:|:------:|:-----:|:-----:|
|2019/6/10(라이선스 1개) |실버     |2019/6/10   |2019/6/10         |$20        |1         |$20            |신규 항목      |
|2019/6/10(라이선스 1개) |실버    | 2019/6/10    |2019/6/10        |$20        |1       | $-20       |변환           |
...
|**구매 날짜**   |**SKU**   |**청구 시작**   |**청구 종료**  |**단가**  |**수량**  |**합계** |**청구 유형** |
|:------:|:------:|:------:|:------:|:------:|:------:|:-----:|:-----:|
|2019/6/10(라이선스 1개) |Bronze     |2019/6/10   |2019/6/10         |$10        |1         |$10            |신규 항목      |
...
- 요금 청구 **서비스 기간**: 요금은 달력 월에 정렬 됩니다. 예를 들어 청구 된 파트너가 10/15에 있는 Azure 요금제를 통해 Azure 서비스를 추가 하 고 고객이 10/15에서 Azure 서비스의 사용을 시작 하는 경우 청구 된 파트너는 서비스 기간 10/15-10/31에 대 한 고객 소비량에 대해 11/8에 대해 청구서/정찰을 받게 됩니다. 12/8에 생성 될 다음 달의 청구서에는 서비스 기간 11/1-11/31에 대 한 모든 요금이 포함 됩니다.

- **청구서 지불 기간**: 순 60 일.

- **송장 통화**: 파트너는 고객의 country's 할당 된 통화로 계속 청구 됩니다. 예를 들어 청구 된 파트너가 영국, 노르웨이 및 독일의 고객과 아일랜드에 있는 경우 청구 된 파트너는 GBP, NOK 및 EUR invoice/정찰을 받습니다.
