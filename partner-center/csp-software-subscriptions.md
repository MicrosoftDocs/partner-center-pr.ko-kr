...
5. 취소 하려는 소프트웨어 구매를 찾은 다음, **취소**를 선택 합니다. 대화 상자가 표시됩니다.

6. 주문 번호 드롭다운 목록에서 취소 하려는 올바른 주문 ID 번호를 선택 하 고 **제출**을 선택 합니다.

7. 고객에 대 한 여러 주문을 취소 하려면 각 고유 주문 ID 번호에 대해 4 ~ 6 단계를 다시 수행 해야 합니다. 고객의 **주문 기록** 페이지에서 주문 또는 주문 ID 번호에 대 한 자세한 내용을 확인할 수 있습니다.

8. 주문을 취소 하려고 할 때 파트너 센터는 주문 번호 드롭다운 목록 아래에 표시 되는 다른 정보를 제공할 수도 있습니다. 이 정보에는 다음이 포함 될 수 있습니다.
