...
3.  **서비스 관리** 섹션에서 서비스 관리 포털을 열려면 작업 해야 하는 서비스를 선택 합니다.
4.  중단 서비스나 저하 경험 등 고객의 계정 사용 하 여 문제를 발견 하는 경우에 서비스 상태를 확인 하 여 시작 해야 합니다. [서비스 상태 확인](check-service-health.md)을 참조하세요.
