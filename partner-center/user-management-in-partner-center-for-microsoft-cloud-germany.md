...
Microsoft 클라우드 독일 파트너 센터에 로그인하면 다시 로그인할 필요 없이 Microsoft 클라우드 독일 Azure 포털을 열 수 있습니다. 그러나 Microsoft 클라우드 독일 Azure 포털에 직접 로그인 해야 할 경우 이동 [https://portal.microsoftazure.de](https://portal.microsoftazure.de). 
