...
| CustomerCompanyName | 파트너 센터에 보고 된 고객의 조직 이름입니다. *시스템 정보에 따라 청구서를 조정하는 데 매우 중요합니다.* | *고객 테스트* |
| MpnId | CSP (클라우드 솔루션 공급자) 파트너의 Microsoft 파트너 네트워크 (MPN) 식별자입니다. | *4390934* |
