...
| 이벤트  | 날짜 (UTC) | 파트너 가시성: 파트너 센터 지급 보고서  |  파트너 가시성: 파트너 센터 분석\* |
| --- | --- | --- | --- |
| 트랜잭션 또는 사용 월 | 8/1/2020 – 8/31/2020 | 해당 없음 | **사용 보고서**: 새 소비 표시 (4 시간 마다 새로 고침)<br>**주문 보고서**: 해당 없음 |
| 종료 기간 (월) | 2020년 8월 31일 | 해당 없음 | **사용 보고서**: 월간 끝 소비 표시<br>**주문 보고서**: 해당 없음 |
| 주문 생성 됨 | 9/3/2020 – 9/7/2020 | 해당 없음 | **사용량 보고서**: OrderID/OrderLineItemID로 표시 되는 사용량 보고서<br>**주문 보고서**: 활성으로 표시 된 고객 주문 |
...
| 이벤트  | 날짜 (UTC) | 파트너 가시성: 파트너 센터 지급 보고서  |  파트너 가시성: 파트너 센터 분석\*  |
| --- | --- | --- | --- |
| 트랜잭션 또는 사용 월 | 8/1/2019 - 8/31/2019 | 해당 없음 | **사용 보고서**: 새 소비 표시 (4 시간 마다 새로 고침)<br>**주문 보고서**: 해당 없음 |
| 종료 기간 (월) | 8/31/2019 | 해당 없음 | **사용 보고서**: 월간 끝 소비 표시<br>**주문 보고서**: 해당 없음 |
| 주문 생성 됨 | 9/3/2019 – 9/7/2019 | 해당 없음 | **사용량 보고서**: OrderID/OrderLineItemID로 표시 되는 사용량 보고서<br>**주문 보고서**: 활성으로 표시 된 고객 주문 |
| 수집 된 고객 송장 | 9/7/2019 – 9/10/2019 | 해당 없음 | **사용량 보고서**: OrderID/OrderLineItemID로 표시 되는 사용량 보고서<br>**주문 보고서**: 활성으로 표시 된 고객 주문 |
...
| 종료 기간 (월) | 8/31/2019 | 해당 없음 | **사용 보고서**: 월간 끝 소비 표시<br>**주문 보고서**: 해당 없음 |
| 주문 생성 됨 | 9/3/2019 – 9/7/2019 | 해당 없음 | **사용량 보고서**: OrderID/OrderLineItemID로 표시 되는 사용량 보고서<br>**주문 보고서**: 활성으로 표시 된 고객 주문 |
| 수집 된 고객 송장 | 12/1/2019 | 해당 없음 | **사용량 보고서**: OrderID/OrderLineItemID로 표시 되는 사용량 보고서<br>**주문 보고서**: 활성으로 표시 된 고객 주문 |
