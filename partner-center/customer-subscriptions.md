...
|**수행할 작업**   |**이 글 읽기**   |
|----------------------|:----------------------|
|파트너 센터에서 기존 고객을 위한 새 구독을 생성 하거나 새 고객을 다음, 구독을 생성|[새 구독 생성](create-a-new-subscription.md)|
...
|이제 파트너 센터 내에서 Azure 구독 프로세스를 시작할 수 있습니다.   |[파트너 센터에서 Azure 구독 할당](assign-azure-subscriptions.md)|
