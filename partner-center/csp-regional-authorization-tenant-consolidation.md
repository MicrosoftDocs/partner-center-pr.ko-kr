...
-   **전환**(기존) 계정으로 **대시보드**에 로그인하고 모든 고객과 이들 고객에게 프로비전된 모든 서비스를 확인합니다.
...
1.  새로운 **전환 대상** 계정으로 **대시보드**에 로그인하고 **고객**에서 고객 목록을 탐색합니다.
...
1.  **전환 원본** CSP 계정으로 **대시보드**에 로그인하여 고객 목록을 탐색합니다.
