...
[기술 혜택](https://partner.microsoft.com/dashboard/mpn/membership/benefits/technical) 페이지에는 두 개의 개별 혜택에 대한 정보가 표시됩니다.

1.  **기술 제품 지원 인시던트 - 아래 참조**
2.  기술 사전 판매 및 배포 서비스(TPD) - [자세한 정보](https://docs.microsoft.com/partner-center/technical-benefits)
...
먼저 활성화해야 합니다. 그러면 액세스 ID 및 계약 ID가 표시되며, 이를 통해 계정에 혜택을 연결합니다. 계정을 사용하여 관련 기술 지원 포털에 로그인하고 기술 지원 요청을 만듭니다.
...
3. Microsoft 제품 지원 또는 서명 제품 지원을 사용하려면 혜택을 활성화해야 합니다. 혜택을 활성화하려면 **활성화** 단추를 클릭합니다. 활성화에 사용되는 사용자 계정에는 전역 관리자 또는 MPN 파트너 관리자 역할이 필요합니다. 

4. 활성화에 성공하면 액세스 ID 및 계약 ID가 모든 사용자에게 표시됩니다. 액세스 ID 및 계약 ID가 표시 되는 경우 Microsoft 기술 지원 및 서명 제품 지원 (골드 및 실버 구성원)을 사용할 수 있습니다.

   > [!NOTE]
   > 각 계정에 Microsoft 기술 지원 또는 서명 제품 지원을 처음 사용할 때 액세스 ID 및 계약 ID가 필요 합니다. 사용자의 계정에 혜택이 연결 되 면 액세스 ID 및 계약 ID를 다시 사용할 필요가 없습니다.  
...
| 서명 클라우드 지원<br>클라우드 제품에만 해당                   |              | 클라우드 역량:<br>제한 없음<br>         <br>기타 역량:<br>5 개 인시던트         | 클라우드 역량:<br>제한 없음<br>          <br>기타 역량:<br>10개 인시던트   
...
최신 온-프레미스 제품에 대한 기술 지원에 **Microsoft 제품** 지원을 사용할 수 있습니다.
...
2단계 지원 계약이 계정에 이미 연결되어 있으면 지원 인시던트 표시되어야 합니다. 온-프레미스 지원의 경우 파트너 지원 계약이 표시되고(더 이상 유효하지 않은 경우) 시작 날짜, 종료 날짜 및 남은 인시던트도 포함됩니다. 지원 계약을 연결해야 하는 경우 "지원 플랜을 구입하거나 추가해야 합니까?"를 확장하고 계약 추가 단추를 클릭하여 액세스 ID 및 계약 ID를 입력합니다. "사용할 수 없는 지원 계획을 보 시겠습니까?"를 확장 합니다. 섹션을 참조 하세요. 계약이 만료 되었거나, 남은 인시던트가 없거나, 이전 온-프레미스 제품을 선택한 경우 여기에 표시 되는 파트너 지원도 표시 됩니다 (지원 제품에 대 한 [aka.ms/n-1](https://aka.ms/n-1) 참조).

**자세한 내용은 [남은 파트너 지원 인시던트 수](https://support.microsoft.com/topic/how-many-partner-support-incidents-are-remaining-e8220db5-14f6-93db-4b4a-35766e11b3c3) 를 참조 하세요.** 
...
> [!NOTE]  
> Azure Portal 사용 하는 경우 지원 계약이 계정에 이미 연결 되어 있는 경우 "액세스 ID가 이미 연결 되어 있습니다 ..." 라는 오류 메시지가 표시 됩니다. 액세스 ID 및 계약 ID를 추가 하는 경우 아래 참조
...
*"이 액세스 ID는 이미 계정에 연결 되어 있습니다. 새 액세스 ID를 얻으려면 기술 계정 관리자에 게 문의 하세요. "* **이 오류 메시지는 유효하지 않으며 무시해야 합니다.** 오류를 사용하지 않도록 요청하고 유용한 진단 오류 메시지로 대체했습니다. 

위의 "액세스 ID가 이미 연결되어 있습니다..."가 표시됩니다. Azure Portal 사용할 때 지원 계약을 계정에 두 번 이상 연결하는 경우 오류가 발생합니다. 아래 시나리오를 참조하세요.

1. 골드 또는 실버 기술 혜택이 있고 이전에 온-프레미스 지원에 대한 계약을 추가한 경우 Azure Portal 사용하여 동일한 계정에 계약을 두 번째로 추가합니다. 지원 계약을 한 번만 계정에 연결하면 되므로 Azure에서 지원 혜택을 연결할 필요가 없습니다. 계약이 계정에 이미 연결되어 있을 때 링크 지원 혜택을 사용하는 경우 오류가 표시되며 무시되어야 합니다. + 새 지원 요청 사용하고 정상적으로 지원 인시던트 만들기 및 지원 계획이 표시됩니다.

2. 지원 계약이 만료되었거나 서명 10 팩(골드 하이브리드 역량) 또는 서명 5 팩(실버 하이브리드 역량)에 인시던트 남은 인시던트는 없으면 지원 계약이 잘못되어 숨겨집니다. 지원 혜택을 다시 연결하면 계약이 이미 연결되어 있으므로 오류가 표시됩니다. Azure 지원 인시던트 받기 위해 새 지원 계획을 구매해야 합니다. 
...
*   [기술 사전 판매 및 배포 서비스(TPD)](https://docs.microsoft.com/partner-center/technical-benefits)
