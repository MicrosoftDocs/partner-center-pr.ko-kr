...
학습 Action Pack는 학습 파트너 프로그램의 기본 수준 항목입니다. 학습 기간 업무를 처음 사용 하 고 조직에서 Microsoft 교육 과정 교육을 완료 하지 않은 경우 microsoft는 microsoft Learning Partner로 등록할 수 있는 기회를 제공 합니다. 학습 Action Pack 구매 하기만 하면 됩니다.
...
- 파트너 센터에서 학습 Action Pack를 검증 하려면 MCT (1)가 하나 이상 있어야 합니다. 다른 학습 Kpi를 충족 하지 않아도 됩니다.
- 학습 Action Pack를 활성화 하려면 다음 단계를 사용 합니다.
   1. [Microsoft Action Pack 구독 구입 또는 갱신](mpn-get-action-pack.md)에 설명 된 단계를 수행 합니다.
   2. 새 계정 프로필을 설정 하는 데 도움이 필요 하면 [Partner Frontline 지원](https://partner.microsoft.com/support) 팀에 문의 하세요. 그러면 교육용 Marketplace의 Microsoft 교육 과정 교육에 액세스할 수 있습니다.

## <a name="enroll-with-a-silver-competency-learning-option"></a>실버 역량 학습 옵션을 사용 하 여 등록

실버 수준의 멤버 자격을 얻기 위해 학습 파트너는 특정 역량에 연결 된 실버 학습 옵션에 등록할 수 있습니다. 이렇게 하려면 해당 특정 역량에 대 한 실버 학습 옵션 요구 사항을 충족 해야 합니다.

> [!NOTE]
> 실버 또는 골드 학습 옵션을 제공 하는 역량에 대해 자세히 알아보려면 최신 역량 [페이지](https://partner.microsoft.com/membership/competencies)를 참조 하세요. 

특정 실버 역량의 학습 옵션을 한정 하 고 등록 하려면 해당 역량의 실버 요구 사항을 검토 하 여 충족 하는지 확인 합니다. 그런 후 다음 단계를 수행합니다.

- 학습 프로그램 성능 지침에 설명 된 **성능 요구 사항** 에 커밋합니다. 이러한 지침은 [학습 리소스 사이트](https://partner.microsoft.com/marketing/learning-resources#/)에서 사용할 수 있습니다.
...
### <a name="q-if-i-am-a-net-new-partner-and-decide-to-buy-courseware-trainings-or-certifications-before-applying-for-the-learning-option-will-the-kpis-be-recognized-by-partner-center-automatically"></a>Q: net-new 파트너 이며 학습 옵션을 적용 하기 전에 교육 및 학습 또는 인증을 구입 하기로 결정 한 경우 Kpi가 파트너 센터에서 자동으로 인식 되나요?

예, 파트너 센터에서 Kpi를 인식 해야 합니다.

### <a name="q-where-should-i-go-in-case-there-is-a-discrepancy-between-kpis-in-partner-center-under-the-learning-option-and-my-kpi-dashboard"></a>17. 파트너 센터에서 학습 옵션 및 내 KPI 대시보드의 Kpi 사이에 차이가 없는 경우 어디에서 이동 해야 하나요?

[Partner Frontline 지원](https://partner.microsoft.com/support)에 문의 하세요. Kpi를 추적 하는 데 도움이 되도록 KPI 대시보드에서 다음 세부 정보를 제공 해야 합니다.
