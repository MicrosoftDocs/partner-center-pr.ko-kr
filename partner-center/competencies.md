...
[실버 및 골드 멤버 자격에 대 한 역량 요구 사항](learn-about-competencies.md)

## <a name="earn-competencies"></a>역량을 획득
...
파트너 센터 파트너 센터에서 역량을에서 진행률을 확인 하려면로 이동 합니다 **파트너 관계 > 역량**합니다. 

### <a href="" id="associating_achievements"></a>전체 기술 기반 목표에 연결 하 여 직원 가져오기

1.  조직 내 직원의 사용자 계정을 추가합니다. [파트너 센터](https://partnercenter.microsoft.com)로 이동 하세요 **계정 설정 > 사용자 추가**합니다. (PMC 사용자는 **PMC 데이터를 사용하여 사용자 추가**를 선택하여 동시에 여러 사용자를 추가할 수 있습니다.)
...
2. 조직 내 직원에게 MSA(Microsoft 계정)에 로그인하여 자신의 사용자 계정과 연결하라고 합니다. (에서 합니다 [파트너 센터](https://partnercenter.microsoft.com)로 이동 하세요 **계정 설정**.) 직원의 Microsoft 기술 시험 하 고 인증 및 Microsoft Partner University를 통해 해당 계정에 연결할 동일 하거나 다른 Msa를 사용할 수 있습니다.
...
### <a href="" id="maintain_membership"></a> 유지 관리 하 고 멤버 자격을 갱신
...
경고 표시 되 면: **"사용자 역량 도전 과제의 최근 변경 멤버 갱신 자격 위험에 처 가"**, 즉, 하나 또는 만료의 위험에 노출 되어 역량 성과 많은 합니다. 
