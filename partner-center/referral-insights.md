...
이 카드는 공동 판매 기회가 어떻게 수행되는지 간략하게 보여줍니다.
...
:::image type="content" source="images/referrals/cosellanalyticsfunnel.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
:::image type="content" source="images/referrals/cosellanalyticsgeodistribution.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
:::image type="content" source="images/referrals/cosellanalyticssolutions.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
:::image type="content" source="images/referrals/cosellanalyticsreasons.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
거래 유형을 선택하는 경우 추천 성과를 공동 판매 기회 및 개인 거래와 관련하여 비교하는 옵션이 제공됩니다. 시장 및 솔루션의 경우 최대 세 가지 옵션을 선택하여 성과를 비교할 수 있습니다. 가로 막대형 차트인 첫 번째 그래프에는 주 피벗(볼륨 또는 거래 금액)을 기준으로 전달 대비 추세를 보여주는 데이터가 포함됩니다. 가로 막대형 차트의 오른쪽에는 동일한 데이터의 백분율로 분포를 표시하는 원형 차트도 있습니다.

:::image type="content" source="images/referrals/cosellanalyticscompare.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
:::image type="content" source="images/referrals/cosellanalyticsrawdata.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
...
:::image type="content" source="images/referrals/nodata.png" alt-text="공동 판매 기회 분석의 요약 카드를 보여주는 이미지":::
