...
- 새 고객을 만들고 계약을 검토하고 동의하도록 고객을 초대합니다.

- 재판매인 관계와 계약을 검토하고 동의하도록 새 고객을 초대합니다.
...
2. 고객은 이메일을 통해 초대를 받고 [URL](https://admin.microsoft.com/AdminPortal/Home?ref=/BillingAccounts/agreement)을 클릭합니다. 

3. 고객은 자격 증명을 Microsoft 365 관리 센터에 입력합니다.
