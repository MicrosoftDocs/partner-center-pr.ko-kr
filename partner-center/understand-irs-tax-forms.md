...
> [!NOTE]
> **IRS 세금 양식과**관련 된 추가 질문이 나 문제가 있는 경우 [지원 티켓](https://developer.microsoft.com/windows/support)을 만듭니다. Microsoft는 특정 세금 환경과 관련 된 질문에 답변할 수 없습니다. 이러한 질문의 경우 세금 전문가에 게 조언을 문의 하세요.
