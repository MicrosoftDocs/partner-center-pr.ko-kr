...
| **양식에서 어떻게 해야 하나요?** | 일반적으로 사용자가 특정 작업을 수행 하지 않아도 됩니다. 1042-S 폼은 세금 크레딧의 모든 형식에 대해 현지 세금 기관에 적용 하려는 경우 유용할 수 있습니다.  이 주제에 대 한 자세한 정보를 얻으려면 해당 세금 관리자에 게 문의 하세요. | 
| **W8 양식을 완료 했을 때 지불에 세금을 보안상 이유로 이유는 무엇 인가요?** | 다음 중 하나에 해당 하는 경우 세금이 보안상 이유로 됩니다.<br/><br/>1. W8의 세금 협약 섹션을 제대로 완료 하지 못했습니다. 또는 <br/>2. 미국에 세금 조약이 없는 국가에 거주 하 고 있습니다.<br/><br/>언제 든 지 파트너 센터를 방문 하 여 업데이트 된 W8 양식을 제출할 수 있습니다.<br/><br/> **참고:** 일부 수입은 세금 원천 적용 되지 않습니다. | 
