...
Cloudyn is a web app that allows you to track and manage how much your customers are using Azure and the costs of that usage. 파트너 센터 API를 통해 사용합니다.
...
3. 비밀 키 값을 복사하고 저장합니다. 30일 무료 평가판을 사용하려면 이 키가 필요합니다.<br>
   > [!NOTE]  
   > The application secret keys are like passwords with longer expiration dates. 나중에 사용할 수 있도록 키 값을 안전한 위치에 저장하십시오.
